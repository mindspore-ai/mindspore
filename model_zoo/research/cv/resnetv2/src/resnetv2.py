...
class PreActBottleNeck(nn.Cell):
    ...
    def __init__(self,
        ...
        self.bn1 = nn.BatchNorm2d(in_planes, eps=1e-5, momentum=0.1)
        ...
        self.bn3 = nn.BatchNorm2d(planes, eps=1e-5, momentum=0.1)
...
class PreActResNet(nn.Cell):
    ...
    def __init__(self,
        ...
        self.conv1 = nn.Conv2d(3, self.in_planes, kernel_size=3, stride=1, pad_mode='pad', padding=1)
...
def PreActResNet50(class_num=10):
...
def PreActResNet101(class_num=10):
    return PreActResNet(PreActBottleNeck,
                        num_blocks=[3, 4, 23, 3],
                        in_planes=64,
                        planes=[64, 128, 256, 512],
...
def PreActResNet152(class_num=10):
    return PreActResNet(PreActBottleNeck,
                        num_blocks=[3, 8, 36, 3],
                        in_planes=64,
                        planes=[64, 128, 256, 512],
