...
class BboxAssignSample(nn.Cell):
    ...
    def construct(self, gt_bboxes_i, gt_labels_i, valid_mask, bboxes, gt_valids):
        """The core implementation of bbox assigner and sampler definition.

        Args:
            gt_bboxes_i(Tensor): get the value of bboxes_i.
            gt_labels_i(Tensor): get the value of labels_i.
            valid_mask(Tensor): valid part of mask.
            bboxes(Tensor): bboxes, a tensor.
            gt_valids(Tensor): get the valid part of bboxes.

        Returns:
            total_bboxes(Tensor): the total bboxes.
            total_deltas(Tensor): the total variable.
            total_labels(Tensor): the total labels.
            total_mask(Tensor): the total mask.
        """
