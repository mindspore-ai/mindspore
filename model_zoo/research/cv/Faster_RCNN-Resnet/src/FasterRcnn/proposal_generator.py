...
class Proposal(nn.Cell):
    ...
    def construct(self, rpn_cls_score_total, rpn_bbox_pred_total, anchor_list):
        """
        Construct proposal subnet.

        Args:
            rpn_cls_score_total (Tensor): the rpn classification score.
            rpn_bbox_pred_total (Tensor): the prediction bounding box.
            anchor_list (list) - list of anchor.
