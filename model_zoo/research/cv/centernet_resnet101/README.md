...
- [Model Description](#model-description)
    - [Performance](#performance)
        - [Training Performance On Ascend](#training-performance-on-ascend)
        - [Inference Performance On Ascend](#inference-performance-on-ascend)
...
| Total time: evaluation     | keep res: test 1.5h, val 0.9h; fix res: test 60min, val 8min|
| Checkpoint                 | 591.70MB (.ckpt file)                                              |
| Scripts                    | <https://gitee.com/mindspore/mindspore/tree/master/model_zoo/research/cv/centernet_resnet101> |
