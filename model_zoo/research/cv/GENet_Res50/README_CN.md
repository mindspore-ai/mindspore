...
GENet_Res50是一个基于GEBlock构建于ResNet50之上的卷积神经网络，可以将ImageNet图像分成1000个目标类，准确率达78.3%。
...
```python
result: {'top_5_accuracy': 0.9407852564102565, 'top_1_accuracy': 0.7829727564102564}
```
...
| batch_size | 256（1卡） |
| 输出 | 概率 |
| 准确率 | θ-：ACC1[77.8%]   θ-：ACC1[78%]  θ+：ACC1[78.3%] |
| 速度 |  |
| 总时间 | 3分钟 |
| 推理模型 ||
