...
if __name__ == "__main__":
    ...
    for file in files:
        ...
        output_big = np.fromfile(result_path_1, dtype=np.float32).reshape(1, 38, 38, 3, 85)

        detection.detect([output_small, output_big], args.per_batch_size, image_shape, img_id)
