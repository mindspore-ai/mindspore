...
def parse_args():
    ...
    parser.add_argument('--gamma', type=float, default=0.80, help='how many epochs to save checkpoint.')
    parser.add_argument("--momentum", help="resume start epoch.", type=float, default=0.9)

    #run on where
    parser.add_argument('--device_id', type=int, default=5, help='device id of GPU or Ascend. (Default: 0)')
