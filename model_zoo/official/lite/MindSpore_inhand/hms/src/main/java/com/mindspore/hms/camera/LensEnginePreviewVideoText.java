...
public class LensEnginePreviewVideoText extends ViewGroup {
    private static final String TAG = LensEnginePreviewVideoText.class.getSimpleName();
    ...
    public LensEnginePreviewVideoText(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private class SurfaceCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceCreated(SurfaceHolder surface) {
            LensEnginePreviewVideoText.this.mSurfaceAvailable = true;
            try {
                LensEnginePreviewVideoText.this.startIfReady();
            } catch (IOException e) {
                Log.e(LensEnginePreviewVideoText.TAG, "Could not start camera source.", e);
            }
        }

        @Override
        public void surfaceDestroyed(SurfaceHolder surface) {
            LensEnginePreviewVideoText.this.mSurfaceAvailable = false;
        }
    ...
    private boolean isPortraitMode() {
        ...
        Log.d(LensEnginePreviewVideoText.TAG, "isPortraitMode returning false by default");
        return false;
    }
}
