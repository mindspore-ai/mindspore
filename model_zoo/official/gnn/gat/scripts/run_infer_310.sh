...
function preprocess_data()
{
    ...
    python3.7 ../preprocess.py --data_dir=$dataset_path --result_path=./preprocess_Result/
}
...
function cal_acc()
{
    python3.7 ../postprocess.py --result_path=./result_Files --dataset_name=$dataset_name --label_path=./preprocess_Result/y_test.npy --mask_path=./preprocess_Result/test_mask.npy &> acc.log
}
