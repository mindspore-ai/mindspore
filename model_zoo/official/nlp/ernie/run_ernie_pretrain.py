...
def _get_optimizer(args_opt, network):
    ...
    if cfg.optimizer == 'Lamb':
        ...
        if args_opt.enable_lossscale == "true" and args_opt.device_target == 'GPU':
            optimizer = AdamWeightDecayForErnie(group_params, learning_rate=lr_schedule, eps=cfg.AdamWeightDecay.eps)
...
def run_pretrain():
    ...
    if args_opt.enable_lossscale == "true":
        ...
        net_with_grads = ErnieTrainOneStepCell(net_with_loss, optimizer=optimizer, enable_clip_grad=True)
