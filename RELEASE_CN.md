...
- [STABLE] ops.ctc_greedy_decoder 新增CPU支持。
...
- [BETA] ops.log_softmax 新增CPU支持。
- [BETA] ops.norm 新增GPU、CPU支持。
...
- [STABLE] ops.scatter_nd_min 新增GPU支持。
...
- [BETA] ops.tensor_scatter_sub 新增CPU支持。
