...
def test_single_col_map():
    ...
    # test dict
    def per_batch_map_dict(x, batch_info):
        return {"anno": [100, 200, 300, 400], "label": 4}
    batch_map_config(per_batch_map_dict, {"anno": [100, 200, 300, 400], "label": 4})

    # test numpy
    def per_batch_map_numpy(x, batch_info):
        return (np.array(10),)
    batch_map_config(per_batch_map_numpy, 10)
