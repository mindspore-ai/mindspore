...
def test_func_bass_biquad_eager():
    ...
    Description: Test BassBiquad op in eager mode with valid input
...
def test_func_bass_biquad_pipeline():
    """
    Feature: BassBiquad op
    Description: Test BassBiquad op in pipeline mode with valid input
    Expectation: Output is equal to the expected output
    """
...
def test_invalid_invalid_input():
    """
    Feature: BassBiquad op
    Description: Test BassBiquad op with invalid input
