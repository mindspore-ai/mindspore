...
def test_func_frequency_masking_eager_random_input():
    ...
    Description: Test FrequencyMasking op in eager mode under normal test case with random input
...
def test_func_frequency_masking_eager_precision():
    """
    Feature: FrequencyMasking op
    Description: Test FrequencyMasking op precision in eager mode under normal test case
...
def test_func_frequency_masking_pipeline():
    """
    Feature: FrequencyMasking op
    Description: Test FrequencyMasking op in pipeline mode under normal test case
    Expectation: Output's shape is equal to the expected output's shape
    """
...
def test_frequency_masking_invalid_input():
    """
    Feature: FrequencyMasking op
    Description: Test FrequencyMasking op with invalid input
