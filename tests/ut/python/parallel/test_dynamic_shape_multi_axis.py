...
def test_parallel_dynamic_shape_with_features_010():
    ...
    assert validator.check_node_inputs('tuple_getitem_for_value_10-0', ['Shape-0', 2])
    assert validator.check_node_inputs('MakeTuple-1',
                                       [1, 1, 'tuple_getitem_for_value_3-0', 32, 'tuple_getitem_for_value_10-0', 16])
    ...
    assert validator.check_node_inputs('ScalarMul-0', ['tuple_getitem_for_value_3-0', 4])
    assert validator.check_node_inputs('ScalarFloorDiv-0', ['tuple_getitem_for_value_10-0', 2])
...
def test_parallel_dynamic_shape_with_features_011():
    ...
    assert validator.check_node_inputs('Shape-0', ['TupleGetItem-0'])
    assert validator.check_node_inputs('tuple_getitem_for_value_3-0', ['Shape-0', 0])
    assert validator.check_node_inputs('tuple_getitem_for_value_10-0', ['Shape-0', 1])
    assert validator.check_node_inputs('tuple_getitem_for_value_14-0', ['Shape-0', 2])
    assert validator.check_node_inputs('tuple_getitem_for_value_22-0', ['Shape-0', 3])
    assert validator.check_node_inputs('MakeTuple-1',
                                       [1, 1, 'tuple_getitem_for_value_3-0', 'tuple_getitem_for_value_10-0',
                                        'tuple_getitem_for_value_14-0', 'tuple_getitem_for_value_22-0'])
    assert validator.check_node_inputs('Reshape-0', ['TupleGetItem-0', 'MakeTuple-1'])
    assert validator.check_node_inputs('ScalarMul-0', ['tuple_getitem_for_value_3-0', 4])
    assert validator.check_node_inputs('ScalarFloorDiv-0', ['tuple_getitem_for_value_10-0', 2])
    assert validator.check_node_inputs('ScalarFloorDiv-1', ['tuple_getitem_for_value_14-0', 2])
    assert validator.check_node_inputs('MakeTuple-4',
                                       ['ScalarMul-0', 'ScalarFloorDiv-0', 'ScalarFloorDiv-1',
                                        'tuple_getitem_for_value_22-0'])
    assert validator.check_node_inputs('Reshape-1', ['TupleGetItem-6', 'MakeTuple-4'])
    assert validator.check_node_inputs('Shape-1', ['Add-0'])
    assert validator.check_node_inputs('TupleGetItem-11', ['Shape-1', 0])
    assert validator.check_node_inputs('ScalarMul-1', ['TupleGetItem-11', 2])
...
def test_parallel_dynamic_shape_with_features_015():
    ...
    assert validator.check_node_inputs('tuple_getitem_for_value_10-0', ['Shape-0', 1])
    assert validator.check_node_inputs('MakeTuple-1',
                                       [1, 1, 'tuple_getitem_for_value_3-0', 'tuple_getitem_for_value_10-0', 8, 4])
    assert validator.check_node_inputs('Reshape-0', ['TupleGetItem-0', 'MakeTuple-1'])
    assert validator.check_node_inputs('ScalarMul-0', ['tuple_getitem_for_value_3-0', 4])
    assert validator.check_node_inputs('ScalarFloorDiv-0', ['tuple_getitem_for_value_10-0', 2])
...
def test_parallel_dynamic_shape_with_features_022():
    ...
    assert validator.check_node_inputs('tuple_getitem_for_value_40-0', ['Shape-2', 1])
    assert validator.check_node_inputs('ScalarMul-6', ['tuple_getitem_for_value_40-0', 2])
    assert validator.check_node_inputs('tuple_getitem_for_value_3-1', ['Shape-2', 0])
    assert validator.check_node_inputs('MakeTuple-9', [2, 'ScalarMul-6', 2, 'tuple_getitem_for_value_3-1'])
    assert validator.check_node_inputs('Reshape-3', ['Concat-4', 'MakeTuple-9'])
