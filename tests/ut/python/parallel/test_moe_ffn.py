...
def test_moeffn_net():
    ...
    input_x = Tensor(np.ones([4096, 5120]), dtype=ms.float16)
    expert_tokens = Tensor(np.ones([16]), dtype=ms.int64)
    weight1 = Parameter(Tensor(np.ones([16, 5120, 20480]), dtype=ms.float16), "w1")
    bias1 = Parameter(Tensor(np.ones([16, 20480]), dtype=ms.float16), "bias1")
    weight2 = Parameter(Tensor(np.ones([16, 20480, 5120]), dtype=ms.float16), "w2")
    ...
    assert validator.check_parameter_shape('w1', [16, 5120, 2560])
    assert validator.check_parameter_shape('bias1', [16, 2560])
    assert validator.check_parameter_shape('w2', [16, 2560, 5120])
