...
def test_pangu_alpha_frontend_scheduling():
    '''
    Feature: frontend scheduling
    Description: Run Pangu with auto parallel mode and frontend scheduling
    Expectation: success
    '''
    os.environ["MS_ENABLE_FRONTEND_SCHEDULING_OPTIMIZATION"] = "1"
