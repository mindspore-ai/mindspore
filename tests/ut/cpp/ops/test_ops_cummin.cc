...
class TestCummin : public TestOps, public testing::WithParamInterface<CumminShapeParams> {};

TEST_P(TestCummin, dyn_shape) {
  ...
  CumminFuncImpl cummin_func_impl;
...
INSTANTIATE_TEST_CASE_P(
  TestCummin, TestCummin,
  testing::Values(CumminShapeParams{{3, 4, 5}, kFloat32, CreateScalar<int64_t>(2), {3, 4, 5}, kFloat32, {3, 4, 5}, kInt32},
                  CumminShapeParams{{3, 4, 5}, kInt64, CreateScalar<int64_t>(0), {3, 4, 5}, kInt64, {3, 4, 5}, kInt32},
                  CumminShapeParams{{3, 4, 5}, kInt64, CreateScalar<int64_t>(-3), {3, 4, 5}, kInt64, {3, 4, 5}, kInt32},
                  CumminShapeParams{{2, 3, 4, 5}, kInt32, CreateScalar<int64_t>(-2), {2, 3, 4, 5}, kInt32, {2, 3, 4, 5}, kInt32},
                  CumminShapeParams{{-1, -1, -1}, kUInt64, CreateScalar<int64_t>(2), {-1, -1, -1}, kUInt64, {-1, -1, -1}, kInt32},
                  CumminShapeParams{{-2}, kFloat32, CreateScalar<int64_t>(2), {-2}, kFloat32, {-2}, kInt32}));
}  // namespace ops
}  // namespace mindspore
