...
namespace mindspore {
namespace ops {
struct NormalTensorTensorOpParams {
...
class TestNormalTensorTensor : public TestOps, public testing::WithParamInterface<NormalTensorTensorOpParams> {};

TEST_P(TestNormalTensorTensor, normal_dyn_shape) {
  auto primitive = std::make_shared<Primitive>("NormalTensorTensor");
  ...
  auto infer_impl = std::make_shared<NormalTensorTensorFuncImpl>();
...
INSTANTIATE_TEST_CASE_P(
  TestNormalTensorTensorGroup, TestNormalTensorTensor,
  testing::Values(
    NormalTensorTensorOpParams{
      {2, 2}, kFloat16, {2, 2}, kFloat16, CreateScalar<float>(1.0), CreateScalar<float>(1.0), {2, 2}, kFloat16},
    NormalTensorTensorOpParams{
      {2, 2}, kFloat32, {2, 2}, kFloat32, CreateScalar<float>(1.0), CreateScalar<float>(1.0), {2, 2}, kFloat32}));
}  // namespace ops
}  // namespace mindspore
