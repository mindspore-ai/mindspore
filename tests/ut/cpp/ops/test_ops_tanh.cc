...
TEST_P(TestTanh, dyn_shape) {
  ...
  DoFuncImplInferAndCompare<TanhFuncImpl>("Tanh", {x}, expect_shape, expect_type);
}

namespace {
auto TanhOpTypeCases = testing::ValuesIn({
...
INSTANTIATE_TEST_CASE_P(TestTanhGroup, TestTanh, testing::Combine(EltwiseDynShapeTestCases, TanhOpTypeCases));
}  // namespace ops
}  // namespace mindspore
