...
auto ResizeDynTestCase = testing::ValuesIn(
  {Resize2DParams{
     {1, 3, 8, 8}, kFloat32, CreatePyIntTuple({4, 4}), CreateScalar(false), CreateScalar(true), {1, 3, 4, 4}, kFloat32},
   ...
   Resize2DParams{{1, 3, 8, 8},
                  ...
                  {1, 3, -1, -1},
                  kFloat32},
   Resize2DParams{{1, 3, 8, 8}, kFloat32, kValueAny, CreateScalar(false), CreateScalar(true), {1, 3, -1, -1}, kFloat32},
   ...
   Resize2DParams{{-2},
                  ...
                  {-1, -1, -1, -1},
                  kFloat32},
   Resize2DParams{{-2}, kFloat32, kValueAny, CreateScalar(false), CreateScalar(true), {-1, -1, -1, -1}, kFloat32}});
}
