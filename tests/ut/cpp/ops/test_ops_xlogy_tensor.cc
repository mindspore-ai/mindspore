...
TEST_P(TestXlogyTensor, XlogyTensor_dyn_shape) {
  ...
  XLogYTensorFuncImpl xlogy_tensor_func_impl;
  auto prim = std::make_shared<Primitive>("XLogYTensor");
...
auto XlogyTensorOpTypeTestCases =
  testing::ValuesIn({XlogyTensorType{kFloat16, kFloat16, kFloat16}, XlogyTensorType{kFloat32, kFloat16, kFloat32},
                     ...
                     XlogyTensorType{kFloat32, kBool, kFloat32}, XlogyTensorType{kBool, kUInt8, kUInt8},
                     XlogyTensorType{kInt64, kUInt8, kInt64}, XlogyTensorType{kFloat32, kInt16, kFloat32},
