...
class TestIm2ColExt : public TestOps, public testing::WithParamInterface<Im2ColExtParams> {};

TEST_P(TestIm2ColExt, dyn_shape) {
  // inputs
  ...
  // run
  auto infer_impl = std::make_shared<Im2ColExtFuncImpl>();
  auto prim = std::make_shared<Primitive>("Im2ColExt");
...
INSTANTIATE_TEST_CASE_P(TestIm2ColExt, TestIm2ColExt,
                        testing::Values(Im2ColExtParams{{-2},
                                                        kFloat32,
