...
namespace mindspore {
namespace ops {
struct LayerNormGradV3OpParams {
...
class TestLayerNormGradV3 : public TestOps, public testing::WithParamInterface<LayerNormGradV3OpParams> {};

TEST_P(TestLayerNormGradV3, layer_norm_grad_v3_dyn_shape) {
  auto primitive = std::make_shared<Primitive>("LayerNormGradV3");
  ...
  auto infer_impl = std::make_shared<LayerNormGradV3FuncImpl>();
...
INSTANTIATE_TEST_CASE_P(TestLayerNormGradV3Group, TestLayerNormGradV3,
                        testing::Values(LayerNormGradV3OpParams{{1, 2, 3, 4},
                                                                kFloat32,
                                                                {1, 2, 3, 4},
                                                                kFloat32,
                                                                {1},
