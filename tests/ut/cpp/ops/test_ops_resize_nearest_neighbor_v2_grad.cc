...
INSTANTIATE_TEST_CASE_P(
  ...
  testing::Values(
    ...
    ResizeNearestNeighborV2GradParams{
      {1, 3, 8, 8}, kFloat32, kValueAny, CreateScalar(false), CreateScalar(true), {1, 3, -1, -1}, kFloat32},
    ...
    ResizeNearestNeighborV2GradParams{{1, 3, -1, -1},
                                      ...
                                      kFloat32},
    ResizeNearestNeighborV2GradParams{
      {1, 3, -1, -1}, kFloat32, kValueAny, CreateScalar(false), CreateScalar(true), {1, 3, -1, -1}, kFloat32},

    ResizeNearestNeighborV2GradParams{
      {-2}, kFloat32, CreatePyIntTuple({4, 4}), CreateScalar(false), CreateScalar(true), {-1, -1, 4, 4}, kFloat32},
    ...
    ResizeNearestNeighborV2GradParams{{-2},
                                      ...
                                      kFloat32},
    ResizeNearestNeighborV2GradParams{
      {-2}, kFloat32, kValueAny, CreateScalar(false), CreateScalar(true), {-1, -1, -1, -1}, kFloat32}));
}  // namespace ops
}  // namespace mindspore
