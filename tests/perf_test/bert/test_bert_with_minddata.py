...
def test_bert_train():
    ...
    # dataset
    dataset_dir = ""
    schema_file = './datasetSchema.json'
    files = os.listdir(dataset_dir)
    data_files = []
    for file_name in files:
        data_files.append(os.path.join(dataset_dir, file_name))
    dataset = test_me_de_train_dataset(batch_size, epoch_size, schema_file=schema_file, data_files=data_files)
