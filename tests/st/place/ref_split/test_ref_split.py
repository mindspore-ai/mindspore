...
from src.net import SingleRefSplitNet, MultiChainRefNet, get_optimizer, get_loss, get_dataset
...
net_name_map = {
    "single_ref_split": SingleRefSplitNet,
    "multi_chain_ref": MultiChainRefNet
}
