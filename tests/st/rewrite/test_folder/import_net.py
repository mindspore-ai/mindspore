...
class Net(models.BaseNet, models.NoCellNet, models.NetWithClassVar):
    def __init__(self):
        models.BaseNet.__init__(self, Tensor(1))
        models.NoCellNet.__init__(self, Tensor(1), Tensor(2))
        models.NetWithClassVar.__init__(self, Tensor(1))
        self.relu = nn.ReLU()
