...
def test_bitwise_and_forward(mode):
    """
...
@pytest.mark.platform_x86_ascend_training
@pytest.mark.parametrize("mode", ['GE', 'pynative', 'KBK'])
def test_bitwise_and_backward(mode):
    """
    Feature: Auto grad.
...
def test_bitwise_and_dynamic_shape(jit_level):
    """
    ...
    TEST_OP(bitwise_and_forward_func, [[x, y], [x2, y2]], jit_level=jit_level, grad=False)
