...
class Net(nn.Cell):
    def __init__(self):
        ...
        self.weight1 = Parameter(initializer(Tensor(weight1), weight1.shape), name='weight1')
        self.weight2 = Parameter(initializer(Tensor(weight2), weight2.shape), name='weight2')
    ...
    def construct(self, input):
        output = self.matmul1(input, self.weight1)
...
def test_MatMulAllReduce():
    ...
    print(output_no_fusion.asnumpy(), output_fusion.asnumpy(), output_no_fusion.asnumpy() - output_fusion.asnumpy())