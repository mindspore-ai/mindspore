...
class Net(nn.Cell):
    def __init__(self):
        ...
        self.reduce_scatter1 = P.ReduceScatter(self.op0, group=HCCL_WORLD_COMM_GROUP)
        self.reduce_scatter2 = P.ReduceScatter(self.op1, group=HCCL_WORLD_COMM_GROUP)
        self.reduce_scatter3 = P.ReduceScatter(self.op2, group=HCCL_WORLD_COMM_GROUP)
