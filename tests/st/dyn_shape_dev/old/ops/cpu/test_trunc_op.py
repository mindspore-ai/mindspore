...
def test16_net():
    """
    Feature: Trunc Op.
    Description: Trunc with fp16 input.
...
def test32_net():
    """
    Feature: Trunc Op.
    Description: Trunc with fp32 input.
    Expectation: run success without error.
    """
...
def testint8_net():
    """
    Feature: Trunc Op.
    Description: Trunc with int8 input.
    Expectation: run success without error.
    """
...
def testuint8_net():
    """
    Feature: Trunc Op.
    Description: Trunc with uint8 input.
    Expectation: run success without error.
    """
...
def testint32_net():
    """
    Feature: Trunc Op.
    Description: Trunc with int32 input.
    Expectation: run success without error.
    """
