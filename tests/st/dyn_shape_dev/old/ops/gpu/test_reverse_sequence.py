...
def test_net_int8():
    """
    Feature: test ReverseSequence op
    Description: test ReverseSequence op with int8
...
def test_net_int32():
    """
    Feature: test ReverseSequence op
    Description: test ReverseSequence op with int32
    Expectation: test success
    """
...
def test_net_float32():
    """
    Feature: test ReverseSequence op
    Description: test ReverseSequence op with float32
    Expectation: test success
    """
    context.set_context(mode=context.GRAPH_MODE, device_target="GPU")
    x = np.array([[[[1, 2], [3, 4]],
...
def test_net_float64_0_dim():
    """
    Feature: test ReverseSequence op
    Description: Test added to test for 0 seq len edge case
    Expectation: test success
    """
    context.set_context(mode=context.GRAPH_MODE, device_target="GPU")
    x = np.array([[[[1, 2], [3, 4]],
