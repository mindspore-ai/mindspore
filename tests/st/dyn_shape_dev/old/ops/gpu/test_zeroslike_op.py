...
def test_ZerosLike():
    """
    Feature: ZerosLike Op.
    Description: Trunc with different input.
...
def test_zeros_like_dynamic_bool():
    """
    Feature: ZerosLike Op.
    Description: Trunc with dynamic bool input.
    Expectation: run success without error.
    """
...
def test_zeros_like_dynamic_int8():
    """
    Feature: ZerosLike Op.
    Description: Trunc with dynamic int8 input.
    Expectation: run success without error.
    """
...
def test_zeros_like_dynamic_uint8():
    """
    Feature: ZerosLike Op.
    Description: Trunc with dynamic uint8 input.
    Expectation: run success without error.
    """
...
def test_zeros_like_dynamic_int32():
    """
    Feature: ZerosLike Op.
    Description: Trunc with dynamic int32 input.
    Expectation: run success without error.
    """
...
def test_zeros_like_dynamic_float16():
    """
    Feature: ZerosLike Op.
    Description: Trunc with dynamic fp16 input.
    Expectation: run success without error.
    """
...
def test_zeros_like_dynamic_float32():
    """
    Feature: ZerosLike Op.
    Description: Trunc with dynamic fp32 input.
    Expectation: run success without error.
    """
...
def test_zeros_like_dynamic_float64():
    """
    Feature: ZerosLike Op.
    Description: Trunc with dynamic fp64 input.
    Expectation: run success without error.
    """
...
def test_zeros_like_dynamic_multiple_inputs():
    """
    Feature: ZerosLike Op.
    Description: Trunc with dynamic multipule input.
    Expectation: run success without error.
    """
    context.set_context(mode=context.GRAPH_MODE, device_target="GPU")
    net = ZerosLikeDynamicNet()
