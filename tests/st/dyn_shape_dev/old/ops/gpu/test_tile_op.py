...
def test_tile_float16():
    """
    Feature: Tile Op.
    Description: Tile with FP16 input.
...
def test_tile_float32():
    """
    Feature: Tile Op.
    Description: Tile with FP32 input.
    Expectation: run success without error.
    """
    ms_tile(np.float32)
...
def test_tile_float64():
    """
    Feature: Tile Op.
    Description: Tile with FP64 input.
    Expectation: run success without error.
    """
    ms_tile(np.float64)
...
def test_tile_int16():
    """
    Feature: Tile Op.
    Description: Tile with int16 input.
    Expectation: run success without error.
    """
    ms_tile(np.int16)
...
def test_tile_int64():
    """
    Feature: Tile Op.
    Description: Tile with int64 input.
    Expectation: run success without error.
    """
    ms_tile(np.int64)
