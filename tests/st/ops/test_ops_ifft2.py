...
def test_ops_ifft2_forward(mode):
    """
    Feature: ops.ifft2
    Description: test function ifft2 forward.
    Expectation: success
    """
...
@arg_mark(plat_marks=['platform_ascend', 'cpu_linux', 'cpu_windows', 'cpu_macos'], level_mark='level0', card_mark='onecard', essential_mark='essential')
@pytest.mark.parametrize('mode', [ms.GRAPH_MODE, ms.PYNATIVE_MODE])
def test_ops_ifft2_backward(mode):
    """
    Feature: ops.ifft2
    Description: test function ifft2 backward.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
...
@arg_mark(plat_marks=['platform_ascend', 'cpu_linux', 'cpu_windows', 'cpu_macos'], level_mark='level0', card_mark='onecard', essential_mark='essential')
@pytest.mark.parametrize('mode', [ms.GRAPH_MODE, ms.PYNATIVE_MODE])
def test_ops_ifft2_forward_dynamic_shape(mode):
    """
    Feature: ops.ifft2
    Description: test function ifft2 forward with dynamic shape.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
...
@arg_mark(plat_marks=['platform_ascend', 'cpu_linux', 'cpu_windows', 'cpu_macos'], level_mark='level0', card_mark='onecard', essential_mark='essential')
@pytest.mark.parametrize('mode', [ms.GRAPH_MODE, ms.PYNATIVE_MODE])
def test_ops_ifft2_forward_dynamic_rank(mode):
    """
    Feature: ops.ifft2
    Description: test function ifft2 forward with dynamic rank.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
...
@arg_mark(plat_marks=['platform_ascend', 'cpu_linux', 'cpu_windows', 'cpu_macos'], level_mark='level0', card_mark='onecard', essential_mark='essential')
@pytest.mark.parametrize('mode', [ms.GRAPH_MODE, ms.PYNATIVE_MODE])
def test_ops_ifft2_backward_dynamic_shape(mode):
    """
    Feature: ops.ifft2
    Description: test function ifft2 backward with dynamic shape.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
...
@arg_mark(plat_marks=['platform_ascend', 'cpu_linux', 'cpu_windows', 'cpu_macos'], level_mark='level0', card_mark='onecard', essential_mark='essential')
@pytest.mark.parametrize('mode', [ms.GRAPH_MODE, ms.PYNATIVE_MODE])
def test_ops_ifft2_backward_dynamic_rank(mode):
    """
    Feature: ops.ifft2
    Description: test function ifft2 backward with dynamic rank.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
