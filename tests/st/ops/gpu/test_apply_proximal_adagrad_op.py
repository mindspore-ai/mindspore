...
def test_apply_proximal_adagrad_op():
    """
    ...
    expect_var = np.array([[5.96388459e-01, 3.92964751e-01], [9.78178233e-02, 4.92815793e-01]]).astype(np.float32)
    expect_accum = np.array([[6.90000057e-01, 9.90000010e-01], [2.10000008e-01, 1.24000001e+00]]).astype(np.float32)
