...
def test_fast_gelu_grad_float32():
    ...
    Description: test the rightness of FastGeLUGrad gpu kernel, type of input data is float32.
    Expectation: Success.
    """
...
def test_fast_gelu_grad_float16():
    """
    Feature: FastGeLUGrad gpu kernel
    Description: test the rightness of FastGeLUGrad gpu kernel, type of input data is float16.
    Expectation: Success.
    """
    x_ms = Tensor(np.array([0.58401114, 0.68800163, 0.9760397, 0.14702141, 0.46563736, 0.9607501,
