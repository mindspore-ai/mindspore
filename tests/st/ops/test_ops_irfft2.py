...
from mindspore.ops import irfft2


class IRFFT2Net(nn.Cell):
    def __init__(self):
        super(IRFFT2Net, self).__init__()
        self.irfft2 = irfft2

    def construct(self, x, s, dim):
        return self.irfft2(x, s, dim)


class IRFFT2GradNet(nn.Cell):
    def __init__(self, net, dout):
        super(IRFFT2GradNet, self).__init__()
        self.net = net
        self.dout = dout
...
def test_ops_irfft2_forward(mode):
    """
    Feature: ops.irfft2
    Description: test function irfft2 forward.
    Expectation: success
    """
...
def test_ops_irfft2_backward(mode):
    """
    Feature: ops.irfft2
    Description: test function irfft2 backward.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
    ...
    net = IRFFT2Net()
    grad_net = IRFFT2GradNet(net, ms.Tensor(dout))
    grad_net.set_train()
...
def test_ops_irfft2_forward_dynamic_shape(mode):
    """
    Feature: ops.irfft2
    Description: test function irfft2 forward with dynamic shape.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
...
def test_ops_irfft2_forward_dynamic_rank(mode):
    """
    Feature: ops.irfft2
    Description: test function irfft2 forward with dynamic rank.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
...
def test_ops_irfft2_backward_dynamic_shape(mode):
    """
    Feature: ops.irfft2
    Description: test function irfft2 backward with dynamic shape.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    ...
    grad_net = IRFFT2GradNet(net, ms.Tensor(dout1))
    grad_net.set_train()
    ...
    grad_net = IRFFT2GradNet(net, ms.Tensor(dout2))
    grad_net.set_train()
    grad_net.set_inputs(x_dyn, n_dyn, dim_dyn)
...
def test_ops_irfft2_backward_dynamic_rank(mode):
    """
    Feature: ops.irfft2
    Description: test function irfft2 backward with dynamic rank.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
