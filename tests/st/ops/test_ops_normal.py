...
def test_normal_tensor_tensor_forward():
    ...
    seed = 1
    offset = 1
    output = normal_tensor_tensor_forward_func(mean, std, seed, offset)
...
def test_normal_tensor_float_forward():
    ...
    seed = 1
    offset = 1
    output = normal_tensor_float_forward_func(mean, std, seed, offset)
    assert output.shape == (10, 10)
...
def test_normal_float_tensor_forward():
    ...
    seed = 1
    offset = 1
    output = normal_float_tensor_forward_func(mean, std, seed, offset)
    assert output.shape == (10, 10)
...
def test_normal_float_float_forward():
    ...
    seed = 1
    offset = 1
    output = normal_float_float_forward_func(mean, std, size, seed, offset)
    assert output.shape == (10, 10)
...
def test_normal_tensor_tensor_dynamic_shape_testop():
    ...
    TEST_OP(normal_tensor_tensor_op,
            [[ms.Tensor(x1), ms.Tensor(x1), 10, 10],
             [ms.Tensor(x2), ms.Tensor(x2), 10, 10]], 'normal_tensor_tensor',
...
def test_normal_tensor_float_dynamic_shape_testop():
    ...
    TEST_OP(normal_tensor_float_op,
            [[ms.Tensor(x1), 1.0, 10, 10],
             [ms.Tensor(x2), 1.0, 10, 10]], 'normal_tensor_float',
            disable_input_check=True, disable_mode=['GRAPH_MODE'])
...
def test_normal_float_tensor_dynamic_shape_testop():
    ...
    TEST_OP(normal_float_tensor_op,
            [[1.0, ms.Tensor(x1), 10, 10],
             [1.0, ms.Tensor(x2), 10, 10]], 'normal_float_tensor',
            disable_input_check=True, disable_mode=['GRAPH_MODE'])
...
def test_normal_float_float_dynamic_shape_testop():
    ...
    TEST_OP(normal_float_float_op,
            [[1.0, 1.0, (2, 2), 10, 10],
             [2.0, 2.0, (2, 2), 10, 10]], 'normal_float_float',
            disable_input_check=True, disable_mode=['GRAPH_MODE'])
