...
def test_ops_ihfft2_forward(mode):
    """
    Feature: ops.ihfft2
    Description: test function ihfft2 forward.
    Expectation: success
    """
...
@pytest.mark.env_onecard
@pytest.mark.parametrize('mode', [ms.GRAPH_MODE, ms.PYNATIVE_MODE])
def test_ops_ihfft2_backward(mode):
    """
    Feature: ops.ihfft2
    Description: test function ihfft2 backward.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
...
@pytest.mark.env_onecard
@pytest.mark.parametrize('mode', [ms.GRAPH_MODE, ms.PYNATIVE_MODE])
def test_ops_ihfft2_forward_dynamic_shape(mode):
    """
    Feature: ops.ihfft2
    Description: test function ihfft2 forward with dynamic shape.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
...
@pytest.mark.env_onecard
@pytest.mark.parametrize('mode', [ms.GRAPH_MODE, ms.PYNATIVE_MODE])
def test_ops_ihfft2_forward_dynamic_rank(mode):
    """
    Feature: ops.ihfft2
    Description: test function ihfft2 forward with dynamic rank.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
...
@pytest.mark.env_onecard
@pytest.mark.parametrize('mode', [ms.GRAPH_MODE, ms.PYNATIVE_MODE])
def test_ops_ihfft2_backward_dynamic_shape(mode):
    """
    Feature: ops.ihfft2
    Description: test function ihfft2 backward with dynamic shape.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
...
@pytest.mark.env_onecard
@pytest.mark.parametrize('mode', [ms.GRAPH_MODE, ms.PYNATIVE_MODE])
def test_ops_ihfft2_backward_dynamic_rank(mode):
    """
    Feature: ops.ihfft2
    Description: test function ihfft2 backward with dynamic rank.
    Expectation: success
    """
    ms.context.set_context(mode=mode)
    s = (2,)
