...
def test_reciprocal_grad_float32(mode):
    """
    Feature: ALL To ALL
    Description: test cases for inv for float32
...
@pytest.mark.env_onecard
@pytest.mark.parametrize('mode', [context.GRAPH_MODE, context.PYNATIVE_MODE])
def test_reciprocal_grad_float16(mode):
    """
    Feature: ALL To ALL
    Description: test cases for inv for float16
    Expectation: the result match to numpy
    """
    context.set_context(mode=mode, device_target="CPU")
...
def test_reciprocal_grad_int(mode, dtype):
    """
    Feature: ALL To ALL
    Description: test cases for inv for int
    Expectation: the result match to numpy
    """
    context.set_context(mode=mode, device_target="CPU")
