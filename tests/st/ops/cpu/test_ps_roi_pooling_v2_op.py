...
class NetPSROIPooling(nn.Cell):
    ...
    def __init__(self, spatial_scale, group_size, output_dim, dynamic_shape=False):
...
def _ps_roi_pooling_case(data_type, mode, x_size_adjust=None, dynamic_shape=False):
    """Run op calculation."""
    ...
    x_size = [batch_size * rois_num, output_dim * group_size * group_size, x_height, x_width]
    ...
    net = NetPSROIPooling(spatial_scale, group_size, output_dim, dynamic_shape=dynamic_shape)
