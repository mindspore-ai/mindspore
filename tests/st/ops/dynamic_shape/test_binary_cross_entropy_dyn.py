...
def test_binary_cross_entropy_loss():
    ...
    prediction_dyn = Tensor(shape=(None,), dtype=mindspore.float32)
    target_dyn = Tensor(shape=(None,), dtype=mindspore.float32)
    weight_dyn = Tensor(shape=(None,), dtype=mindspore.float32)
    reduction = "none"
