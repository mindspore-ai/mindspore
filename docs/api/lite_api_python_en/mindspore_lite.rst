...
.. class:: mindspore_lite.FmkType
  ...
  For details, see `FmkType <https://gitee.com/mindspore/mindspore/blob/r1.10/mindspore/lite/python/api/converter.py>`_.
...
.. class:: mindspore_lite.ModelType
  ...
  For details, see `ModelType <https://gitee.com/mindspore/mindspore/blob/r1.10/mindspore/lite/python/api/model.py>`_.
  Run the following command to import the package:
...
.. class:: mindspore_lite.DataType
  ...
  For details, see `DataType <https://gitee.com/mindspore/mindspore/blob/r1.10/mindspore/lite/python/api/tensor.py>`_.
  Run the following command to import the package:
...
.. class:: mindspore_lite.Format
  ...
  For details, see `Format <https://gitee.com/mindspore/mindspore/blob/r1.10/mindspore/lite/python/api/tensor.py>`_.
  Run the following command to import the package:
