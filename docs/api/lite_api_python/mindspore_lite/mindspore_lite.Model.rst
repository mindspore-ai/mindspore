...
.. py:class:: mindspore_lite.Model()
    ...
    .. py:method:: build_from_file(model_path, model_type, context=None, config_path="", config_dict: dict = None)
        ...
        参数：
            ...
            - **model_type** (ModelType) - 定义输入模型文件的类型。选项有 ``ModelType::MINDIR`` 。有关详细信息，请参见 `模型类型 <https://mindspore.cn/lite/api/zh-CN/r2.3.0rc1/mindspore_lite/mindspore_lite.ModelType.html>`_ 。
    ...
    .. py:method:: update_weights(weights)
        ...
        教程样例：
            - `动态权重更新
              <https://www.mindspore.cn/lite/docs/zh-CN/r2.3.0rc1/use/cloud_infer/runtime_python.html#%E5%8A%A8%E6%80%81%E6%9D%83%E9%87%8D%E6%9B%B4%E6%96%B0>`_
