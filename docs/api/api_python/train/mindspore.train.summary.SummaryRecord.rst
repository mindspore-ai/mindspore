    ...
    **异常：**
    ...
    .. py:method:: record(step, train_network=None, plugin_filter=None)
        ...
        **异常：**
        ...
        - **TypeError：** `step` 不为整型，或 `train_network` 的类型不为 `mindspore.nn.Cell <https://www.mindspore.cn/docs/zh-CN/r1.7/api_python/nn/mindspore.nn.Cell.html?highlight=MindSpore.nn.cell#mindspore-nn-cell>`_ 。
