...
更多详情请参考 `通用数据变换 <https://www.mindspore.cn/tutorials/zh-CN/r1.11/beginner/transforms.html#common-transforms>`_ 。
...
更多详情请参考 `视觉数据变换 <https://www.mindspore.cn/tutorials/zh-CN/r1.11/beginner/transforms.html#vision-transforms>`_ 。
...
- Pipeline模式一般用于处理数据集，示例可参考 `数据处理Pipeline介绍 <https://www.mindspore.cn/docs/zh-CN/r1.11/api_python/mindspore.dataset.html#数据处理pipeline介绍>`_ 。
...
更多详情请参考 `文本数据变换 <https://www.mindspore.cn/tutorials/zh-CN/r1.11/beginner/transforms.html#text-transforms>`_ 。
