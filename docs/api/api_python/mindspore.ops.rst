...
动态shape的支持情况详见 `functional接口动态shape支持情况 <https://mindspore.cn/docs/zh-CN/r2.0/note/dynamic_shape_func.html>`_ 。

MindSpore中 `mindspore.ops` 接口与上一版本相比，新增、删除和支持平台的变化信息请参考 `mindspore.ops API接口变更 <https://gitee.com/mindspore/docs/blob/r2.0/resource/api_updates/func_api_updates_cn.md>`_ 。
