...
MindSpore中 `mindspore.ops` 接口与上一版本相比，新增、删除和支持平台的变化信息请参考 `API Updates <https://gitee.com/mindspore/docs/blob/r1.8/resource/api_updates/ops_api_updates.md>`_ 。
...
<https://www.mindspore.cn/tutorials/experts/zh-CN/r1.8/parallel/train_ascend.html#准备环节>`_ 。

针对GPU设备，用户需要准备host文件和mpi，详见 `GPU指导文档 \
<https://www.mindspore.cn/tutorials/experts/zh-CN/r1.8/parallel/train_gpu.html#准备环节>`_ 。
