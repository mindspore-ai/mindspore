...
.. py:function:: mindspore.jacrev(fn, grad_position=0, has_aux=False)
    ...
    通过反向模式计算给定网络的Jacobian矩阵，对应 `反向模式自动微分 <https://www.mindspore.cn/docs/zh-CN/r2.2/design/programming_paradigm.html#反向自动微分>`_。当网络输出数量远小于输入数量时，使用反向模式求Jacobian矩阵比前向模式性能更好。
