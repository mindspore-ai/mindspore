...
.. py:function:: mindspore.load(file_name, **kwargs)
    ...
    参数：
        ...
        - **kwargs** (dict) - 配置项字典。
          ...
          - **obf_func** (function) - 导入混淆模型所需要的函数，可以参考 `obfuscate_model() <https://www.mindspore.cn/docs/zh-CN/r2.3.0rc1/api_python/mindspore/mindspore.obfuscate_model.html>`_ 了解详情。
