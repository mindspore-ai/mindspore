...
.. py:method:: load_checkpoint_async(ckpt_file_name, net=None, strict_load=False, filter_prefix=None, dec_key=None, dec_mode="AES-GCM", specify_prefix=None, choice_func=None)
   ...
   返回：
       自定义的ParamDictFuture类， 调用其result方法可以得到load_checkpoint返回的结果。
