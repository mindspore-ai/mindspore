...
- ms_function使用示例
  ...
  .. note::
      目前静态图不支持在Python交互式模式下运行，并且有部分语法限制。`ms_function` 的更多信息可参考 `API ms_function <https://www.mindspore.cn/docs/zh-CN/r1.10/api_python/mindspore/mindspore.ms_function.html>`_ 。
...
- GradOperation使用示例
  ...
  更多细节可参考 `API GradOperation <https://www.mindspore.cn/docs/zh-CN/r1.10/api_python/ops/mindspore.ops.GradOperation.html>`_ 。
...
- mindspore.set_context使用示例
  ...
  更多细节可参考 `API mindspore.set_context <https://www.mindspore.cn/docs/zh-CN/r1.10/api_python/mindspore/mindspore.set_context.html#mindspore.set_context>`_ 。
