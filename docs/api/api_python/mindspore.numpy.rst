...
- GradOperation使用示例
  ...
  更多细节可参考 `API GradOperation <https://www.mindspore.cn/docs/zh-CN/r2.2/api_python/ops/mindspore.ops.GradOperation.html>`_ 。
...
- mindspore.set_context使用示例
  ...
  更多细节可参考 `API mindspore.set_context <https://www.mindspore.cn/docs/zh-CN/r2.2/api_python/mindspore/mindspore.set_context.html#mindspore.set_context>`_ 。
