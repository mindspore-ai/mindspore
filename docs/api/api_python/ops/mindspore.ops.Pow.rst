...
.. py:class:: mindspore.ops.Pow()
    ...
    **输入：**
    ...
    - **x** (Union[Tensor, number.Number, bool]) - 第一个输入，是一个number.Number、bool值或数据类型为 `number <https://www.mindspore.cn/docs/en/r1.7/api_python/mindspore/mindspore.dtype.html#mindspore.dtype>`_ 或 `bool_ <https://www.mindspore.cn/docs/en/r1.7/api_python/mindspore/mindspore.dtype.html#mindspore.dtype>`_ 的Tensor。
