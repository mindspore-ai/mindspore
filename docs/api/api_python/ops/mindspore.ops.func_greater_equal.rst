...
.. py:function:: mindspore.ops.greater_equal(input, other)
    ...
    参数：
        - **input** (Union[Tensor, Number]) - 第一个输入，是一个Number或数据类型为 `number <https://www.mindspore.cn/docs/zh-CN/r2.3.q1/api_python/mindspore/mindspore.dtype.html#mindspore.dtype>`_ 或 `bool_ <https://www.mindspore.cn/docs/zh-CN/r2.3.q1/api_python/mindspore/mindspore.dtype.html#mindspore.dtype>`_ 的Tensor。
