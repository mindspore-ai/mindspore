...
.. py:class:: mindspore.nn.Cell(auto_prefix=True, flags=None)
    ...
    **参数：**
    ...
    .. py:method:: set_boost(boost_type)
        ...
        `algorithm library <https://gitee.com/mindspore/mindspore/tree/r1.8/mindspore/python/mindspore/boost>`_ 算法库中。
    ...
    .. py:method:: set_data_parallel()
        ...
        .. note:: 仅在图模式、inputs** (tuple) - construct方法的输入。全自动并行(AUTO_PARALLEL)模式下生效。
