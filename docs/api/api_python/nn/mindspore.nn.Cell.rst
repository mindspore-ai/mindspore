...
.. py:class:: mindspore.nn.Cell(auto_prefix=True, flags=None)
    ...
    .. py:method:: bprop_debug
        ...
        教程样例：
            - `Cell与参数 - 自定义Cell反向
              <https://mindspore.cn/tutorials/zh-CN/r2.2/advanced/modules/layer.html#自定义cell反向>`_
    ...
    .. py:method:: parameters_and_names(name_prefix='', expand=True)
        ...
        教程样例：
            - `网络构建 - 模型参数 <https://mindspore.cn/tutorials/zh-CN/r2.2/beginner/model.html#模型参数>`_
    ...
    .. py:method:: set_boost(boost_type)
        ...
        `algorithm library <https://gitee.com/mindspore/mindspore/tree/r2.2/mindspore/python/mindspore/boost>`_ 算法库中。
    ...
    .. py:method:: set_train(mode=True)
        ...
        教程样例：
            - `模型训练 - 训练与评估实现 <https://mindspore.cn/tutorials/zh-CN/r2.2/beginner/train.html#训练与评估>`_
    ...
    .. py:method:: trainable_params(recurse=True)
        ...
        教程样例：
            - `模型训练 - 优化器 <https://mindspore.cn/tutorials/zh-CN/r2.2/beginner/train.html#优化器>`_
