...
.. py:class:: mindspore.nn.LazyAdam(params, learning_rate=1e-3, beta1=0.9, beta2=0.999, eps=1e-8, use_locking=False, use_nesterov=False, weight_decay=0.0, loss_scale=1.0)
    ...
    异常：
        - **TypeError** - `learning_rate` 不是int、float、Tensor、Iterable或 `LearningRateSchedule <https://www.mindspore.cn/docs/zh-CN/r2.3.0rc1/api_python/mindspore.nn.html#learningrateschedule%E7%B1%BB>`_ 。
