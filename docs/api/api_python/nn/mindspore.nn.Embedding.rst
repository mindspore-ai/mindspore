...
.. py:class:: mindspore.nn.Embedding(vocab_size, embedding_size, use_one_hot=False, embedding_table="normal", dtype=mstype.float32, padding_idx=None)
    ...
    参数：
        ...
        - **embedding_table** (Union[Tensor, str, Initializer, numbers.Number]) - embedding_table的初始化方法。当指定为字符串，字符串取值请参见类 `mindspore.common.initializer <https://www.mindspore.cn/docs/zh-CN/r2.2/api_python/mindspore.common.initializer.html>`_ 。默认值： ``"normal"`` 。
