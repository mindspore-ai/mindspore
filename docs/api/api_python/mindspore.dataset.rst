...
请参考 `Single-Node Tensor Cache <https://www.mindspore.cn/tutorials/experts/zh-CN/r1.10/dataset/cache.html>`_。
...
- 数据集样本增强操作（map）：用户可以将数据增强算子
  （`vision类 <https://www.mindspore.cn/docs/zh-CN/r1.10/api_python/mindspore.dataset.vision.html>`_，
  `nlp类 <https://www.mindspore.cn/docs/zh-CN/r1.10/api_python/mindspore.dataset.text.html>`_，
  `audio类 <https://www.mindspore.cn/docs/zh-CN/r1.10/api_python/mindspore.dataset.audio.html>`_）
...
`datasets_example.py <https://gitee.com/mindspore/mindspore/tree/r1.10/docs/api/api_python/datasets_example.py>`_：
