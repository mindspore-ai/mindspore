...
请参考 `Single-Node Tensor Cache <https://www.mindspore.cn/tutorials/experts/zh-CN/r2.0/dataset/cache.html>`_ 。
...
- 数据集样本增强操作（map）：用户可以将数据增强操作
  ...
  `audio类 <https://mindspore.cn/docs/zh-CN/r2.0/api_python/mindspore.dataset.transforms.html#音频>`_ ）
