...
请参考 `Single-Node Tensor Cache <https://www.mindspore.cn/tutorials/experts/zh-CN/r1.11/dataset/cache.html>`_ 。
...
- 数据集样本增强操作（map）：用户可以将数据增强操作
  ...
  `audio类 <https://mindspore.cn/docs/zh-CN/r1.11/api_python/mindspore.dataset.transforms.html#音频>`_ ）
...
`datasets_example.py <https://gitee.com/mindspore/mindspore/blob/r1.11/docs/api/api_python/datasets_example.py>`_ ：
