...
- Use GradOperation to compute deratives
  ...
  For more details, see `API GradOperation <https://www.mindspore.cn/docs/en/r2.1/api_python/ops/mindspore.ops.GradOperation.html>`_ .
...
- Use mindspore.set_context to control execution mode
  ...
  For more details, see `API mindspore.set_context <https://www.mindspore.cn/docs/en/r2.1/api_python/mindspore/mindspore.set_context.html#mindspore.set_context>`_ .
