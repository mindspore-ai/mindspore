...
- Use ms_function to run code in static graph mode
  ...
  .. note::
      Currently, static graph cannot run in Python interactive mode and not all python types can be passed into functions decorated with `ms_function`. For details about how to use `ms_function`, see `API ms_function <https://www.mindspore.cn/docs/en/r1.10/api_python/mindspore/mindspore.ms_function.html>`_ .
...
- Use GradOperation to compute deratives
  ...
  For more details, see `API GradOperation <https://www.mindspore.cn/docs/en/r1.10/api_python/ops/mindspore.ops.GradOperation.html>`_ .
...
- Use mindspore.set_context to control execution mode
  ...
  For more details, see `API mindspore.set_context <https://www.mindspore.cn/docs/en/r1.10/api_python/mindspore/mindspore.set_context.html#mindspore.set_context>`_ .
