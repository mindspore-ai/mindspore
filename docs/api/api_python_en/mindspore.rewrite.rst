...
For a quick start of using ReWrite, please refer to `Modifying Network With ReWrite <https://www.mindspore.cn/docs/en/r2.2/api_python/samples/rewrite/rewrite_tutorial.html>`_ .
