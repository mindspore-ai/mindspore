...
.. class:: mindspore.dtype
  ...
  * **Other Type**
    ...
    Type                            Description
    ============================   =================
    ``tensor``                      MindSpore's ``tensor`` type. Data format uses NCHW. For details, see `tensor <https://www.gitee.com/mindspore/mindspore/blob/r2.2/mindspore/python/mindspore/common/tensor.py>`_.
