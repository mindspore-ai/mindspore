...
Compared with the previous version, the added, deleted and supported platforms change information of `mindspore.ops` operators in MindSpore, please refer to the link `<https://gitee.com/mindspore/docs/blob/r1.8/resource/api_updates/ops_api_updates.md>`_.
...
<https://www.mindspore.cn/tutorials/experts/en/r1.8/parallel/train_ascend.html#configuring-distributed-environment-variables>`_ for more details.
For the GPU device, users need to prepare the host file and mpi, please see the `GPU tutorial \
<https://www.mindspore.cn/tutorials/experts/en/r1.8/parallel/train_gpu.html#preparation>`_.
