...
from mindspore.offline_debug.mi_validator_helpers import parse_user_args, \
    type_check, type_check_list, check_dir, check_uint32, check_uint64, \
    check_iteration, check_param
        ...
        for node_name, node_info in check_node_list.items():
            ...
            for info_name, info_param in node_info.items():
                ...
                if info_name in ["rank_id"]:
                    check_param(info_param, info_name="rank_id")
                elif info_name in ["root_graph_id"]:
                    check_param(info_param, info_name="root_graph_id")
