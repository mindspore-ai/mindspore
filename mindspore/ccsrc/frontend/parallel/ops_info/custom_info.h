...
#ifndef MINDSPORE_CCSRC_FRONTEND_PARALLEL_OPS_INFO_CUSTOM_INFO_H_
#define MINDSPORE_CCSRC_FRONTEND_PARALLEL_OPS_INFO_CUSTOM_INFO_H_
...
namespace mindspore {
namespace parallel {
class CustomInfo : public OperatorInfo {
 public:
...
#endif  // MINDSPORE_CCSRC_FRONTEND_PARALLEL_OPS_INFO_CUSTOM_INFO_H_
