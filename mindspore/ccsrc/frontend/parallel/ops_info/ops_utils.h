...
constexpr size_t ROTARY_MUL_INPUTS_SIZE = 3;
constexpr size_t ROTARY_MUL_INPUT_SPLITTABLE_ROW_INDEX = 0;
constexpr size_t ROTARY_MUL_INPUT_SPLITTABLE_COL_INDEX = 2;
