...
void RegMathBpropExpanderOps3() {
  ...
  REGISTER_EXPANDER_BPROP_IMPL(LogicalOr);
}
...
void RegNNBpropExpanderOps3() {
  REGISTER_EXPANDER_BPROP_IMPL(MaxPool);
  REGISTER_EXPANDER_BPROP_IMPL(BatchNorm);
  REGISTER_EXPANDER_BPROP_IMPL(BiasAdd);
  REGISTER_EXPANDER_BPROP_IMPL(GeLU);
}
...
void RegArrayBpropExpanderOps1() {
  ...
  REGISTER_EXPANDER_BPROP_IMPL(Size);
...
void RegArrayBpropExpanderOps2() {
  REGISTER_EXPANDER_BPROP_IMPL(Coalesce);
  REGISTER_EXPANDER_BPROP_IMPL(MaskedFill);
  REGISTER_EXPANDER_BPROP_IMPL(MatrixDiagPartV3);
  REGISTER_EXPANDER_BPROP_IMPL(MatrixSetDiagV3);
  REGISTER_EXPANDER_BPROP_IMPL(ResizeNearestNeighborV2);
  REGISTER_EXPANDER_BPROP_IMPL(SegmentMean);
  REGISTER_EXPANDER_BPROP_IMPL(SegmentSum);
  REGISTER_EXPANDER_BPROP_IMPL(ScatterNdUpdate);
  REGISTER_EXPANDER_BPROP_IMPL(ScatterUpdate);
  ...
  REGISTER_EXPANDER_BPROP_IMPL(TensorScatterMax);
  REGISTER_EXPANDER_BPROP_IMPL(TensorScatterMin);
