 ...
 */
#ifndef DATASET_KERNELS_IMAGE_RANDOM_VERTICAL_FLIP_OP_H_
#define DATASET_KERNELS_IMAGE_RANDOM_VERTICAL_FLIP_OP_H_
...
#endif  // DATASET_KERNELS_IMAGE_RANDOM_VERTICAL_FLIP_OP_H_
