...
#ifndef DATASET_ENGINE_DATASETOPS_SOURCE_CELEBA_OP_H
#define DATASET_ENGINE_DATASETOPS_SOURCE_CELEBA_OP_H
...
#endif  // DATASET_ENGINE_DATASETOPS_SOURCE_CELEBA_OP_H
