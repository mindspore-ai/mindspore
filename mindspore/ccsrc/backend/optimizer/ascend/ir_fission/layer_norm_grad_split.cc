...
void LayerNormGradSplit::CreateOutputsOfLayerNormBetaGammaBackprop(
  ...
  auto shapes = {AnfAlgo::GetOutputInferShape(layer_norm_grad, kLayerNormGradOutputGammaIndex),
                 AnfAlgo::GetOutputInferShape(layer_norm_grad, kLayerNormGradOutputBetaIndex)};
