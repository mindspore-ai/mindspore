...
namespace mindspore {
namespace opt {
const BaseRef AccumulateNV2Fusion::DefinePattern() const {
  VarPtr Xs = std::make_shared<SeqVar>();
  return VectorRef({prim::kPrimAccumulateNV2, Xs});
}

const AnfNodePtr AccumulateNV2Fusion::Process(const FuncGraphPtr &graph, const AnfNodePtr &node,
