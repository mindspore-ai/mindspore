...
class AdamApplyOneWithDecayAssign : public OpDesc {
 public:
  AdamApplyOneWithDecayAssign() {}
  ~AdamApplyOneWithDecayAssign() = default;
 ...
 protected:
  NodePtrList Compute() {
    ...
    auto result = {v_result, m_result, var_result};
    return result;
  }
...
EXPANDER_OP_DESC_REGISTER("AdamApplyOneWithDecayAssign", AdamApplyOneWithDecayAssign);
}  // namespace mindspore::graphkernel::expanders
