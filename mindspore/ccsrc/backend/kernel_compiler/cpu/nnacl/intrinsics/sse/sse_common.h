...
#ifndef MINDSPORE_NNACL_INTRINSICS_SSE_SSE_COMMON_H_
#define MINDSPORE_NNACL_INTRINSICS_SSE_SSE_COMMON_H_
...
#endif  // MINDSPORE_NNACL_INTRINSICS_SSE_SSE_COMMON_H_
