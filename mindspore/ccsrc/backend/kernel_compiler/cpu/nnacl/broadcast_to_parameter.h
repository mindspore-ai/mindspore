 ...
 */
#ifndef MINDSPORE_NNACL_FP32_BROADCAST_TO_PARAMETER_H_
#define MINDSPORE_NNACL_FP32_BROADCAST_TO_PARAMETER_H_
...
#endif  // MINDSPORE_NNACL_FP32_BROADCAST_TO_PARAMETER_H_
