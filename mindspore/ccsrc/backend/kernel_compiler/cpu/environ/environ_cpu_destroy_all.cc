...
namespace mindspore {
namespace kernel {
const std::vector<size_t> &EnvironDestroyAllCpuKernelMod::GetInputSizeList() const { return input_size_list_; }

const std::vector<size_t> &EnvironDestroyAllCpuKernelMod::GetOutputSizeList() const { return output_size_list_; }

const std::vector<size_t> &EnvironDestroyAllCpuKernelMod::GetWorkspaceSizeList() const { return workspace_size_list_; }
