...
class v1ForceRedistributeGpuKernel : public GpuKernel {
 public:
  v1ForceRedistributeGpuKernel() : ele_uint_crd(1) {}
  ~v1ForceRedistributeGpuKernel() override = default;
  ...
  bool Launch(const std::vector<AddressPtr> &inputs, const std::vector<AddressPtr> &,
    ...
    v1ForceRedistribute(atom_numbers, virtual_numbers, v_info_f, uint_crd_f, frc_f,
