...
class v0CoordinateRefreshGpuKernel : public GpuKernel {
 public:
  v0CoordinateRefreshGpuKernel() : ele_uint_crd(1) {}
  ~v0CoordinateRefreshGpuKernel() override = default;
  ...
  bool Launch(const std::vector<AddressPtr> &inputs, const std::vector<AddressPtr> &,
    ...
    v0CoordinateRefresh(atom_numbers, virtual_numbers, v_info_f, uint_crd_f, scaler_f, crd_f,
