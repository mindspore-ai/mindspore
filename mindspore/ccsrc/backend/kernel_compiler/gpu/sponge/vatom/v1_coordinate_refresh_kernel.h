...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_VATOM_V1_FORCE_REDISTRIBUTE_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_VATOM_V1_FORCE_REDISTRIBUTE_KERNEL_H_
...
class v1CoordinateRefreshGpuKernel : public GpuKernel {
 public:
  v1CoordinateRefreshGpuKernel() : ele_uint_crd(1) {}
  ~v1CoordinateRefreshGpuKernel() override = default;
  ...
  bool Launch(const std::vector<AddressPtr> &inputs, const std::vector<AddressPtr> &,
    ...
    v1CoordinateRefresh(atom_numbers, virtual_numbers, v_info_f, uint_crd_f, scaler_f, crd_f,
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_VATOM_V1_FORCE_REDISTRIBUTE_KERNEL_H_
