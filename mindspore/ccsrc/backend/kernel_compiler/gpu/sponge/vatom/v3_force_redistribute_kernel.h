...
class v3ForceRedistributeGpuKernel : public GpuKernel {
 public:
  v3ForceRedistributeGpuKernel() : ele_uint_crd(1) {}
  ~v3ForceRedistributeGpuKernel() override = default;
  ...
  bool Launch(const std::vector<AddressPtr> &inputs, const std::vector<AddressPtr> &,
    ...
    v3ForceRedistribute(atom_numbers, virtual_numbers, v_info_f, uint_crd_f, scaler_f, frc_f,
