...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_VATOM_V0_FORCE_REDISTRIBUTE_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_VATOM_V0_FORCE_REDISTRIBUTE_KERNEL_H_
...
class v0ForceRedistributeGpuKernel : public GpuKernel {
 public:
  v0ForceRedistributeGpuKernel() : ele_uint_crd(1) {}
  ~v0ForceRedistributeGpuKernel() override = default;
  ...
  bool Init(const CNodePtr &kernel_node) override {
    ...
    auto shape_v_info = AnfAlgo::GetPrevNodeOutputInferShape(kernel_node, 1);
  ...
  bool Launch(const std::vector<AddressPtr> &inputs, const std::vector<AddressPtr> &,
    ...
    auto v_info_f = GetDeviceAddress<T>(inputs, 1);
    auto frc_f = GetDeviceAddress<T>(outputs, 0);

    v0ForceRedistribute(atom_numbers, virtual_numbers, v_info_f, uint_crd_f, frc_f,
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_VATOM_V0_FORCE_REDISTRIBUTE_KERNEL_H_
