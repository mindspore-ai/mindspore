...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_VATOM_V3_FORCE_REDISTRIBUTE_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_VATOM_V3_FORCE_REDISTRIBUTE_KERNEL_H_
...
class v3CoordinateRefreshGpuKernel : public GpuKernel {
 public:
  v3CoordinateRefreshGpuKernel() : ele_uint_crd(1) {}
  ~v3CoordinateRefreshGpuKernel() override = default;
  ...
  bool Launch(const std::vector<AddressPtr> &inputs, const std::vector<AddressPtr> &,
    ...
    v3CoordinateRefresh(atom_numbers, virtual_numbers, v_info_f, uint_crd_f, scaler_f, crd_f,
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_VATOM_V3_FORCE_REDISTRIBUTE_KERNEL_H_
