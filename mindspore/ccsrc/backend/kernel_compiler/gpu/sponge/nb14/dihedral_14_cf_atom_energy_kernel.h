...
class Dihedral14CFAtomEnergyGpuKernelMod : public NativeGpuKernelMod {
 public:
  Dihedral14CFAtomEnergyGpuKernelMod() : ele_uint_crd(1) {}
  ~Dihedral14CFAtomEnergyGpuKernelMod() override = default;
