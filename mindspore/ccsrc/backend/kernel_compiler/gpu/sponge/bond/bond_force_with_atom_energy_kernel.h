...
class BondForceWithAtomEnergyGpuKernelMod : public NativeGpuKernelMod {
 public:
  BondForceWithAtomEnergyGpuKernelMod() : ele_uint_crd(1) {}
  ~BondForceWithAtomEnergyGpuKernelMod() override = default;
