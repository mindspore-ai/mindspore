...
class TensorScatterAddFwdGpuKernelMod : public NativeGpuKernelMod {
 public:
  TensorScatterAddFwdGpuKernelMod()
      : input_size_(1),
        update_size_(1),
        indices_size_(1),
        output_size_(1),
  ...
  bool Launch(const std::vector<AddressPtr> &inputs, const std::vector<AddressPtr> &workspace,
    ...
    if (!memcpy_flag_) {
      ...
      CHECK_CUDA_RET_WITH_EXCEPT(kernel_node_,
                                 ...
                                 "cudaMemcpy failed in TensorScatterAddFwdGpuKernelMod::Launch.");
      CHECK_CUDA_RET_WITH_EXCEPT(kernel_node_,
