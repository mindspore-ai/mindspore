...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_MATH_TRUNCATE_MOD_KERNEL_H
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_MATH_TRUNCATE_MOD_KERNEL_H
...
template <typename T>
class TruncateModOpGpuKernel : public GpuKernel {
 public:
  TruncateModOpGpuKernel() { ResetResource(); }
  ~TruncateModOpGpuKernel() override = default;
  ...
  void ResetResource() noexcept override {
    op_type_ = BROADCAST_TYPE_TRUNCATEMOD;
