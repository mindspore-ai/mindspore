...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_MATH_TRUNCATE_DIV_KERNEL_H
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_MATH_TRUNCATE_DIV_KERNEL_H
...
template <typename T>
class TruncateDivOpGpuKernel : public GpuKernel {
 public:
  TruncateDivOpGpuKernel() { ResetResource(); }
  ~TruncateDivOpGpuKernel() override = default;
  ...
  void ResetResource() noexcept override {
    op_type_ = BROADCAST_TYPE_TRUNCATEDIV;
