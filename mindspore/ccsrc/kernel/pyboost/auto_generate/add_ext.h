...
namespace kernel {
namespace pyboost {
class BACKEND_EXPORT AddExt : public pyboost::Op {
 public:
  AddExt() = default;
  ~AddExt() = default;

  virtual tensor::TensorPtr Call(const tensor::TensorPtr &self, const tensor::TensorPtr &other,
                                 const ScalarPtr &alpha = kOneScalar) = 0;
};
}  // namespace pyboost
}  // namespace kernel
}  // namespace mindspore
