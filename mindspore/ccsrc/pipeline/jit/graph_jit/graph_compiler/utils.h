...
class GraphUtils {
 public:
  ...
  static AnfNodePtr GetOperationNode(int op_code, int op_arg, const AbstractBasePtrList &abs_list);

  static AnfNodePtr ConvertPythonObjectToAnfNode(const py::object &object);

  static py::object CreatePythonClassInstance(const py::object &cls, const py::object &args, const py::object &kwargs);

  static void ResolveFuncGraph(const FuncGraphPtr &func_graph);

  static void InferAnfNode(const AnfNodePtr &node);
