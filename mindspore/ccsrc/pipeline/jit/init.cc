...
PYBIND11_MODULE(_c_expression, m) {
  ...
  (void)py::class_<PSContext, std::shared_ptr<PSContext>>(m, "PSContext")
    ...
    .def("set_server_domain", &PSContext::set_server_domain, "Set server http server domain, example: 127.0.0.1:8080.")
    .def("server_domain", &PSContext::server_domain, "Get server http server domain.");
