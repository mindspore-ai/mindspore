...
#ifndef MINDSPORE_CCSRC_TRANSFORM_GRAPH_IR_OP_DECLARE_CANDIDATE_SAMPLING_OPS_DECLARE_H_
...
DECLARE_OP_ADAPTER(UniformCandidateSampler)
DECLARE_OP_USE_OUTPUT(UniformCandidateSampler)
