...
ATTR_MAP(ReverseV2D) = {{"axis", ATTR_DESC(axis, AnyTraits<std::vector<int64_t>>())}};
OUTPUT_MAP(ReverseV2D) = {{0, OUTPUT_DESC(y)}};
REG_ADPT_DESC(ReverseV2D, kNameReverseV2D, ADPT_DESC(ReverseV2D))
REG_ADPT_DESC(ReverseV2, kNameReverseV2, ADPT_DESC(ReverseV2D))
