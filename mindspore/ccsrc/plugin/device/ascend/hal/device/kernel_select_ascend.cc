...
static const std::unordered_set<std::string> kAclKernelSet = {kAssignOpName,
                                                              kAssignAddOpName,
                                                              kBatchMatMulOpName,
                                                              kBNInferOpName,
...
static const std::unordered_set<std::string> kAclBlackList = {
  kAddNOpName,        kTransposeOpName,  kGatherV2OpName,      kAvgPool3DOpName,   kResizeBilinearV2OpName,
  kIndexAddOpName,    kOneHotOpName,     kTransDataOpName,     kCastOpName,        kROIAlignGradName,
  kSquareSumV1OpName, kDynamicRNNOpName, kKLDivLossGradOpName, kTransDataRNNOpName};
