...
void GeDeviceContext::Initialize() {
  ...
  if (soc_version == "ascend910b") {
    bool is_saturation = (common::GetEnv("MS_ASCEND_910B_CHECK_OVERFLOW_MODE") == "SATURATION_MODE");
    auto mode = (is_saturation) ? aclrtFloatOverflowMode::ACL_RT_OVERFLOW_MODE_SATURATION
