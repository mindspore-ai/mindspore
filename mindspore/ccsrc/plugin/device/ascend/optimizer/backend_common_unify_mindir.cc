...
#include "plugin/device/ascend/optimizer/enhancer/add_placeholder_for_op_with_optional_inputs.h"
...
void GetBackendCommonUnifyMindIRPassManager(PassManagerPtr *unify_mindir_pm) {
  ...
  (*unify_mindir_pm)->AddPass(std::make_shared<opt::InsertPlaceholderForOpWithOptionalInputs>());
