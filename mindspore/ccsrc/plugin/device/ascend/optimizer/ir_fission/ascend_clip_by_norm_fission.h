...
#ifndef MINDSPORE_CCSRC_BACKEND_OPTIMIZER_PASS_ASCEND_CLIP_BY_NORM_FISSION_H_
#define MINDSPORE_CCSRC_BACKEND_OPTIMIZER_PASS_ASCEND_CLIP_BY_NORM_FISSION_H_
...
class AscendClipByNormFission : public PatternProcessPass {
 public:
  ...
  ~AscendClipByNormFission() override = default;
...
#endif  // MINDSPORE_CCSRC_BACKEND_OPTIMIZER_PASS_ASCEND_CLIP_BY_NORM_FISSION_H_
