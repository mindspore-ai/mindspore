...
class RemoveHostKernel : public PatternProcessPass {
 public:
  RemoveHostKernel() : PatternProcessPass("remove_host_kernel") {}
  ~RemoveHostKernel() override = default;
...
#endif  // MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_OPTIMIZER_FORMAT_TYPE_REMOVE_HOST_KERNEL_H_
