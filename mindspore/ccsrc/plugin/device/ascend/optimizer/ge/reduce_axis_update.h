...
#ifndef MINDSPORE_CCSRC_BACKEND_OPTIMIZER_ASCEND_GE_REDUCE_AXIS_UPDATE_H_
#define MINDSPORE_CCSRC_BACKEND_OPTIMIZER_ASCEND_GE_REDUCE_AXIS_UPDATE_H_
...
#endif  // MINDSPORE_CCSRC_BACKEND_OPTIMIZER_ASCEND_GE_REDUCE_AXIS_UPDATE_H_
