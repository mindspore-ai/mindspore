 ...
 */
#ifndef MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_OPTIMIZER_GE_GE_CONVERT_CONST_INPUT_TO_TENSOR_INPUT_H_
...
#endif  // MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_OPTIMIZER_GE_GE_CONVERT_CONST_INPUT_TO_TENSOR_INPUT_H_
