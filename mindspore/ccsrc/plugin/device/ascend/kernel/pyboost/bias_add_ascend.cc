...
bool BiasAddAscend::Launch(const tensor::TensorPtr &input_x, const tensor::TensorPtr &bias,
  ...
  auto output_address = runtime::DeviceAddressUtils::CreateOutputTensorAddress(device_context, output, "output", false);
  ...
  bias_add_kernel->PackageInput(kIndex0, "", &input_x_shape);
  bias_add_kernel->PackageInput(kIndex1, "", &bias_shape);
