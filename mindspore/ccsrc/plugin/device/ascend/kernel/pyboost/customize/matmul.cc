...
#include "plugin/device/ascend/kernel/pyboost/customize/matmul.h"
#include <memory>
...
tensor::TensorPtr MatMulAscendCustomize(const std::shared_ptr<OpRunner> &op, const TensorPtr &input_tensor,
  ...
  PyBoostUtils::DispatchRun(
    std::make_shared<runtime::PyBoostDeviceTask>([op, input_tensor, mat2_tensor, transpose_a_imm, transpose_b_imm]() {
