...
#include "plugin/device/ascend/kernel/pyboost/customize/masked_select_ext.h"
...
tensor::BaseTensorPtr MaskedSelectExtAscendCustomize(const std::shared_ptr<OpRunner> &op,
