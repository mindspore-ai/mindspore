...
namespace mindspore {
namespace kernel {
MS_ACLNN_COMMON_KERNEL_FACTORY_REG(Div, aclnnDiv, 3)
MS_ACLNN_COMMON_KERNEL_FACTORY_REG(Equal, aclnnEqTensor, 3)
MS_ACLNN_COMMON_KERNEL_FACTORY_REG(Exp, aclnnExp, 2)
MS_ACLNN_COMMON_KERNEL_FACTORY_REG(Greater, aclnnGtTensor, 3)
...
MS_ACLNN_COMMON_KERNEL_FACTORY_REG(Mul, aclnnMul, 3)
MS_ACLNN_COMMON_KERNEL_FACTORY_REG(Neg, aclnnNeg, 2)
...
MS_ACLNN_COMMON_KERNEL_FACTORY_REG(Sqrt, aclnnSqrt, 2)
}  // namespace kernel
}  // namespace mindspore
