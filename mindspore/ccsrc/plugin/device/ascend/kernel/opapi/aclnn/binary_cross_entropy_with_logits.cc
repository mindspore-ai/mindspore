 ...
 */
#include "plugin/device/ascend/kernel/opapi/aclnn/binary_cross_entropy_with_logits.h"
#include <vector>
...
MS_ACLNN_KERNEL_FACTORY_REG(BinaryCrossEntropyWithLogits, BinaryCrossEntropyWithLogitsAclnnKernelMod);
}  // namespace kernel
}  // namespace mindspore
