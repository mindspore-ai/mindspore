 ...
 */
#include "plugin/device/ascend/kernel/opapi/aclnn/l1_loss_ext_aclnn_kernel.h"
#include <vector>
...
bool L1LossExtAclnnKernelMod::Launch(const std::vector<KernelTensor *> &inputs,
  ...
  ParseGenExecutor(
    GEN_EXECUTOR_BOOST(op_type_, hash_id_, inputs[kIndex0], inputs[kIndex1], reduction_, outputs[kIndex0]));
