 ...
 */
#include "plugin/device/ascend/kernel/opapi/aclnn/avg_pool2d_grad_aclnn_kernel.h"
...
bool AvgPool2DGradAscend::Launch(const std::vector<KernelTensor *> &inputs,
  ...
  ParseGenExecutor(GEN_EXECUTOR_BOOST(op_type_, hash_id_, inputs[0], inputs[1], kernel_size, stride, padding, ceil_mode,
