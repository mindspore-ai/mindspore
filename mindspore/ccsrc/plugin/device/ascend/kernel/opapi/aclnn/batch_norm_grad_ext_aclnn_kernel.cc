 ...
 */
#include "plugin/device/ascend/kernel/opapi/aclnn/batch_norm_grad_ext_aclnn_kernel.h"
#include <algorithm>
#include <vector>
#include <memory>
#include <functional>
...
void BatchNormGradExtAscend::GetWorkSpaceInfo(const std::vector<KernelTensor *> &inputs,
  ...
  GetWorkspaceForResize(inputs[kIndex0], inputs[kIndex1], inputs[kIndex2], inputs[kIndex3], inputs[kIndex4],
                        inputs[kIndex5], inputs[kIndex6], training, eps, output_mask, outputs[kIndex0],
