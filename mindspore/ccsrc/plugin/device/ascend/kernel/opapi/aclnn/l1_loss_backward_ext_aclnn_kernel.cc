 ...
 */
#include "plugin/device/ascend/kernel/opapi/aclnn/l1_loss_backward_ext_aclnn_kernel.h"
#include <vector>
...
void L1LossBackwardExtAclnnKernelMod::GetWorkSpaceInfo(const std::vector<KernelTensor *> &inputs,
  ...
  if (iter == reduction_map.end()) {
    MS_LOG(EXCEPTION) << "For L1LossBackward, the value of reduction is invalid.";
  }
