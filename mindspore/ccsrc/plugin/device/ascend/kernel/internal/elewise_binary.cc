...
REG_MS_TO_INTERNAL_IN_TENSOR_IDX_MAP(NotEqual, 2, 0, 1);
REG_MS_TO_INTERNAL_OUT_TENSOR_IDX_MAP(NotEqual, 1, 0);
MS_INTERNAL_KERNEL_FACTORY_REG(Add, InternalAdd);
REG_MS_TO_INTERNAL_IN_TENSOR_IDX_MAP(Add, 2, 0, 1);
REG_MS_TO_INTERNAL_OUT_TENSOR_IDX_MAP(Add, 1, 0);
MS_INTERNAL_KERNEL_FACTORY_REG(Sub, InternalSub);
REG_MS_TO_INTERNAL_IN_TENSOR_IDX_MAP(Sub, 2, 0, 1);
REG_MS_TO_INTERNAL_OUT_TENSOR_IDX_MAP(Sub, 1, 0);
MS_INTERNAL_KERNEL_FACTORY_REG(Equal, InternalEqual);
REG_MS_TO_INTERNAL_IN_TENSOR_IDX_MAP(Equal, 2, 0, 1);
REG_MS_TO_INTERNAL_OUT_TENSOR_IDX_MAP(Equal, 1, 0);
MS_INTERNAL_KERNEL_FACTORY_REG(Less, InternalLess);
REG_MS_TO_INTERNAL_IN_TENSOR_IDX_MAP(Less, 2, 0, 1);
REG_MS_TO_INTERNAL_OUT_TENSOR_IDX_MAP(Less, 1, 0);
MS_INTERNAL_KERNEL_FACTORY_REG(Mul, InternalMul);
REG_MS_TO_INTERNAL_IN_TENSOR_IDX_MAP(Mul, 2, 0, 1);
REG_MS_TO_INTERNAL_OUT_TENSOR_IDX_MAP(Mul, 1, 0);
MS_INTERNAL_KERNEL_FACTORY_REG(RealDiv, InternalRealDiv);
REG_MS_TO_INTERNAL_IN_TENSOR_IDX_MAP(RealDiv, 2, 0, 1);
REG_MS_TO_INTERNAL_OUT_TENSOR_IDX_MAP(RealDiv, 1, 0);
}  // namespace kernel
}  // namespace mindspore
