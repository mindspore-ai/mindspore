...
CUST_IMPLEMT_VERIFIER(SegmentMean, SegmentMeanVerify) {
...
IMPLEMT_COMMON_INFERFUNC(SegmentMeanInferShape) {
...
CUST_COMMON_INFER_FUNC_REG(SegmentMean, SegmentMeanInferShape);
CUST_VERIFY_FUNC_REG(SegmentMean, SegmentMeanVerify);
// ----------------SegmentMax END-------------------
}  // namespace ge