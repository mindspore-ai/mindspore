...
#include "inc/sparse_apply_momentum.h"
...
CUST_IMPLEMT_VERIFIER(SparseApplyMomentum, SparseApplyMomentumVerify) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter SparseApplyMomentum proto verifyFunction!");
...
IMPLEMT_COMMON_INFERFUNC(SparseApplyMomentumInferShape) {
  OP_LOGI(TbeGetName(op).c_str(), "Enter SparseApplyMomentum op_proto inferfunction!");
...
CUST_COMMON_INFER_FUNC_REG(SparseApplyMomentum, SparseApplyMomentumInferShape);
CUST_VERIFY_FUNC_REG(SparseApplyMomentum, SparseApplyMomentumVerify);
// ----------------SparseApplyMomentum END-------------------
}  // namespace ge