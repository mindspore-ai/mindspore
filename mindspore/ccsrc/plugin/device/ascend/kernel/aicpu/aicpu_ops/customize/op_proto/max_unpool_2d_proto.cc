...
#include <string>
#include "inc/max_unpool_2d_op.h"
...
// ---------------------MaxUnpool2D---------------------
CUST_IMPLEMT_VERIFIER(MaxUnpool2D, MaxUnpool2DVerify) {
...
CUST_IMPLEMT_INFERFUNC(MaxUnpool2D, MaxUnpool2DInferShape) {
...
CUST_INFER_FUNC_REG(MaxUnpool2D, MaxUnpool2DInferShape);
CUST_VERIFY_FUNC_REG(MaxUnpool2D, MaxUnpool2DVerify);
// ---------------------MaxUnpool2D---------------------
}  // namespace ge