...
#include "inc/sparse_segment_mean_with_num_segments_op.h"
#include "register/op_impl_registry.h"
#include "utils/util.h"
#include "utils/common_shape_fns.h"

namespace ge {
CUST_IMPLEMT_INFERFUNC(SparseSegmentMeanWithNumSegments, SparseSegmentMeanWithNumSegmentsInfer) {
...
CUST_INFER_FUNC_REG(SparseSegmentMeanWithNumSegments, SparseSegmentMeanWithNumSegmentsInfer);
}  // namespace ge