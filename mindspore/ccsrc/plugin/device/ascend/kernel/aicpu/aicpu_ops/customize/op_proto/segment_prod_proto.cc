...
CUST_IMPLEMT_VERIFIER(SegmentProd, SegmentProdVerify) {
...
IMPLEMT_COMMON_INFERFUNC(SegmentProdInferShape) {
...
CUST_COMMON_INFER_FUNC_REG(SegmentProd, SegmentProdInferShape);
CUST_VERIFY_FUNC_REG(SegmentProd, SegmentProdVerify);
}  // namespace ge