...
RER_GPU_DYNAMIC_CONST_TO_ATTR(kEmbeddingLookupOpName, 2, 3, 4, 5);
RER_GPU_DYNAMIC_CONST_TO_ATTR(kExpandDimsOpName, 1);
...
RER_GPU_DYNAMIC_CONST_TO_ATTR(kScatterNdOpName, 2);
RER_GPU_DYNAMIC_CONST_TO_ATTR(kTransposeOpName, 1);

RER_GPU_STATIC_CONST_TO_ATTR(kApplyRMSPropOpname, 5, 6, 7);
RER_GPU_STATIC_CONST_TO_ATTR(kArgminV2OpName, 1);
RER_GPU_STATIC_CONST_TO_ATTR(kAvgPool3DGradOpName, 0);
RER_GPU_STATIC_CONST_TO_ATTR(kAvgPoolGradVmOpName, 0);
RER_GPU_STATIC_CONST_TO_ATTR(kBatchToSpaceOpName, 1);
RER_GPU_STATIC_CONST_TO_ATTR(kCastOpName, 1);
RER_GPU_STATIC_CONST_TO_ATTR(kCentralizationOpName, 1);
RER_GPU_STATIC_CONST_TO_ATTR(kConcatOpName, 0);
...
RER_GPU_STATIC_CONST_TO_ATTR(kConv3DBackpropFilterOpName, 2);
RER_GPU_STATIC_CONST_TO_ATTR(kConv3DBackpropInputOpName, 2);
RER_GPU_STATIC_CONST_TO_ATTR(kConv3DTransposeOpName, 2);
...
RER_GPU_STATIC_CONST_TO_ATTR(kGatherOpName, 2);
...
RER_GPU_STATIC_CONST_TO_ATTR(kResizeBilinearV2OpName, 1);
RER_GPU_STATIC_CONST_TO_ATTR(kResizeNearestNeighborGradOpName, 1);
RER_GPU_STATIC_CONST_TO_ATTR(kROIAlignGradName, 2);
RER_GPU_STATIC_CONST_TO_ATTR(kScatterNdOpName, 2);
RER_GPU_STATIC_CONST_TO_ATTR(kSimpleMeanGradOpName, 1);
RER_GPU_STATIC_CONST_TO_ATTR(kSliceGradOpName, 2, 3);
...
RER_GPU_STATIC_CONST_TO_ATTR(kSplitOpName, 0);
RER_GPU_STATIC_CONST_TO_ATTR(kStridedSliceAssignOpName, 1, 2, 3);
RER_GPU_STATIC_CONST_TO_ATTR(kStridedSliceGradOpName, 1, 2, 3, 4);
...
RER_GPU_STATIC_CONST_TO_ATTR(kUnsortedSegmentMaxOpName, 2);
RER_GPU_STATIC_CONST_TO_ATTR(kUnsortedSegmentMinOpName, 2);
