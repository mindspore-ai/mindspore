...
bool MapTensorGetDataGpuKernelMod::Init(const std::vector<KernelTensor *> &inputs,
...
int MapTensorGetDataGpuKernelMod::Resize(const std::vector<KernelTensor *> &inputs,
                                         const std::vector<KernelTensor *> &outputs) {
  ResetResource();
