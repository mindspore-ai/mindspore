...
#include "plugin/device/gpu/kernel/nn/fractional_max_pool_gpu_kernel.h"
#include <utility>
#include <iostream>
...
bool FractionalMaxPoolGpuKernelMod::Init(const BaseOperatorPtr &base_operator,
...
int FractionalMaxPoolGpuKernelMod::Resize(const BaseOperatorPtr &base_operator,
                                          const std::vector<KernelTensorPtr> &inputs,
                                          const std::vector<KernelTensorPtr> &outputs,
