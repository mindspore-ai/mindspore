...
#ifndef MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_NN_FTRL_GPU_KERNEL_H_
#define MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_NN_FTRL_GPU_KERNEL_H_
...
class FtrlGpuKernelMod : public NativeGpuKernelMod {
 ...
 protected:
  ...
  using FtrlLaunchFunc = std::function<bool(FtrlGpuKernelMod *, const std::vector<kernel::KernelTensor *> &,
                                            const std::vector<kernel::KernelTensor *> &,
                                            const std::vector<kernel::KernelTensor *> &, void *)>;

 private:
  FtrlLaunchFunc kernel_func_;
  static std::vector<std::pair<KernelAttr, FtrlLaunchFunc>> func_list_;
...
#endif  // MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_NN_FTRL_GPU_KERNEL_H_
