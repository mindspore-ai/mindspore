...
bool AdaptiveAvgPool3DGpuKernelMod::Launch(const std::vector<AddressPtr> &inputs,
...
bool AdaptiveAvgPool3DGpuKernelMod::Init(const BaseOperatorPtr &base_operator,
...
int AdaptiveAvgPool3DGpuKernelMod::Resize(const BaseOperatorPtr &base_operator,
                                          const std::vector<KernelTensorPtr> &inputs,
                                          const std::vector<KernelTensorPtr> &outputs,
