...
#include "plugin/device/gpu/kernel/nn/softmarginloss_grad_gpu_kernel.h"
#include <utility>
namespace mindspore {
namespace kernel {
namespace {
...
bool SoftMarginLossGradGpuKernelMod::Launch(const std::vector<AddressPtr> &inputs,
...
bool SoftMarginLossGradGpuKernelMod::Init(const BaseOperatorPtr &base_operator,
                                          const std::vector<KernelTensorPtr> &inputs,
                                          const std::vector<KernelTensorPtr> &outputs) {
  auto kernel_ptr = std::dynamic_pointer_cast<ops::SoftMarginLossGrad>(base_operator);
...
int SoftMarginLossGradGpuKernelMod::Resize(const BaseOperatorPtr &base_operator,
                                           const std::vector<KernelTensorPtr> &inputs,
                                           const std::vector<KernelTensorPtr> &outputs,
