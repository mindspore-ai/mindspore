...
class LJForceWithVirialEnergyUpdateGpuKernelMod : public DeprecatedNativeGpuKernelMod {
 public:
  LJForceWithVirialEnergyUpdateGpuKernelMod() : ele_uint_crd(1) {}
  ~LJForceWithVirialEnergyUpdateGpuKernelMod() override = default;
