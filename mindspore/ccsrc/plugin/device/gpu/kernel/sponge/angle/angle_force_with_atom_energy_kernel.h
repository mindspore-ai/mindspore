...
class AngleForceWithAtomEnergyGpuKernelMod : public DeprecatedNativeGpuKernelMod {
 public:
  AngleForceWithAtomEnergyGpuKernelMod() : ele_uint_crd(1) {}
  ~AngleForceWithAtomEnergyGpuKernelMod() override = default;
