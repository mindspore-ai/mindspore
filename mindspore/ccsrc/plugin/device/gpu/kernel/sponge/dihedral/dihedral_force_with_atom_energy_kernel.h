...
class DihedralForceWithAtomEnergyGpuKernelMod : public DeprecatedNativeGpuKernelMod {
 public:
  DihedralForceWithAtomEnergyGpuKernelMod() : ele_uint_crd(1) {}
  ~DihedralForceWithAtomEnergyGpuKernelMod() override = default;
