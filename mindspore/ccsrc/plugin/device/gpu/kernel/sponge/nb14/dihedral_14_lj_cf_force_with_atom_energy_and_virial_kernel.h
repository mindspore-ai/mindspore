...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_NB14_DIHEDRAL_14_LJ_CF_FORCE_WITH_ATOM_ENE_VIRIAL_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_SPONG_NB14_DIHEDRAL_14_LJ_CF_FORCE_WITH_ATOM_ENE_VIRIAL_KERNEL_H_
...
class Dihedral14LJCFForceWithAtomEnergyAndVirialGpuKernelMod : public DeprecatedNativeGpuKernelMod {
 public:
  Dihedral14LJCFForceWithAtomEnergyAndVirialGpuKernelMod() : ele_uint_crd(1) {}
  ~Dihedral14LJCFForceWithAtomEnergyAndVirialGpuKernelMod() override = default;
  ...
  bool Init(const CNodePtr &kernel_node) override {
    ...
    ele_lj_scale_factor *= SizeOf(shape_lj_scale_factor);
    ele_cf_scale_factor *= SizeOf(shape_cf_scale_factor);
    ele_LJ_type_A *= SizeOf(shape_LJ_type_A);
    ele_LJ_type_B *= SizeOf(shape_LJ_type_B);
