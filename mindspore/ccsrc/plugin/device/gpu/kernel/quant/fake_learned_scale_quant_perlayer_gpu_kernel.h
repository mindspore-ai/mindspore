...
namespace mindspore {
namespace kernel {
class FakeLearnedScaleQuantPerLayerGpuKernelMod : public DeprecatedNativeGpuKernelMod {
 public:
  FakeLearnedScaleQuantPerLayerGpuKernelMod();
  ~FakeLearnedScaleQuantPerLayerGpuKernelMod() = default;
