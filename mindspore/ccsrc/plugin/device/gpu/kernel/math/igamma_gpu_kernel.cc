...
#include <algorithm>
#include <utility>
#include "plugin/device/gpu/kernel/math/igamma_gpu_kernel.h"
...
bool IgammaGpuKernelMod::Launch(const std::vector<AddressPtr> &inputs, const std::vector<AddressPtr> &workspace,
