...
#include "mindspore/core/ops/triu_indices.h"
#include "plugin/factory/ms_factory.h"
#include "plugin/device/gpu/kernel/gpu_kernel.h"
#include "plugin/device/gpu/kernel/gpu_kernel_factory.h"
#include "plugin/device/gpu/kernel/cuda_impl/cuda_ops/triu_indices_impl.cuh"
...
class TriuIndicesGpuKernelMod : public NativeGpuKernelMod {
 ...
 private:
  ...
  using TriuIndicesFunc =
    std::function<bool(TriuIndicesGpuKernelMod *, const std::vector<kernel::AddressPtr> &,
