...
namespace mindspore {
namespace kernel {
class TensorArraySizeKernelMod : public DeprecatedNativeGpuKernelMod {
 public:
  TensorArraySizeKernelMod();
  ~TensorArraySizeKernelMod() = default;
...
MS_REG_GPU_KERNEL(TensorArraySize, TensorArraySizeKernelMod)
}  // namespace kernel
}  // namespace mindspore
