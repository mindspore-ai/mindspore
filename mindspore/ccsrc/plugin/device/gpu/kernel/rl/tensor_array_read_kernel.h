...
namespace mindspore {
namespace kernel {
class TensorArrayReadKernelMod : public DeprecatedNativeGpuKernelMod {
 public:
  TensorArrayReadKernelMod();
  ~TensorArrayReadKernelMod() = default;
...
MS_REG_GPU_KERNEL(TensorArrayRead, TensorArrayReadKernelMod)
}  // namespace kernel
}  // namespace mindspore
