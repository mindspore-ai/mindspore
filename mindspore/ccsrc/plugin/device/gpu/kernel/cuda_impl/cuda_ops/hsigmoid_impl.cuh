...
template <typename T>
CUDA_LIB_EXPORT cudaError_t CalHSigmoid(const size_t &size, const T *input, T *output, cudaStream_t cuda_stream);

template <typename T>
CUDA_LIB_EXPORT cudaError_t CalHSigmoidGrad(const size_t &size, const T *dout, const T *x, T *output,
