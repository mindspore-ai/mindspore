...
CUDA_LIB_EXPORT cudaError_t CalUniqueWithPad(const T *input, int num_elements, S *input_index, S *sorted_index,
                                             T *output, S *index, cudaStream_t cuda_stream, T *pad_num);
