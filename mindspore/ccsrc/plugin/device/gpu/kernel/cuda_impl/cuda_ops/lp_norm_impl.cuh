...
template <typename T>
CUDA_LIB_EXPORT cudaError_t CalLpNorm(const T *input, const size_t *input_shape, size_t input_shape_length,
                                      size_t input_elements, const size_t *output_axis, size_t output_shape_length,
                                      size_t output_elements, float p, float eps, float *middle_output, T *output,
