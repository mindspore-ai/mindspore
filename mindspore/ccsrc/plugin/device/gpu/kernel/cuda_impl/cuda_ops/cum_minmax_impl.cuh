...
CUDA_LIB_EXPORT void CumMinMax(CumOpType cum_op_type, const DataType *input_ptr, size_t *workspace_ptr,
                               DataType *value_ptr, IndexType *index_ptr, size_t element_size, size_t axis_size,
                               size_t inner_size, const uint32_t &device_id, cudaStream_t cuda_stream);
