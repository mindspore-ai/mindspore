...
CUDA_LIB_EXPORT cudaError_t CumMin(const DataType *input_ptr, DataType *value_ptr, IndexType *index_ptr,
                                   size_t outer_size, size_t axis_size, size_t inner_size, const uint32_t &device_id,
                                   cudaStream_t cuda_stream);

template <typename DataType, typename IndexType>
CUDA_LIB_EXPORT cudaError_t CumMax(const DataType *input_ptr, DataType *value_ptr, IndexType *index_ptr,
                                   size_t outer_size, size_t axis_size, size_t inner_size, const uint32_t &device_id,
                                   cudaStream_t cuda_stream);
