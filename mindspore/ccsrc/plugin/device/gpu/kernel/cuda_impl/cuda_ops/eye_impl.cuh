...
template <typename T>
CUDA_LIB_EXPORT cudaError_t BatchEye(const size_t size, const size_t dim, T *output_addr, cudaStream_t cuda_stream);

template <typename T>
CUDA_LIB_EXPORT cudaError_t CudaEye(const size_t out_size, const int64_t nums, const int64_t cols, T *out,
