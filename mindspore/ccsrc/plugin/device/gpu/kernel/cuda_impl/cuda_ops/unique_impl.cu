...
cudaError_t CalUnique(const T *input, int num_elements, S *input_index, S *sorted_index, T *output, S *index,
  ...
  thrust::stable_sort_by_key(policy, thrust::device_pointer_cast(output),
  ...
  output_end =
    thrust::unique(policy, thrust::device_pointer_cast(output), thrust::device_pointer_cast(output) + num_elements);
  *output_size = thrust::distance(thrust::device_pointer_cast(output), output_end);
  return GetCudaStatus();
}

template CUDA_LIB_EXPORT cudaError_t CalUnique<float, int>(const float *input, int num_elements, int *input_index,
                                                           int *sorted_index, float *output, int *index,
                                                           cudaStream_t cuda_stream, int *output_size);
template CUDA_LIB_EXPORT cudaError_t CalUnique<half, int>(const half *input, int num_elements, int *input_index,
                                                          int *sorted_index, half *output, int *index,
                                                          cudaStream_t cuda_stream, int *output_size);
template CUDA_LIB_EXPORT cudaError_t CalUnique<double, int>(const double *input, int num_elements, int *input_index,
                                                            int *sorted_index, double *output, int *index,
                                                            cudaStream_t cuda_stream, int *output_size);
template CUDA_LIB_EXPORT cudaError_t CalUnique<int, int>(const int *input, int num_elements, int *input_index,
                                                         int *sorted_index, int *output, int *index,
                                                         cudaStream_t cuda_stream, int *output_size);
template CUDA_LIB_EXPORT cudaError_t CalUnique<int8_t, int>(const int8_t *input, int num_elements, int *input_index,
                                                            int *sorted_index, int8_t *output, int *index,
                                                            cudaStream_t cuda_stream, int *output_size);
template CUDA_LIB_EXPORT cudaError_t CalUnique<int16_t, int>(const int16_t *input, int num_elements, int *input_index,
                                                             int *sorted_index, int16_t *output, int *index,
                                                             cudaStream_t cuda_stream, int *output_size);
template CUDA_LIB_EXPORT cudaError_t CalUnique<uint8_t, int>(const uint8_t *input, int num_elements, int *input_index,
                                                             int *sorted_index, uint8_t *output, int *index,
                                                             cudaStream_t cuda_stream, int *output_size);
template CUDA_LIB_EXPORT cudaError_t CalUnique<uint16_t, int>(const uint16_t *input, int num_elements, int *input_index,
                                                              int *sorted_index, uint16_t *output, int *index,
                                                              cudaStream_t cuda_stream, int *output_size);
template CUDA_LIB_EXPORT cudaError_t CalUnique<int64_t, int64_t>(const int64_t *input, int num_elements,
