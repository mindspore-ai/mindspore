...
template <typename T>
__global__ void SparseSparseMinimum1(const T *a_indices, const T *b_indices, int64_t *ab_status, const int64_t rank_1,
...
template <typename T>
__global__ void SparseSparseMinimum2(const T *a_indices, const T *b_indices, int64_t *ab_status,
...
__global__ void SparseSparseMinimum3(const T *a_indices, const S *a_values, const T *b_indices, const S *b_values,
...
template <typename T>
__global__ void SparseSparseMinimum3(const T *a_indices, const half *a_values, const T *b_indices, const half *b_values,
                                     int64_t *ab_stauts1, int64_t *ab_stauts2, const int64_t rank_1, T *output_indices,
...
template <typename T, typename S>
__global__ void Min_test1(const int64_t a_len, const T *a_indices, const S *a_values, T *output_indices,
...
template <typename T>
__global__ void Min_test1(const int64_t a_len, const T *a_indices, const half *a_values, T *output_indices,
...
__global__ void Min_test2(int64_t *sum_ptr) { *sum_ptr = 0; }
...
CUDA_LIB_EXPORT cudaError_t SparseSparseMinimum(const T *a_indices, const S *a_values, const T *b_indices,
  ...
  SparseSparseMinimum1<<<grid12, block12>>>(a_indices, b_indices, ab_status_ptr, rank_1, a_indices_num, b_indices_num);
  cudaDeviceSynchronize();
  SparseSparseMinimum2<<<1, 1>>>(a_indices, b_indices, ab_status_ptr, a_indices_num, b_indices_num, rank_1, sum_ptr,
                                 ab_status_ptr1, ab_status_ptr2);
  cudaDeviceSynchronize();
  SparseSparseMinimum3<<<grid3, block1>>>(a_indices, a_values, b_indices, b_values, ab_status_ptr1, ab_status_ptr2,
                                          rank_1, sum_indices, sum_values, a_indices_num + b_indices_num);
  cudaDeviceSynchronize();
  return GetCudaStatus();
}

#define GPU_SPARSE_SPARSE_MINIMUM_GRAD_EXPORT_REGISTER(index_type1, val_type1)                                        \
  template CUDA_LIB_EXPORT cudaError_t SparseSparseMinimum<index_type1, val_type1>(                                   \
