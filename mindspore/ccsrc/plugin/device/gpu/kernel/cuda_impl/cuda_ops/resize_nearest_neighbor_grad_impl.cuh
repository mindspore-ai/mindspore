...
template <typename T>
CUDA_LIB_EXPORT void CalResizeNearestNeighborGrad(float *work, const int input_size, const T *input, const int s1,
                                                  const int s2, const int s3, const int s4, T *output, const int d1,
                                                  const int d2, const int d3, const int d4, bool align_corners,
