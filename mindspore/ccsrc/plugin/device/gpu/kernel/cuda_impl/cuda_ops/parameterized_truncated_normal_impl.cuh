...
template <typename T>
CUDA_LIB_EXPORT cudaError_t ParameterizedTruncatedNormal(uint64_t seed, uint64_t seed_offset, int64_t batch_size,
                                                         int64_t samples_per_batch, T *mean, T *stdevs, T *min, T *max,
                                                         T *output, bool scalar_mean, bool scalar_stdevs,
