...
template
CUDA_LIB_EXPORT void NextAfter<float>(const size_t size, const float *input1, const float *input2, float *output,
                                      const uint32_t &device_id, cudaStream_t cuda_stream);
template
CUDA_LIB_EXPORT void NextAfter<double>(const size_t size, const double *input1, const double *input2, double *output,
                                       const uint32_t &device_id, cudaStream_t cuda_stream);
