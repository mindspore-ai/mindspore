...
template <typename T>
CUDA_LIB_EXPORT cudaError_t MatrixDiagPartV3(const T *matrix_ptr, const T *padding_value_ptr, T *diagnal_ptr,
                                             const int64_t num_rows, const int64_t num_cols,
                                             const int64_t lower_diag_idx, const int64_t upper_diag_index,
                                             const int64_t diag_size, const int64_t max_diag_len,
