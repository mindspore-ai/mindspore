...
template <typename T>
CUDA_LIB_EXPORT void CudaIm2Col(const int batches, const int x_channel, const int x_height,
                                ...
                                const int stride_height, const int stride_width, const int dilation_height,
                                const int dilation_width, const int pad_height, const int pad_width, T *x,
