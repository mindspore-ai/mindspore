...
template <typename T>
CUDA_LIB_EXPORT void CalSpaceToBatch(const size_t size, const T *input, const size_t in, const size_t ih,
                                     ...
                                     const size_t pad_lft, const size_t pad_rht, const size_t block_num, T *output,
