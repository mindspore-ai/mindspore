...
template CUDA_LIB_EXPORT void CalAssignSub<float>(const size_t size, float *ref, const float *value, float *output,
                                                  const uint32_t device_id, cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT void CalAssignSub<half>(const size_t size, half *ref, const half *value, half *output,
                                                 const uint32_t device_id, cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT void CalAssignSub<int>(const size_t size, int *ref, const int *value, int *output,
                                                const uint32_t device_id, cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT void CalAssignSub<int64_t>(const size_t size, int64_t *ref, const int64_t *value,
                                                    ...
                                                    cudaStream_t cuda_stream);
template CUDA_LIB_EXPORT void CalAssignSub<int8_t>(const size_t size, int8_t *ref, const int8_t *value, int8_t *output,
                                                   const uint32_t device_id, cudaStream_t cuda_stream);
