...
template <typename T>
CUDA_LIB_EXPORT bool IndexFill(T *out, const int *index, const size_t index_size, const size_t outer_size,
                               const int dim_size, const size_t inner_size, const T value, cudaStream_t cuda_stream);
