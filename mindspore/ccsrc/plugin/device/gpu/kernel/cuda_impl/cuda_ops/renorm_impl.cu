...
template <typename T>
cudaError_t CalRenorm(const T *input, size_t input_elements, size_t inner_size, size_t axis_size, int p,
                      float *norm_value, T *output, const uint32_t &device_id, cudaStream_t cuda_stream,
                      float max_norm) {
...
template CUDA_LIB_EXPORT cudaError_t CalRenorm<half>(const half *input, size_t input_elements, size_t inner_size,
                                                     size_t axis_size, int p, float *norm_value, half *output,
                                                     const uint32_t &device_id, cudaStream_t cuda_stream,
                                                     float max_norm);

template CUDA_LIB_EXPORT cudaError_t CalRenorm<float>(const float *input, size_t input_elements, size_t inner_size,
                                                      size_t axis_size, int p, float *norm_value, float *output,
                                                      const uint32_t &device_id, cudaStream_t cuda_stream,
                                                      float max_norm);

template CUDA_LIB_EXPORT cudaError_t CalRenorm<double>(const double *input, size_t input_elements, size_t inner_size,
                                                       size_t axis_size, int p, float *norm_value, double *output,
                                                       const uint32_t &device_id, cudaStream_t cuda_stream,
                                                       float max_norm);

template CUDA_LIB_EXPORT cudaError_t CalRenorm<Complex<float>>(const Complex<float> *input, size_t input_elements,
                                                               size_t inner_size, size_t axis_size, int p,
                                                               float *norm_value, Complex<float> *output,
                                                               const uint32_t &device_id, cudaStream_t cuda_stream,
                                                               float max_norm);

template CUDA_LIB_EXPORT cudaError_t CalRenorm<Complex<double>>(const Complex<double> *input, size_t input_elements,
                                                                size_t inner_size, size_t axis_size, int p,
                                                                float *norm_value, Complex<double> *output,
                                                                const uint32_t &device_id, cudaStream_t cuda_stream,
                                                                float max_norm);
