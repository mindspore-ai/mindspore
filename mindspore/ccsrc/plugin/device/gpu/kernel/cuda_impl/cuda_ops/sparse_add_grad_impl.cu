...
GPU_SPARSE_ADD_GRAD_EXPORT_REGISTER(int16_t, int8_t)
GPU_SPARSE_ADD_GRAD_EXPORT_REGISTER(int16_t, int16_t)
GPU_SPARSE_ADD_GRAD_EXPORT_REGISTER(int16_t, int32_t)
GPU_SPARSE_ADD_GRAD_EXPORT_REGISTER(int16_t, int64_t)
GPU_SPARSE_ADD_GRAD_EXPORT_REGISTER(int16_t, float)
GPU_SPARSE_ADD_GRAD_EXPORT_REGISTER(int16_t, double)
GPU_SPARSE_ADD_GRAD_COMPLEX_EXPORT_REGISTER(int16_t, cuComplex)
GPU_SPARSE_ADD_GRAD_COMPLEX_EXPORT_REGISTER(int16_t, cuDoubleComplex)

GPU_SPARSE_ADD_GRAD_EXPORT_REGISTER(int32_t, int8_t)
GPU_SPARSE_ADD_GRAD_EXPORT_REGISTER(int32_t, int16_t)
GPU_SPARSE_ADD_GRAD_EXPORT_REGISTER(int32_t, int32_t)
GPU_SPARSE_ADD_GRAD_EXPORT_REGISTER(int32_t, int64_t)
GPU_SPARSE_ADD_GRAD_EXPORT_REGISTER(int32_t, float)
GPU_SPARSE_ADD_GRAD_EXPORT_REGISTER(int32_t, double)
GPU_SPARSE_ADD_GRAD_COMPLEX_EXPORT_REGISTER(int32_t, cuComplex)
GPU_SPARSE_ADD_GRAD_COMPLEX_EXPORT_REGISTER(int32_t, cuDoubleComplex)
