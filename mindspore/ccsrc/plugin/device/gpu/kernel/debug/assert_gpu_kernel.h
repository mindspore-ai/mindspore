...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_NN_ASSERT_GPU_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_NN_ASSERT_GPU_KERNEL_H_
#include <vector>
#include <string>
#include <utility>
#include <map>
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_GPU_NN_ASSERT_GPU_KERNEL_H_
