...
// UnstackWithNum
MS_REG_GPU_KERNEL_ONE(UnstackWithNum,
                      KernelAttr().AddAllSameAttr(true).AddInputAttr(kNumberTypeInt8).AddOutputAttr(kNumberTypeInt8),
                      UnpackFwdGpuKernelMod, int8_t)
MS_REG_GPU_KERNEL_ONE(UnstackWithNum,
                      KernelAttr().AddAllSameAttr(true).AddInputAttr(kNumberTypeInt16).AddOutputAttr(kNumberTypeInt16),
...
MS_REG_GPU_KERNEL_ONE(UnstackWithNum,
                      ...
                      UnpackFwdGpuKernelMod, bool)
MS_REG_GPU_KERNEL_ONE(
  UnstackWithNum, KernelAttr().AddAllSameAttr(true).AddInputAttr(kNumberTypeUInt16).AddOutputAttr(kNumberTypeUInt16),
  UnpackFwdGpuKernelMod, uint16_t)
MS_REG_GPU_KERNEL_ONE(
  UnstackWithNum, KernelAttr().AddAllSameAttr(true).AddInputAttr(kNumberTypeUInt32).AddOutputAttr(kNumberTypeUInt32),
  UnpackFwdGpuKernelMod, uint32_t)
MS_REG_GPU_KERNEL_ONE(
  UnstackWithNum, KernelAttr().AddAllSameAttr(true).AddInputAttr(kNumberTypeUInt64).AddOutputAttr(kNumberTypeUInt64),
  UnpackFwdGpuKernelMod, uint64_t)
MS_REG_GPU_KERNEL_ONE(
  UnstackWithNum, KernelAttr().AddAllSameAttr(true).AddInputAttr(kNumberTypeFloat16).AddOutputAttr(kNumberTypeFloat16),
  UnpackFwdGpuKernelMod, half)
MS_REG_GPU_KERNEL_ONE(
  UnstackWithNum, KernelAttr().AddAllSameAttr(true).AddInputAttr(kNumberTypeFloat32).AddOutputAttr(kNumberTypeFloat32),
  UnpackFwdGpuKernelMod, float)
}  // namespace kernel
}  // namespace mindspore
