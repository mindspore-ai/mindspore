...
bool UnsortedSegmentSumGpuKernelMod::Init(const std::vector<KernelTensor *> &inputs,
...
int UnsortedSegmentSumGpuKernelMod::Resize(const std::vector<KernelTensor *> &inputs,
                                           const std::vector<KernelTensor *> &outputs) {
