...
bool RightShiftGpuKernelMod::Launch(const std::vector<KernelTensor *> &inputs,
...
bool RightShiftGpuKernelMod::Init(const std::vector<KernelTensor *> &inputs,
...
int RightShiftGpuKernelMod::Resize(const std::vector<KernelTensor *> &inputs,
                                   const std::vector<KernelTensor *> &outputs) {
