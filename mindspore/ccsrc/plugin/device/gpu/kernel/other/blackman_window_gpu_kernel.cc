...
namespace mindspore {
namespace kernel {
bool BlackmanWindowGpuKernelMod::Init(const BaseOperatorPtr &base_operator, const std::vector<KernelTensorPtr> &inputs,
                                      const std::vector<KernelTensorPtr> &outputs) {
  auto kernel_ptr_ = std::dynamic_pointer_cast<ops::BlackmanWindow>(base_operator);
...
int BlackmanWindowGpuKernelMod::Resize(const BaseOperatorPtr &base_operator, const std::vector<KernelTensorPtr> &inputs,
                                       const std::vector<KernelTensorPtr> &outputs,
...
bool BlackmanWindowGpuKernelMod::LaunchKernel(const std::vector<AddressPtr> &inputs,
