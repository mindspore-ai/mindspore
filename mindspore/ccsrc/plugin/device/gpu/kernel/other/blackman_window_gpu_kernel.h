...
#include "plugin/device/gpu/kernel/cuda_impl/cuda_ops/blackman_window_impl.cuh"
...
class BlackmanWindowGpuKernelMod : public NativeGpuKernelMod {
 ...
 private:
  ...
  using BmWFunc = std::function<bool(BlackmanWindowGpuKernelMod *, const std::vector<kernel::AddressPtr> &,
