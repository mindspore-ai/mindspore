...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_CALL_FLASH_ATTENTION_SCORE_GRAD_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_CALL_FLASH_ATTENTION_SCORE_GRAD_H_
...
namespace kernel {
namespace pyboost {
// FlashAttentionScoreGrad can not be used in GPU, just empty implement.
void FlashAttentionScoreGradGPUCustomize(
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_CALL_FLASH_ATTENTION_SCORE_GRAD_H_
