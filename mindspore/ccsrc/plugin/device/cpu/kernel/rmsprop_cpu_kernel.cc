...
template <typename T>
void RMSPropCpuKernelMod<T>::LaunchRMSPropUnuseCenter(T *variable, T *mean_square, T *moment, T *gradients,
                                                      float *learning_rate) {
...
template <typename T>
void RMSPropCpuKernelMod<T>::LaunchRMSPropUseCenter(T *variable, T *mean_square, T *moment, T *gradients,
                                                    T *mean_gradients, float *momentum, float *learning_rate,
...
template <typename T>
bool RMSPropCpuKernelMod<T>::Launch(const std::vector<kernel::AddressPtr> &inputs,
