...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_CALL_FLASH_ATTENTION_SCORE_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_CALL_FLASH_ATTENTION_SCORE_H_
...
namespace kernel {
namespace pyboost {
// FlashAttentionScore can not be used in CPU, just empty implement.
void FlashAttentionScoreCPUCustomize(
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_CALL_FLASH_ATTENTION_SCORE_H_
