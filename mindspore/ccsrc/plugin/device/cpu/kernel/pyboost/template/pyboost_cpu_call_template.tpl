...
std::make_shared<pynative::PyBoostDeviceTask>([this, op, cpu_kernel, ${real_call_args}]() {
  ...
  // KernelMod init
  auto ret = cpu_kernel->Init(primitive(), inputs_kernel_tensors, outputs_kernel_tensors);
  if (!ret) {
