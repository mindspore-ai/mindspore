...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_LOGIT_GRAD_CPU_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_LOGIT_GRAD_CPU_KERNEL_H_
#include <vector>
#include <memory>
#include <utility>
