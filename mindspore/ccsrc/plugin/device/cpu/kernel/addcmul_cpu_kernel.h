...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_ADDCMUL_CPU_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_ADDCMUL_CPU_KERNEL_H_
...
namespace mindspore {
namespace kernel {
class AddcmulCpuKernelMod : public DeprecatedNativeCpuKernelMod {
 public:
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_ADDCMUL_CPU_KERNEL_H_
