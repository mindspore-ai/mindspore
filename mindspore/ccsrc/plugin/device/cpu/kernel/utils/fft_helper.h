...
#ifndef MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_UTILS_FFT_HELPER_H_
#define MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_UTILS_FFT_HELPER_H_
#include <cmath>
#include <limits>
#include <string>
#include <vector>
...
#endif  // MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_UTILS_FFT_HELPER_H_
