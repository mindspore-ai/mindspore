...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_UTILS_TENSOR_ITERATOR_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_UTILS_TENSOR_ITERATOR_H_
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_UTILS_TENSOR_ITERATOR_H_
