...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_SCATTER_ND_MAX_CPU_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_SCATTER_ND_MAX_CPU_KERNEL_H_
...
class ScatterMaxCPUKernelMod : public DeprecatedNativeCpuKernelMod {
 public:
  ScatterMaxCPUKernelMod() = default;
  ~ScatterMaxCPUKernelMod() override = default;
 ...
 protected:
  virtual void *ScatterMaxRealData(const std::vector<AddressPtr> &inputs,
...
class ScatterNdMaxCpuKernelMod : public ScatterMaxCPUKernelMod {
 protected:
  void *ScatterMaxRealData(const std::vector<AddressPtr> &inputs,
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_SCATTER_ND_MAX_CPU_KERNEL_H_
