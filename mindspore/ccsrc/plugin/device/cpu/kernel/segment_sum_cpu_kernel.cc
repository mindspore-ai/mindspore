 ...
 */
#include "plugin/device/cpu/kernel/segment_sum_cpu_kernel.h"
...
#define SEGMENTSUM_COMPUTE_CASE(DTYPE, TYPE1, TYPE2)   \
  case (DTYPE): {                                      \
...
namespace mindspore {
namespace kernel {
void SegmentSumCPUKernelMod::InitKernel(const CNodePtr &kernel_node) {
...
bool SegmentSumCPUKernelMod::Launch(const std::vector<kernel::AddressPtr> &inputs,
  ...
  switch (segment_ids_dtype_) {
    case kNumberTypeInt32: {
      switch (input_x_dtype_) {
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeComplex64, std::complex<float>, int32_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeComplex128, std::complex<double>, int32_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeInt8, int8_t, int32_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeInt16, int16_t, int32_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeInt32, int32_t, int32_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeInt64, int64_t, int32_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeUInt8, uint8_t, int32_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeUInt16, uint16_t, int32_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeUInt32, uint32_t, int32_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeUInt64, uint64_t, int32_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeFloat16, float16, int32_t)
    ...
    case kNumberTypeInt64: {
      switch (input_x_dtype_) {
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeComplex64, std::complex<float>, int64_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeComplex128, std::complex<double>, int64_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeInt8, int8_t, int64_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeInt16, int16_t, int64_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeInt32, int32_t, int64_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeInt64, int64_t, int64_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeUInt8, uint8_t, int64_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeUInt16, uint16_t, int64_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeUInt32, uint32_t, int64_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeUInt64, uint64_t, int64_t)
        SEGMENTSUM_COMPUTE_CASE(kNumberTypeFloat16, float16, int64_t)
...
MS_KERNEL_FACTORY_REG(NativeCpuKernelMod, SegmentSum, SegmentSumCPUKernelMod);
}  // namespace kernel
}  // namespace mindspore
