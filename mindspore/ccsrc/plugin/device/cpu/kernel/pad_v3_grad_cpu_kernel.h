...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_PAD_V3_GRAD_CPU_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_PAD_V3_GRAD_CPU_KERNEL_H_
...
class PadV3GradCpuKernelMod : public DeprecatedNativeCpuKernelMod {
 public:
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_PAD_V3_GRAD_CPU_KERNEL_H_
