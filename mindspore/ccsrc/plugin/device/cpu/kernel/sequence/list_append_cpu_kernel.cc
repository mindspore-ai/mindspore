...
bool ListAppendCpuKernelMod::Init(const std::vector<KernelTensor *> &inputs,
...
int ListAppendCpuKernelMod::Resize(const std::vector<KernelTensor *> &inputs,
                                   const std::vector<KernelTensor *> &outputs) {
...
template <typename T>
bool ListAppendCpuKernelMod::LaunchKernel(const std::vector<KernelTensor *> &inputs,
