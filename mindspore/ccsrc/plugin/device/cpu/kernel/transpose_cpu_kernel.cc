...
template <typename T>
int TransposeFwdCpuKernelMod::DoTranspose(const T *in_data, T *out_data, const int *output_shape,
...
template <typename T>
void TransposeFwdCpuKernelMod::TransposeDims(const T *in_data, T *out_data, const int *output_shape,
