...
bool SparseDenseCwiseAddCpuKernelMod::Init(const std::vector<KernelTensor *> &inputs,
                                           const std::vector<KernelTensor *> &outputs) {
  data_type_ = inputs.at(kIndex3)->dtype_id();
  return true;
}

int SparseDenseCwiseAddCpuKernelMod::Resize(const std::vector<KernelTensor *> &inputs,
                                            const std::vector<KernelTensor *> &outputs) {
...
template <typename T>
void SparseDenseCwiseAddCpuKernelMod::ComputeAdd(const std::vector<KernelTensor *> &inputs,
                                                 const std::vector<KernelTensor *> &outputs) {
...
template <typename T>
void SparseDenseCwiseAddCpuKernelMod::SparseDenseCwiseAddNoBcastCompute(const std::vector<KernelTensor *> &inputs,
                                                                        const std::vector<KernelTensor *> &outputs) {
...
template <typename T>
void SparseDenseCwiseAddCpuKernelMod::SparseDenseCwiseAddBcastCompute(const std::vector<KernelTensor *> &inputs,
                                                                      const std::vector<KernelTensor *> &outputs) {
  auto sparse_indices_data = static_cast<int64_t *>(inputs[kIndex0]->device_ptr());
  auto sparse_values_data = static_cast<T *>(inputs[kIndex1]->device_ptr());
  auto sparse_shape_data = static_cast<int64_t *>(inputs[kIndex2]->device_ptr());
...
bool SparseDenseCwiseAddCpuKernelMod::Launch(const std::vector<KernelTensor *> &inputs,
