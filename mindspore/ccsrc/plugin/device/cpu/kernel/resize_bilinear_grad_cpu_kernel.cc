...
bool ResizeBilinearGradCpuKernelMod::Launch(const std::vector<kernel::AddressPtr> &inputs,
...
template <typename T>
bool ResizeBilinearGradCpuKernelMod::LaunchKernel(const std::vector<AddressPtr> &inputs,
