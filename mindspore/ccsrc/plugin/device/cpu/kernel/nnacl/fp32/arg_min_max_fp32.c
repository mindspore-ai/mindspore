      ...
      for (int j = 0; j < after_axis_count; ++j) {                                                                  \
        ...
        if (output_value != NULL) {                                                                                 \
          output_value[output_offset + j] = value;                                                                  \
                                                                                                                    ...
                                                                                                                    \
  void ArgMinMaxDim0##data_type(const DATA_TYPE *input, void *output, DATA_TYPE *output_value, const int *in_shape, \
    ...
    return;                                                                                                         \
                                                                                                                    ...
                                                                                                                    \
  void ArgMinMaxDim1##data_type(const DATA_TYPE *input, void *output, DATA_TYPE *output_value, const int *in_shape, \
                                const ArgMinMaxParameter *param, COMPARE_FUNCTION compare_func) {                   \
    DATA_TYPE *outputfp32 = (DATA_TYPE *)output;                                                                    \
    int *outputint = (int *)output;                                                                                 \
    ...
    return;                                                                                                         \
                                                                                                                    ...
                                                                                                                    \
  void ArgMinMaxDim2##data_type(const DATA_TYPE *input, void *output, DATA_TYPE *output_value, const int *in_shape, \
                                const ArgMinMaxParameter *param, COMPARE_FUNCTION compare_func) {                   \
    int in_shape1 = in_shape[1];                                                                                    \
          ...
          for (int l = 0; l < param->topk_; ++l) {                                                                  \
            ...
            if (output_value != NULL) {                                                                             \
              output_value[out_offset] = param->arg_elements_[l].data_.UNION_DATA;                                  \
                                                                                                                    ...
                                                                                                                    \
  void ArgMinMaxDim3##data_type(const DATA_TYPE *input, void *output, DATA_TYPE *output_value, const int *in_shape, \
                                const ArgMinMaxParameter *param, COMPARE_FUNCTION compare_func) {                   \
    int in_shape1 = in_shape[1];                                                                                    \
    int in_shape2 = in_shape[2];                                                                                    \
          ...
          for (int l = 0; l < param->topk_; ++l) {                                                                  \
            ...
            if (output_value != NULL) {                                                                             \
              output_value[out_offset] = param->arg_elements_[l].data_.UNION_DATA;                                  \
                                                                                                                    ...
                                                                                                                    \
  void ArgMinMax##data_type##32(const DATA_TYPE *input, void *output, DATA_TYPE *output_value, const int *in_shape, \
