...
#define SIMD_OR_MASK MS_SIMD_INSTRUCTION_MASK(MS_OR)
#define SIMD_AND_FP32 MS_SIMD_INSTRUCTION_F32(MS_AND)
#define SIMD_OR_FP32 MS_SIMD_INSTRUCTION_F32(MS_OR)
