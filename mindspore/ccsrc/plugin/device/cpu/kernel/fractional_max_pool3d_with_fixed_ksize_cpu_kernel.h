 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_FRACTIONAL_MAX_POOL3D_WITH_FIXED_KSIZE_CPU_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_FRACTIONAL_MAX_POOL3D_WITH_FIXED_KSIZE_CPU_KERNEL_H_
#include <memory>
#include <vector>
#include <string>
...
namespace mindspore {
namespace kernel {
class FractionalMaxPool3DWithFixedKsizeCPUKernelMod : public DeprecatedNativeCpuKernelMod {
 public:
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_FRACTIONAL_MAX_POOL3D_WITH_FIXED_KSIZE_CPU_KERNEL_H_
