...
std::vector<std::pair<KernelAttr, UpsampleTrilinear3DCpuKernelMod::KernelRunFunc>>
  UpsampleTrilinear3DCpuKernelMod::func_list_ = {
    UpsampleTrilinear3D_CPU_KERNEL_REG(kNumberTypeFloat16, float16, float),
    UpsampleTrilinear3D_CPU_KERNEL_REG(kNumberTypeFloat32, float, float),
    UpsampleTrilinear3D_CPU_KERNEL_REG(kNumberTypeFloat64, double, double)};
