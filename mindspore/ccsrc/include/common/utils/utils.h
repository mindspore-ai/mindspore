...
// format
const std::string kOpFormat_DEFAULT = "DefaultFormat";
const std::string kOpFormat_ChannelFirst = "ChannelFirst";
const std::string kOpFormat_ChannelLast = "ChannelLast";
const std::string kOpFormat_NC1KHKWHWC0 = "NC1KHKWHWC0";
const std::string kOpFormat_ND = "ND";
const std::string kOpFormat_NCHW = "NCHW";
const std::string kOpFormat_NHWC = "NHWC";
const std::string kOpFormat_HWCN = "HWCN";
const std::string kOpFormat_CHWN = "CHWN";
const std::string kOpFormat_NC1HWC0 = "NC1HWC0";
const std::string kOpFormat_FRAC_Z = "FRACTAL_Z";
const std::string kOpFormat_FRACTAL_Z = "FRACTAL_Z";
const std::string kOpFormat_FRAC_NZ = "FRACTAL_NZ";
const std::string kOpFormat_C1HWNCoC0 = "C1HWNCoC0";
const std::string kOpFormat_NC1HWC0_C04 = "NC1HWC0_C04";
const std::string kOpFormat_FRACTAL_Z_C04 = "FRACTAL_Z_C04";
const std::string kOpFormat_NDHWC = "NDHWC";
const std::string kOpFormat_NCDHW = "NCDHW";
const std::string kOpFormat_DHWNC = "DHWNC";
const std::string kOpFormat_DHWCN = "DHWCN";
const std::string kOpFormat_NDC1HWC0 = "NDC1HWC0";
const std::string kOpFormat_FRACTAL_Z_3D = "FRACTAL_Z_3D";
const std::string kOpFormat_FRACTAL_ZN_LSTM = "FRACTAL_ZN_LSTM";
const std::string kOpFormat_FRACTAL_ZN_RNN = "FRACTAL_ZN_RNN";
const std::string kOpFormat_ND_RNN_BIAS = "ND_RNN_BIAS";
const std::string kSliceStart = "start";
const std::string kSliceStop = "stop";
const std::string kSliceStep = "step";
