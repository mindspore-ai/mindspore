...
#ifndef MINDSPORE_CCSRC_OPTIMIZER_PARALLEL_ALLREDUCE_FUSION_ALLREDUCE_FUSION_H_
#define MINDSPORE_CCSRC_OPTIMIZER_PARALLEL_ALLREDUCE_FUSION_ALLREDUCE_FUSION_H_
...
class AllreduceFusion {
 public:
  AllreduceFusion() : allreduce_graph_(), ret_(nullptr), forward_ret_(nullptr), root_graph_(nullptr) {}
 ...
 private:
  ...
  std::vector<double> GenerateCostMap(int32_t fusion_times) const;
...
#endif  // MINDSPORE_CCSRC_OPTIMIZER_PARALLEL_ALLREDUCE_FUSION_ALLREDUCE_FUSION_H_
