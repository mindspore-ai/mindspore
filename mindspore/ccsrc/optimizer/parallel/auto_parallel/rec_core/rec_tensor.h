...
#ifndef OPTIMIZER_PARALLEL_AUTO_PARALLEL_REC_TENSOR_H_
#define OPTIMIZER_PARALLEL_AUTO_PARALLEL_REC_TENSOR_H_
...
#endif  // OPTIMIZER_PARALLEL_AUTO_PARALLEL_REC_TENSOR_H_
