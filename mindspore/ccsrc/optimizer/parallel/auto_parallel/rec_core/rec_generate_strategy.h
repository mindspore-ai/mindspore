...
#ifndef OPTIMIZER_PARALLEL_AUTO_PARALLEL_REC_GENERATE_STRATEGY_H_
#define OPTIMIZER_PARALLEL_AUTO_PARALLEL_REC_GENERATE_STRATEGY_H_
...
#endif  // OPTIMIZER_PARALLEL_AUTO_PARALLEL_REC_GENERATE_STRATEGY_H_
