...
#ifndef OPTIMIZER_PARALLEL_AUTO_PARALLEL_REC_COST_H_
#define OPTIMIZER_PARALLEL_AUTO_PARALLEL_REC_COST_H_
...
#endif  // OPTIMIZER_PARALLEL_AUTO_PARALLEL_REC_COST_H_
