...
#ifndef MINDSPORE_CCSRC_OPTIMIZER_PARALLEL_AUTO_PARALLEL_DP_ALGO_COSTMODEL_H_
#define MINDSPORE_CCSRC_OPTIMIZER_PARALLEL_AUTO_PARALLEL_DP_ALGO_COSTMODEL_H_
...
#endif  // MINDSPORE_CCSRC_OPTIMIZER_PARALLEL_AUTO_PARALLEL_DP_ALGO_COSTMODEL_H_
