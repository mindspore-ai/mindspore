...
#ifndef OPTIMIZER_PARALLEL_AUTO_PARALLEL_EDGE_COSTMODEL_H_
#define OPTIMIZER_PARALLEL_AUTO_PARALLEL_EDGE_COSTMODEL_H_
...
#endif  // OPTIMIZER_PARALLEL_AUTO_PARALLEL_EDGE_COSTMODEL_H_
