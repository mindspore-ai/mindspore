...
#ifndef OPTIMIZER_PARALLEL_OPS_INFO_DATASET_INFO_H_
#define OPTIMIZER_PARALLEL_OPS_INFO_DATASET_INFO_H_
...
#endif  // OPTIMIZER_PARALLEL_OPS_INFO_VIRTUAL_DATASET_INFO_H_
