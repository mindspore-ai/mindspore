...
#ifndef MINDSPORE_CCSRC_OPTIMIZER_PARALLEL_STEP_PARALLEL_H_
#define MINDSPORE_CCSRC_OPTIMIZER_PARALLEL_STEP_PARALLEL_H_
...
#endif  // MINDSPORE_CCSRC_OPTIMIZER_PARALLEL_STEP_PARALLEL_H_
