...
Status MsGraphImpl::ExecuteModel(const std::vector<MSTensor> &request, std::vector<MSTensor> *reply) {
...
MsGraphImpl::MsEnvGuard::MsEnvGuard(uint32_t device_id) {
  MS_LOG(INFO) << "Start to init env.";
...
MsGraphImpl::MsEnvGuard::~MsEnvGuard() {
...
std::shared_ptr<MsGraphImpl::MsEnvGuard> MsGraphImpl::MsEnvGuard::GetEnv(uint32_t device_id) {
...
std::weak_ptr<MsGraphImpl::MsEnvGuard> MsGraphImpl::MsEnvGuard::global_ms_env_;
std::mutex MsGraphImpl::MsEnvGuard::global_ms_env_mutex_;
}  // namespace mindspore
