...
sparse_apply_adagrad_v2_d_ds_op_info = TBERegOp("SparseApplyAdagradV2") \
    .fusion_type("OPAQUE") \
    .async_flag(False) \
...
@op_info_register(sparse_apply_adagrad_v2_d_ds_op_info)
def _sparse_apply_adagrad_v2_ds():
