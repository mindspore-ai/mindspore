...
"""AdamApplyOneWithDecay Dynamic op"""
from mindspore.ops.op_info_register import op_info_register, TBERegOp, DataType

adam_apply_one_with_decay_ds_op_info = TBERegOp("AdamApplyOneWithDecay") \
    .fusion_type("OPAQUE") \
    .async_flag(False) \
...
@op_info_register(adam_apply_one_with_decay_ds_op_info)
def _adam_apply_one_with_decay_ds_tbe():
    """AdamApplyOneWithDecay Dynamic TBE register"""
    return
