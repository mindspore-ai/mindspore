...
unsorted_segment_prod_ds_op_info = TBERegOp("UnsortedSegmentProd") \
    .fusion_type("OPAQUE") \
    .async_flag(False) \
    .binfile_name("unsorted_segment_prod.so") \
    .compute_cost(10) \
...
@op_info_register(unsorted_segment_prod_ds_op_info)
def _unsorted_segment_prod_ds_tbe():
