...
softmax_cross_entropy_with_logits_ds_op_info = TBERegOp("SoftmaxCrossEntropyWithLogits") \
    .fusion_type("OPAQUE") \
    .async_flag(False) \
...
@op_info_register(softmax_cross_entropy_with_logits_ds_op_info)
def _softmax_cross_entropy_with_logits_ds_tbe():
