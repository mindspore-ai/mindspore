...
apply_adam_with_amsgrad_ds_op_info = TBERegOp("ApplyAdamWithAmsgrad") \
    .fusion_type("OPAQUE") \
    .async_flag(False) \
...
@op_info_register(apply_adam_with_amsgrad_ds_op_info)
def _apply_adam_with_amsgrad_ds_tbe():
