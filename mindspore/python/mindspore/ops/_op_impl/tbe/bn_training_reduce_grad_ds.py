...
bn_training_reduce_grad_ds_op_info = TBERegOp("BNTrainingReduceGrad") \
    .fusion_type("OPAQUE") \
    .async_flag(False) \
...
@op_info_register(bn_training_reduce_grad_ds_op_info)
def _bn_training_reduce_grad_ds_tbe():
