...
arg_min_v2_ds_op_info = TBERegOp("ArgminV2") \
    .fusion_type("ELEMWISE") \
    .async_flag(False) \
    .binfile_name("arg_min.so") \
    .compute_cost(10) \
    .dynamic_shape(True) \
    .kernel_name("arg_min") \
    .partial_flag(True) \
    .input(0, "x", False, "required", "all") \
    .input(1, "dimension", False, "required", "all") \
...
@op_info_register(arg_min_v2_ds_op_info)
def _arg_min_v2_ds_tbe():
    """ArgminV2 dynamic TBE register"""
    return
