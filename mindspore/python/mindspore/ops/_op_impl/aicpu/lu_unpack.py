...
lu_unpack_op_info = AiCPURegOp("LuUnpack") \
    .fusion_type("OPAQUE") \
    .input(0, "LU_data", "required") \
    .input(1, "LU_pivots", "required") \
    .output(0, "pivots", "required") \
    .output(1, "L", "required") \
    .output(2, "U", "required") \
...
@op_info_register(lu_unpack_op_info)
def _lu_unpack_aicpu():
    """LuUnpack aicpu register"""
    return
