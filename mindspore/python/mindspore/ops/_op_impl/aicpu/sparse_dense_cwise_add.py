...
"""SparseDenseCwiseAdd op"""
from mindspore.ops.op_info_register import op_info_register, AiCPURegOp, DataType

sparse_dense_cwise_add_op_info = AiCPURegOp("SparseDenseCwiseAdd") \
    .fusion_type("OPAQUE") \
...
@op_info_register(sparse_dense_cwise_add_op_info)
def _sparse_dense_cwise_add_aicpu():
    """SparseDenseCwiseAdd AiCPU register"""
    return
