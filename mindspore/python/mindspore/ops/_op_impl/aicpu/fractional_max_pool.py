...
"""FractionalMaxPool op"""
from mindspore.ops.op_info_register import op_info_register, AiCPURegOp, DataType

fractional_max_pool_op_info = AiCPURegOp("FractionalMaxPool") \
    .fusion_type("OPAQUE") \
    .input(0, "x", "required") \
    .output(0, "y", "required") \
...
@op_info_register(fractional_max_pool_op_info)
def _fractional_max_pool_aicpu():
    """FractionalMaxPool AiCPU register"""
    return
