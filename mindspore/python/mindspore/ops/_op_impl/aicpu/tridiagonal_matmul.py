...
"""TridiagonalMatMul op"""
from mindspore.ops.op_info_register import op_info_register, AiCPURegOp, DataType

tridiagonal_matmul_op_info = AiCPURegOp("TridiagonalMatMul") \
    .fusion_type("OPAQUE") \
    .input(0, "superdiag", "required") \
    .input(1, "maindiag", "required") \
    .input(2, "subdiag", "required") \
    .input(3, "rhs", "required") \
    .output(0, "y", "required") \
...
@op_info_register(tridiagonal_matmul_op_info)
def _tridiagonal_matmul_aicpu():
    """TridiagonalMatMul AiCPU register"""
    return
