...
argmin_with_value_op_info = AiCPURegOp("ArgMinWithValue") \
    .fusion_type("OPAQUE") \
    .input(0, "x", "required") \
    .output(0, "index", "required") \
...
@op_info_register(argmin_with_value_op_info)
def _argmin_with_value_aicpu():
    """ArgMinWithValue aicpu register"""
    return
