...
"""AdaptiveAvgPool3DGrad op"""
from mindspore.ops.op_info_register import op_info_register, AiCPURegOp, DataType

adaptiveavgpool3d_grad_op_info = AiCPURegOp("AdaptiveAvgPool3DGrad") \
    .fusion_type("OPAQUE") \
...
@op_info_register(adaptiveavgpool3d_grad_op_info)
def _adaptiveavgpool3d_grad_aicpu():
    """AdaptiveAvgPool3DGrad aicpu register"""
    return
