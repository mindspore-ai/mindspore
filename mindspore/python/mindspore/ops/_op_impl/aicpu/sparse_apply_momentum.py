...
sparse_apply_momentum_op_info = AiCPURegOp("SparseApplyMomentum") \
    .fusion_type("OPAQUE")                                        \
    ...
    .dtype_format(DataType.F16_Default, DataType.F16_Default, DataType.F16_Default, DataType.F16_Default, \
                  DataType.I64_Default, DataType.I16_Default, DataType.F16_Default)                       \
    .dtype_format(DataType.F32_Default, DataType.F32_Default, DataType.F32_Default, DataType.F32_Default, \
...
@op_info_register(sparse_apply_momentum_op_info)
def _sparse_apply_momentum_aicpu():
    """SparseApplyMomentum AiCPU register"""
    return
