...
hamming_window_op_info = AiCPURegOp("HammingWindow") \
    .fusion_type("OPAQUE") \
    .attr("periodic", "bool") \
    .attr("alpha", "float") \
    .attr("beta", "float") \
    .attr("dtype", "int") \
    .input(0, "length", "required") \
    .output(0, "y", "required") \
...
@op_info_register(hamming_window_op_info)
def _hamming_window_aicpu():
    """HammingWindow AiCPU register"""
    return
