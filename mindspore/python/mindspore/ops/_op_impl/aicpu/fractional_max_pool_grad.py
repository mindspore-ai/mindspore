...
"""FractionalMaxPoolGrad op"""
from mindspore.ops.op_info_register import op_info_register, AiCPURegOp, DataType

fractional_max_pool_grad_op_info = AiCPURegOp("FractionalMaxPoolGrad") \
    .fusion_type("OPAQUE") \
    .input(0, "orig_input", "required") \
    .input(1, "orig_output", "required") \
    .input(2, "out_backprop", "required") \
    .input(3, "row_pooling_sequence", "required") \
    .input(4, "col_pooling_sequence", "required") \
    .output(0, "y", "required") \
...
@op_info_register(fractional_max_pool_grad_op_info)
def _fractional_max_pool_grad_aicpu():
    """FractionalMaxPoolGrad AiCPU register"""
    return
