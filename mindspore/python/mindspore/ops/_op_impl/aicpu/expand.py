...
expand_op_info = AiCPURegOp("Expand") \
    .fusion_type("OPAQUE") \
    .input(0, "x", "required") \
    ...
    .dtype_format(DataType.I8_Default, DataType.I16_Default, DataType.I8_Default) \
    ...
    .dtype_format(DataType.U8_Default, DataType.I16_Default, DataType.U8_Default) \
...
@op_info_register(expand_op_info)
def _expand_aicpu():
    """Expand aicpu register"""
    return
