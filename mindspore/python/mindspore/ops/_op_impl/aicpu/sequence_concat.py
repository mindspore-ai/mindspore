...
sequence_concat_op_info = AiCPURegOp("SequenceConcat") \
    .fusion_type("OPAQUE") \
    .attr("axis", "int") \
    ...
    .dtype_format(DataType.BOOL_Default_Tuple, DataType.BOOL_Default) \
...
@op_info_register(sequence_concat_op_info)
def _sequence_concat_aicpu():
    """SequenceConcat AiCPU register"""
    return
