...
"""FractionalAvgPool op"""
from mindspore.ops.op_info_register import op_info_register, AiCPURegOp, DataType

fractional_avg_pool_op_info = AiCPURegOp("FractionalAvgPool") \
    .fusion_type("OPAQUE") \
    .input(0, "x", "required") \
    .output(0, "y", "required") \
    .output(1, "row_pooling_sequence", "required") \
    .output(2, "col_pooling_sequence", "required") \
    .attr("pooling_ratio", "listFloat") \
    .attr("pseudo_random", "bool") \
...
@op_info_register(fractional_avg_pool_op_info)
def _fractional_avg_pool_aicpu():
    """FractionalAvgPool AiCPU register"""
    return
