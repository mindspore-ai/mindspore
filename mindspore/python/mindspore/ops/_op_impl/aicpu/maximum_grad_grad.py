...
maximum_grad_grad_op_info = AiCPURegOp("MaximumGradGrad") \
    .fusion_type("OPAQUE") \
    .input(0, "x1", "required") \
    .input(1, "x2", "required") \
...
@op_info_register(maximum_grad_grad_op_info)
def _maximum_grad_grad_aicpu():
    """MaximumGradGrad AiCPU register"""
    return
