...
scatter_nd_op_info = AiCPURegOp("ScatterNd") \
    .fusion_type("OPAQUE") \
    ...
    .dtype_format(DataType.I32_Default, DataType.BOOL_Default, DataType.I32_Default, DataType.BOOL_Default) \
...
def _scatter_nd_aicpu():
    """ScatterNd AiCPU register"""
    return
