...
blackman_window_op_info = AiCPURegOp("BlackmanWindow") \
    .fusion_type("OPAQUE") \
    .input(0, "window_length", "required") \
    .output(0, "y", "dynamic") \
    .attr("periodic", "bool") \
...
@op_info_register(blackman_window_op_info)
def _blackman_window_aicpu():
    """BlackmanWindow aicpu register"""
    return
