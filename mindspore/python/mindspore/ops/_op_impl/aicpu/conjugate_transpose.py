...
"""ConjugateTranspose op"""
from mindspore.ops.op_info_register import op_info_register, AiCPURegOp, DataType

conjugate_transpose_op_info = AiCPURegOp("ConjugateTranspose") \
    .fusion_type("OPAQUE") \
    .input(0, "x", "required") \
    .input(1, "perm", "required") \
    .output(0, "y", "required") \
...
@op_info_register(conjugate_transpose_op_info)
def _conjugate_transpose_aicpu():
    """ConjugateTranspose aicpu register"""
    return
