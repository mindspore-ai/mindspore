...
resize_v2_grad_op_info = AiCPURegOp("ResizeV2Grad") \
    .fusion_type("OPAQUE") \
    .input(0, "grads", "required") \
    .input(1, "roi", "required") \
    .input(2, "scales", "required") \
    .input(3, "original_size", "required") \
    .output(0, "y", "required") \
...
@op_info_register(resize_v2_grad_op_info)
def _resize_v2_grad_aicpu():
    """ResizeV2Grad AiCPU register"""
    return
