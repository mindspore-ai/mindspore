...
# ============================================================================
"""UpsampleNearest3DGrad op"""
from mindspore.ops.op_info_register import op_info_register, AiCPURegOp, DataType

upsample_nearest_3d_grad_op_info = AiCPURegOp("UpsampleNearest3DGrad") \
    .fusion_type("OPAQUE") \
...
@op_info_register(upsample_nearest_3d_grad_op_info)
def _upsample_nearest_3d_grad_aicpu():
    """UpsampleNearest3DGrad AiCPU register"""
    return
