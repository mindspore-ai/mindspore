...
slice_grad_op_info = AiCPURegOp("SliceGrad") \
    .fusion_type("OPAQUE") \
    .input(0, "dy", "required") \
    .input(1, "x", "required") \
    .input(2, "begin", "required") \
    .input(3, "size", "required") \
    ...
    .dtype_format(DataType.U16_Default, DataType.U16_Default, DataType.I64_Default, DataType.I64_Default,
                  DataType.U16_Default) \
    .dtype_format(DataType.U32_Default, DataType.U32_Default, DataType.I64_Default, DataType.I64_Default,
                  DataType.U32_Default) \
    .dtype_format(DataType.U64_Default, DataType.U64_Default, DataType.I64_Default, DataType.I64_Default,
                  DataType.U64_Default) \
...
@op_info_register(slice_grad_op_info)
def _slice_grad_aicpu():
    """SliceGrad AiCPU register"""
    return
