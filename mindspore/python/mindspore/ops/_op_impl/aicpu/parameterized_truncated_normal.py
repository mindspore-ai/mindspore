...
"""ParameterizedTruncatedNormal op"""
from mindspore.ops.op_info_register import op_info_register, AiCPURegOp, DataType
parameterized_truncated_normal_op_info = AiCPURegOp("ParameterizedTruncatedNormal") \
    .fusion_type("OPAQUE") \
...
@op_info_register(parameterized_truncated_normal_op_info)
def _parameterized_truncated_normal_aicpu():
    """ParameterizedTruncatedNormal AiCPU register"""
    return
