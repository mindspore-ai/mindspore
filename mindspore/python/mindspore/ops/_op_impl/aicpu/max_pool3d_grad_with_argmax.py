...
"""MaxPool3DGradWithArgmax op"""
from mindspore.ops.op_info_register import op_info_register, AiCPURegOp, DataType

max_pool3d_grad_with_argmax_op_info = AiCPURegOp("MaxPool3DGradWithArgmax") \
    .fusion_type("OPAQUE") \
    .attr("ksize", "listInt") \
    ...
    .dtype_format(DataType.U32_Default, DataType.U32_Default, DataType.I64_Default, DataType.U32_Default) \
    .dtype_format(DataType.U64_Default, DataType.U64_Default, DataType.I64_Default, DataType.U64_Default) \
    .get_op_info()


@op_info_register(max_pool3d_grad_with_argmax_op_info)
def _max_pool3d_grad_with_argmax_aicpu():
    """MaxPool3DGradWithArgmax aicpu register"""
    return
