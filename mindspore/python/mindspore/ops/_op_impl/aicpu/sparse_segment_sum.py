...
sparse_segment_sum_op_info = AiCPURegOp("SparseSegmentSum") \
    .fusion_type("OPAQUE") \
    .input(0, "x", "required") \
...
@op_info_register(sparse_segment_sum_op_info)
def _sparse_segment_sum_aicpu():
    """SparseSegmentSum AiCPU register"""
    return
