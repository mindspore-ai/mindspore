...
argmax_with_value_op_info = AiCPURegOp("ArgMaxWithValue") \
    .fusion_type("OPAQUE") \
    .input(0, "x", "required") \
...
@op_info_register(argmax_with_value_op_info)
def _argmax_with_value_aicpu():
    """ArgMaxWithValue aicpu register"""
    return
