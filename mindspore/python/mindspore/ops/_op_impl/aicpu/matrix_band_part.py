...
matrix_band_part_op_info = AiCPURegOp("MatrixBandPart") \
    .fusion_type("OPAQUE") \
    .input(0, "x", "required") \
    .input(1, "num_lower", "required") \
    .input(2, "num_upper", "required") \
    .output(0, "y", "required") \
...
@op_info_register(matrix_band_part_op_info)
def _matrix_band_part_aicpu():
    """MatrixBandPart aicpu register"""
    return
