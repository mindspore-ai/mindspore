...
class FlashAttentionFwd(FlashAttention):
    ...
    def __init__(self, q, k, v,
        ...
        super(FlashAttentionFwd, self).__init__(q, k, v, attn_mask, dropout_mask, alibi_mask, kernel_name,
...
def flash_attention(q, k, v, attn_mask, dropout_mask, alibi_mask, y, l, m,
    ...
    tik_instance
    """
    fa = FlashAttentionFwd(q=q, k=k, v=v, attn_mask=attn_mask,
