...
def jvp(fn, inputs, v, has_aux=False):
    ...
    <https://www.mindspore.cn/docs/en/r2.3.0rc1/design/programming_paradigm.html#forward-mode-ad>`_.
...
def vjp(fn, *inputs, weights=None, has_aux=False):
    ...
    <https://www.mindspore.cn/docs/en/r2.3.0rc1/design/programming_paradigm.html#reverse-mode-ad>`_.
...
def stop_gradient(value):
    ...
    <https://www.mindspore.cn/tutorials/en/r2.3.0rc1/beginner/autograd.html#stop-gradient>`_.
