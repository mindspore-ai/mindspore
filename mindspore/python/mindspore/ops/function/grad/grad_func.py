...
def jvp(fn, inputs, v, has_aux=False):
    ...
    `forward-mode differentiation <https://www.mindspore.cn/docs/en/r1.11/design/auto_gradient.html#forward-mode-ad>`_.
...
def vjp(fn, *inputs, has_aux=False):
    ...
    `reverse-mode differentiation <https://www.mindspore.cn/docs/en/r1.11/design/auto_gradient.html#reverse-mode-ad>`_.
...
def stop_gradient(value):
    ...
    <https://www.mindspore.cn/tutorials/en/r1.11/beginner/autograd.html#stop-gradient>`_.
