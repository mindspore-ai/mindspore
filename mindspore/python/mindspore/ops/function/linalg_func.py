...
def pinv(x, *, atol=None, rtol=None, hermitian=False):
    ...
    `x.svd <https://www.mindspore.cn/docs/en/r1.11/api_python/ops/mindspore.ops.svd.html>`_ .
    ...
    `eps <https://www.mindspore.cn/docs/en/r1.11/api_python/ops/mindspore.ops.Eps.html>`_ value of x.dtype.
    If rtol is not specified and atol specifies a value larger than zero, rtol is set to zero.

    .. note::
        This function uses
        `svd <https://www.mindspore.cn/docs/en/r1.11/api_python/ops/mindspore.ops.svd.html>`_ internally,
        (or `eigh <https://www.mindspore.cn/docs/en/r1.11/api_python/scipy/mindspore.scipy.linalg.eigh.html>`_ ,
