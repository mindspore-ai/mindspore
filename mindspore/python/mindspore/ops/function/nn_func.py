...
from mindspore.ops.auto_generate import log_softmax, dense, prelu, celu, relu, fast_gelu, silu, elu, sigmoid, relu6, rms_norm
from mindspore.ops.auto_generate import GroupNorm, BatchNormExt
...
def batch_norm_ext(input, running_mean, running_var, weight=None, bias=None, training=False, momentum=0.1, eps=1e-5):
    ...
    output = BatchNormExt()(input, weight, bias, running_mean, running_var, training, momentum, eps)
    return output[0]
