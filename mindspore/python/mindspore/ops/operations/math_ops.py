...
class Add(_MathBinaryOp):
    ...
    .. note::
        - Inputs of `x` and `y` comply with the
          `implicit type conversion rules <https://www.mindspore.cn/docs/en/r1.7/note/operator_list_implicit.html>`_
    ...
    Inputs:
        - **x** (Union[Tensor, number.Number, bool]) - The first input is a number.Number or
          ...
          `number <https://www.mindspore.cn/docs/en/r1.7/api_python/mindspore.html#mindspore.dtype>`_ or
          `bool_ <https://www.mindspore.cn/docs/en/r1.7/api_python/mindspore.html#mindspore.dtype>`_.
...
class AddN(Primitive):
    ...
    Inputs:
        - **x** (Union(tuple[Tensor], list[Tensor])) - A tuple or list composed of Tensor, the data type is
          `bool_ <https://www.mindspore.cn/docs/en/r1.7/api_python/mindspore.html#mindspore.dtype>`_ or
