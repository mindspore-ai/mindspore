...
class AllReduce(Primitive):
    ...
    Tutorial Examples:
        - `Distributed Set Communication Primitives - AllReduce
          <https://www.mindspore.cn/docs/en/r2.3.0rc1/api_python/samples/ops/communicate_ops.html#allreduce>`_
...
class AllGather(PrimitiveWithInfer):
    ...
    Tutorial Examples:
        - `Distributed Set Communication Primitives - AllGather
          <https://www.mindspore.cn/docs/en/r2.3.0rc1/api_python/samples/ops/communicate_ops.html#allgather>`_
...
class ReduceScatter(Primitive):
    ...
    Tutorial Examples:
        - `Distributed Set Communication Primitives - ReduceScatter
          <https://www.mindspore.cn/docs/en/r2.3.0rc1/api_python/samples/ops/communicate_ops.html#reducescatter>`_
...
class Broadcast(PrimitiveWithInfer):
    ...
    Tutorial Examples:
        - `Distributed Set Communication Primitives - Broadcast
          <https://www.mindspore.cn/docs/en/r2.3.0rc1/api_python/samples/ops/communicate_ops.html#broadcast>`_
...
class NeighborExchange(Primitive):
    ...
    Note:
        ...
        <https://www.mindspore.cn/docs/en/r2.3.0rc1/api_python/mindspore.ops.primitive.html#communication-operator>`_.
        ...
        <https://www.mindspore.cn/docs/en/r2.3.0rc1/api_python/samples/ops/communicate_ops.html#notes>`_.
    ...
    Tutorial Examples:
        - `Distributed Set Communication Primitives - NeighborExchange
          <https://www.mindspore.cn/docs/en/r2.3.0rc1/api_python/samples/ops/communicate_ops.html#neighborexchange>`_
...
class AlltoAll(PrimitiveWithInfer):
    ...
    Tutorial Examples:
        - `Distributed Set Communication Primitives - AlltoAll
          <https://www.mindspore.cn/docs/en/r2.3.0rc1/api_python/samples/ops/communicate_ops.html#alltoall>`_
...
class NeighborExchangeV2(Primitive):
    ...
    Tutorial Examples:
        - `Distributed Set Communication Primitives - NeighborExchangeV2
          <https://www.mindspore.cn/docs/en/r2.3.0rc1/api_python/samples/ops/communicate_ops.html#neighborexchangev2>`_
