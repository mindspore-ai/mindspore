...
class ReduceOp:
    ...
    Note:
        ...
        <https://www.mindspore.cn/docs/en/r1.8/api_python/mindspore.ops.html#communication-operator>`_.
...
class NeighborExchange(Primitive):
    ...
    Note:
        ...
        <https://www.mindspore.cn/tutorials/experts/zh-CN/r1.8/parallel/communicate_ops.html#注意事项>`_.
