...
class ReduceOp:
    ...
    Examples:
        .. note::
            ...
            <https://www.mindspore.cn/tutorials/experts/en/r1.11/parallel/train_ascend.html#preparations>`_
            for more details.

            For the GPU devices, users need to prepare the host file and mpi, please see the `GPU tutorial
            <https://www.mindspore.cn/tutorials/experts/en/r1.11/parallel/train_gpu.html#preparation>`_ .
...
class ReduceScatter(Primitive):
    ...
    <https://www.mindspore.cn/tutorials/experts/en/r1.11/parallel/communicate_ops.html#reducescatter>`_ .
...
class NeighborExchange(Primitive):
    ...
    Note:
        ...
        <https://www.mindspore.cn/docs/en/r1.11/api_python/mindspore.ops.html#communication-operator>`_.
        ...
        <https://www.mindspore.cn/tutorials/experts/en/r1.11/parallel/communicate_ops.html#notes>`_.
...
class NeighborExchangeV2(Primitive):
    ...
    <https://www.mindspore.cn/tutorials/experts/en/r1.11/parallel/communicate_ops.html#neighborexchangev2>`_
