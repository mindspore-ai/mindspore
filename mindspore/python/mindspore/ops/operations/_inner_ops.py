...
class ApplyCamePart1(Primitive):
    ...
    Inputs:
        - **grad** (Tensor) - The grad tensor with data type must be in [float16, float32, bfloat16].
          Input tensor of shape = 2D :math:`(..., n, m)`.
        - **eps** (scalar) - data type must be float.
    ...
    def __init__(self):
        ...
        self.init_prim_io_names(inputs=['grad', 'eps'], outputs=['sum_grad_r', 'sum_grad_c', 'sum_grad_rc'])
...
class ApplyCamePart2(Primitive):
    ...
    Inputs:
        - **grad** (Tensor) - The grad tensor with data type must be in [float16, float32, bfloat16].
          Input tensor of shape = 2D :math:`(..., n, m)`.
        - **sum_grad_r** (Tensor) - The sum_grad_r tensor with data type must be in [float32].
          Input tensor of shape = 1D :math:`(..., n)`.
        - **sum_grad_c** (Tensor) - The sum_grad_c tensor with data type must be in [float32].
          Input tensor of shape = 1D :math:`(..., m)`.
        - **sum_grad_rc** (Tensor) - The sum_grad_rc tensor with data type must be in [float32].
          Input tensor of shape = 1D :math:`(...)`.
        - **r** (Tensor) - The r tensor with data type must be in [float16, float32, bfloat16].
          Input tensor of shape = 1D :math:`(..., n)`.
        - **c** (Tensor) - The c tensor with data type must be in [float16, float32, bfloat16].
          Input tensor of shape = 1D :math:`(..., m)`.
        - **beta2** (scalar) - data type must be float.
        - **sum_r** (Tensor or None) - The c tensor with data type must be in [float32].
          Input tensor of shape = 1D :math:`(...)`.
        - **global_shape** (Tensor or None) - The global_shape tensor with data type must be in [int64].
          Input tensor of shape = 1D :math:`(2)`.
    ...
    def __init__(self):
        """Initialize FlashAttentionScore"""
        self.init_prim_io_names(inputs=['grad', 'sum_grad_r', 'sum_grad_c', 'sum_grad_rc', 'r', 'c', 'beta2', 'sum_r',
                                        'global_shape'], outputs=['r', 'c', 'u', 'sum_square_u'])
...
class ApplyCamePart3(Primitive):
    ...
    Inputs:
        - **u** (Tensor) - The u tensor with data type must be in [float16, float32, bfloat16].
          Input tensor of shape = 2D :math:`(..., n, m)`.
        - **m** (Tensor) - The m tensor with data type must be in [float16, float32, bfloat16].
          Input tensor of shape = 2D :math:`(..., n, m)`.
        - **eps** (scalar) - data type must be float.
        - **betal** (scalar) - data type must be float.
        - **clip_threshold** (scalar) - data type must be float.
        - **sum_square_u** (Tensor) - The sum_square_u tensor with data type must be in [float32].
          Input tensor of shape = 1D :math:`(1)`.
        - **global_shape** (Tensor or None) - The global_shape tensor with data type must be in [int64].
          Input tensor of shape = 1D :math:`(2)`.
    ...
    def __init__(self):
        """Initialize FlashAttentionScore"""
        self.init_prim_io_names(inputs=['u', 'm', 'eps', 'betal', 'clip_threshold', 'sum_square_u', 'global_shape',
                                        'use_first_moment'], outputs=['m', 'sum_u_r', 'sum_u_c', 'sum_u_rc'])
...
class ApplyCamePart4(Primitive):
    ...
    Inputs:
        - **param** (Tensor) - The grad tensor with data type must be in [float16, float32, bfloat16].
          Input tensor of shape >= 2D :math:`(..., n, m)`.
        - **m** (Tensor) - The m tensor with data type must be in [float16, float32, bfloat16].
          Input tensor of shape = 2D :math:`(..., n, m)`.
        - **r** (Tensor) - The r tensor with data type must be in [float16, float32, bfloat16].
        ...
        - **c** (Tensor) - The c tensor with data type must be in [float16, float32, bfloat16].
          Input tensor of shape = 1D :math:`(..., m)`.
        - **weight_decay** (scalar) - data type must be float.
        - **lr** (scalar) - data type must be float.
        - **beta3** (scalar) - data type must be float.
        - **sum_r** (Tensor or None) - The sum_r tensor with data type must be in [float32].
          Input tensor of shape = 1D :math:`(..., 1)`.
        - **sum_u_r** (Tensor) - The sum_u_r tensor with data type must be in [float32].
          Input tensor of shape = 1D :math:`(..., n)`.
        - **sum_u_c** (Tensor) - The sum_u_c tensor with data type must be in [float32].
          Input tensor of shape = 1D :math:`(..., m)`.
        - **sum_u_rc** (Tensor) - The sum_u_rc tensor with data type must be in [float32].
          Input tensor of shape = 1D :math:`(...)`.
        - **global_shape** (Tensor or None) - The global_shape tensor with data type must be in [int64].
          Input tensor of shape = 1D :math:`(2)`.
    ...
    def __init__(self):
        """Initialize FlashAttentionScore"""
        self.init_prim_io_names(inputs=['param', 'm', 'r', 'c', 'weight_decay', 'lr', 'beta3', 'sum_r', 'sum_u_r',
                                        'sum_u_c', 'sum_u_rc', 'global_shape'], outputs=['param', 'r', 'c'])
