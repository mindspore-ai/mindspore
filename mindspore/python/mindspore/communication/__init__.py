...
<https://www.mindspore.cn/tutorials/experts/zh-CN/r1.10/parallel/train_ascend.html>`_ for more details.
For the GPU device, users need to prepare the host file and mpi, please see the `GPU tutorial \
<https://www.mindspore.cn/tutorials/experts/zh-CN/r1.10/parallel/train_gpu.html>`_
for more details.
"""
