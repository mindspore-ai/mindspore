...
<https://www.mindspore.cn/tutorials/en/r1.10/beginner/transforms.html#text-transforms>`_ tutorial for more details.
...
- Pipeline mode is generally used to process datasets. For examples, please refer to
  `introduction to data processing pipeline <https://www.mindspore.cn/docs/en/r1.10/api_python/
