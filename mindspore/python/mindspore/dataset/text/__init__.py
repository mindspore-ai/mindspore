...
See `Text Transforms
<https://www.mindspore.cn/tutorials/en/r2.3.0rc1/beginner/transforms.html#text-transforms>`_ tutorial for more details.
...
- Pipeline mode is generally used to process big datasets. Examples refer to
  `introduction to data processing pipeline <https://www.mindspore.cn/docs/en/r2.3.0rc1/api_python/
...
- Eager mode is more like a function call to process data. Examples refer to
  `Lightweight Data Processing <https://www.mindspore.cn/tutorials/en/r2.3.0rc1/advanced/dataset/eager.html>`_ .
"""
import platform
