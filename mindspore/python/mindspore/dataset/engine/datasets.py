...
class Dataset:
    ...
    def map(self, operations, input_columns=None, output_columns=None, column_order=None,
        ...
        - If you use transformations (
          `vision transform <https://mindspore.cn/docs/en/r1.11/api_python/mindspore.\
          dataset.transforms.html#module-mindspore.dataset.vision>`_ ,
          `nlp transform <https://mindspore.cn/docs/en/r1.11/api_python/mindspore.\
          dataset.transforms.html#module-mindspore.dataset.text>`_ ,
          `audio transform <https://mindspore.cn/docs/en/r1.11/api_python/mindspore.\
