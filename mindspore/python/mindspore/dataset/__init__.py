...
can refer `Single-Node Tensor Cache <https://www.mindspore.cn/tutorials/experts/en/r1.10/dataset/cache.html>`_.
...
- Dataset sample transform operation: The user can add data transform operators
  (`vision transform <https://www.mindspore.cn/docs/en/r1.10/api_python/mindspore.dataset.vision.html>`_,
  `NLP transform <https://www.mindspore.cn/docs/en/r1.10/api_python/mindspore.dataset.text.html>`_,
  `audio transform <https://www.mindspore.cn/docs/en/r1.10/api_python/mindspore.dataset.audio.html>`_) to the map
...
`datasets_example.py <https://gitee.com/mindspore/mindspore/tree/r1.10/docs/api/api_python_en/datasets_example.py>`_
