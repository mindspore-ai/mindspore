...
can refer `Single-Node Tensor Cache <https://www.mindspore.cn/tutorials/experts/en/r1.11/dataset/cache.html>`_ .
...
`datasets_example.py <https://gitee.com/mindspore/mindspore/tree/r1.11/docs/api/api_python_en/datasets_example.py>`_
