...
from mindspore.common.tensor import Tensor, RowTensor, RowTensorInner, SparseTensor, COOTensor, CSRTensor
...
__all__.extend([
    "Tensor", "RowTensor", "RowTensorInner", "SparseTensor", "COOTensor", "CSRTensor",  # tensor
