    ...
    def set_param_ps(self, init_in_server=False):
        ...
        Tutorial Examples:
            - `Parameter Server Mode
              <https://www.mindspore.cn/tutorials/experts/en/r2.3.0rc1/parallel/parameter_server_training.html>`_
        """
    ...
    def clone(self, prefix, init='same'):
        ...
        Tutorial Examples:
            - `Cell and Parameter - Parameter Tuple
              <https://mindspore.cn/tutorials/en/r2.3.0rc1/advanced/modules/layer.html#parameter-tuple>`_
        """
