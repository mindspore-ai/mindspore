...
def tensor(input_data=None, dtype=None, shape=None, init=None, internal=False, const_arg=False):
    ...
    <https://www.mindspore.cn/docs/en/r2.3.0rc1/note/static_graph_syntax_support.html#mindspore-user-defined-data-types>`_ .

    The difference between it and the Tensor class is that it adds
    `Annotation
    <https://www.mindspore.cn/docs/en/r2.3.0rc1/design/dynamic_graph_and_static_graph.html?#annotation-type>`_
    ...
    def init_data(self, slice_index=None, shape=None, opt_shard_group=None):
        ...
        Args:
            ...
            opt_shard_group(str): Optimizer shard group which is used in auto or semi auto parallel mode
                ...
                `Optimizer Parallel
                <https://www.mindspore.cn/tutorials/experts/en/r2.3.0rc1/parallel/optimizer_parallel.html>`_.
                Default: ``None``.
