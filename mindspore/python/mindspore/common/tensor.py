...
def tensor(input_data=None, dtype=None, shape=None, init=None, internal=False, const_arg=False):
    ...
    <https://www.mindspore.cn/docs/en/r2.1/note/static_graph_syntax_support.html#mindspore-user-defined-data-types>`_ .

    The difference between it and the Tensor class is that it adds
    `Annotation
    <https://www.mindspore.cn/docs/en/r2.1/design/dynamic_graph_and_static_graph.html?#annotation-type>`_
