...
class QuantDtype(enum.Enum):
    ...
    `dtype.py <https://gitee.com/mindspore/mindspore/blob/r2.3.q1/mindspore/python/mindspore/common/dtype.py>`_ ,
    ...
    Tutorial Examples:
        - `Quantization algorithm in Golden Stick
          <https://www.mindspore.cn/golden_stick/docs/en/r0.4/quantization/slb.html
