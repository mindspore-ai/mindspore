...
"""
        gen_py += enum_func_code + value_error_code + blank_line
    return gen_py
...
if __name__ == "__main__":
    ...
    dst_arg_handler_path = os.path.join(work_path, 'mindspore/python/mindspore/ops/auto_generate/arg_handler.py')
    ...
    os.system(f'cp {src_arg_handler_path} {dst_arg_handler_path}')

    with open(dst_arg_handler_path, 'a') as py_file:
