...
from mindspore.hypercomplex.double._double_bn_impl import _BatchNormImpl as BatchNormImpl, \
...
from mindspore.hypercomplex.double._double_conv_impl import _ConvImpl as ConvImpl, \
    _J1J2ConvImpl as J1J2ConvImpl
# Dense
from mindspore.hypercomplex.hypercomplex.hc_dense import Dense as HDense
from mindspore.hypercomplex.double._double_dense_impl import _DenseImpl as DenseImpl, \
    _J1J2DenseImpl as J1J2DenseImpl
from mindspore.hypercomplex.hypercomplex.uniform_operator import _UniformOperator
# ReLU
from mindspore.hypercomplex.double.double_relu import J1J2ReLU
...
class Conv2d(_UniformOperator):
    ...
    Examples:
        >>> import numpy as np
        >>> from mindspore.hypercomplex.double import Conv2d
...
class Conv1d(_UniformOperator):
    ...
    Examples:
        >>> import numpy as np
        >>> from mindspore.hypercomplex.double import Conv1d
        >>> from mindspore import Tensor
...
class BatchNorm1d(_UniformOperator):
    ...
    Examples:
        >>> import numpy as np
        >>> from mindspore.hypercomplex.double import BatchNorm1d
        >>> from mindspore import Tensor
...
class BatchNorm2d(_UniformOperator):
    ...
    Examples:
        >>> import numpy as np
        >>> from mindspore.hypercomplex.double import BatchNorm2d
        >>> from mindspore import Tensor
...
class BatchNorm3d(_UniformOperator):
    ...
    Examples:
        >>> import numpy as np
        >>> from mindspore.hypercomplex.double import BatchNorm3d
        >>> from mindspore import Tensor
...
class Dense(_UniformOperator):
    ...
    Examples:
        >>> import numpy as np
        >>> from mindspore.hypercomplex.double import Dense
        >>> from mindspore import Tensor
...
class ReLU(nn.Cell):
    ...
    Examples:
        >>> import numpy as np
        >>> from mindspore.hypercomplex.sboule import ReLU
        >>> from mindspore import Tensor
        >>> net = ReLU()
