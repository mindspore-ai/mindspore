...
class Cell(Cell_):
    ...
    def set_inputs(self, *inputs):
        """
        Save set inputs for computation graph. The number of inputs should be the same with that of the network in
        construct. When using Model for dynamic shape, please make sure that all networks and loss functions passed
        to the Model are configured with set_inputs. The inputs can be Tensor of either dynamic or static shape.
    ...
    def set_boost(self, boost_type):
        ...
        `algorithm library <https://gitee.com/mindspore/mindspore/tree/r1.8/mindspore/python/mindspore/boost>`_.
