...
def data_sink(fn, dataset, steps, sink_size=1, jit=False):
    ...
    Args:
        ...
        sink_size (int): Control the amount of data in each sink. `sink_size` must be positive. Default: 1.
        jit (bool): Controls the execution mode of the generated function. Default: False.

    Returns:
        Function, the generated function will be executed in data sinking mode.

    Raises:
        ValueError: If `steps` or `sink_size` is negative.
