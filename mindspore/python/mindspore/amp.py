...
def all_finite(inputs):
    ...
    Tutorial Examples:
        - `Automatic Mix Precision - Loss Scaling
          <https://mindspore.cn/tutorials/en/r2.3.0rc1/advanced/mixed_precision.html#loss-scaling>`_
    """
...
class LossScaler(ABC):
    ...
    For more information, refer to the `tutorials  <https://mindspore.cn/tutorials/en/r2.3.0rc1/advanced/
