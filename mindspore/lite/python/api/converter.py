...
class Converter:
    ...
    `converter_tool <https://www.mindspore.cn/lite/docs/en/r2.2/use/cloud_infer/converter_tool.html>`_  instead of
    ...
    def input_format(self):
        ...
        Returns:
            ...
            see `Format <https://mindspore.cn/lite/api/en/r2.2/mindspore_lite/mindspore_lite.Format.html>`_ .
    ...
    def save_type(self):
        ...
        Returns:
            ...
            `ModelType <https://mindspore.cn/lite/api/en/r2.2/mindspore_lite/mindspore_lite.ModelType.html>`_ .
        """
    ...
    def convert(self, fmk_type, model_file, output_file, weight_file="", config_file=""):
        ...
        Args:
            fmk_type (FmkType): Input model framework type. Options are ``FmkType.TF`` , ``FmkType.CAFFE`` ,
                ...
                `FmkType <https://mindspore.cn/lite/api/en/r2.2/mindspore_lite/mindspore_lite.FmkType.html>`_ .
            ...
            config_file (str, optional): Set the path of the configuration file of Converter can be used to
                ...
                `quantization <https://www.mindspore.cn/lite/docs/en/r2.2/use/post_training_quantization.html>`_ .
                For the configuration parameters related to extension, please refer to
                `extension  <https://www.mindspore.cn/lite/docs/en/r2.2/use/nnie.html#extension-configuration>`_ .
