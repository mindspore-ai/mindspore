 ...
 */
#ifndef MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_BASE_RESHAPE_BASE_H_
#define MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_BASE_RESHAPE_BASE_H_
...
#endif  // MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_BASE_RESHAPE_BASE_H_
