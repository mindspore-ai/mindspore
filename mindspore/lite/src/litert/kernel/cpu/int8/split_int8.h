...
#ifndef MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_INT8_SPLIT_INT8_H_
#define MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_INT8_SPLIT_INT8_H_
...
class SplitInt8CPUKernel : public SplitBaseCPUKernel {
 public:
  ...
  int ReSize() override;
  int Run() override;
  int Split(int task_id) override;
...
#endif  // MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_INT8_SPLIT_INT8_H_
