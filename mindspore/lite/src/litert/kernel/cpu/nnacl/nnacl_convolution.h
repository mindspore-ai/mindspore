...
#ifndef MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_NNACL_CONVOLUTION_H_
#define MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_NNACL_CONVOLUTION_H_
...
class ConvolutionKernel : public NNACLKernel {
 public:
  explicit ConvolutionKernel(OpParameter *parameter, const std::vector<lite::Tensor *> &inputs,
