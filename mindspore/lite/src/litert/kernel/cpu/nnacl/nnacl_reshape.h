...
#ifndef MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_NNACL_RESHAPE_H_
#define MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_NNACL_RESHAPE_H_
...
#endif  // MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_NNACL_RESHAPE_H_
