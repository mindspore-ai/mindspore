 ...
 */
#ifndef MINDSPORE_LITE_SRC_LITERT_DELEGATE_NNAPI_OP_CONCAT_NNAPI_H_
#define MINDSPORE_LITE_SRC_LITERT_DELEGATE_NNAPI_OP_CONCAT_NNAPI_H_
...
namespace mindspore {
namespace lite {
class NNAPIConcat : public NNAPIOp {
 public:
  NNAPIConcat(const std::string &name, const schema::Primitive *primitive,
...
#endif  // MINDSPORE_LITE_SRC_LITERT_DELEGATE_NNAPI_OP_CONCAT_NNAPI_H_
