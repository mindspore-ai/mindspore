 ...
 */
#ifndef MINDSPORE_LITE_SRC_LITERT_DELEGATE_NNAPI_OP_RESIZE_NNAPI_H_
#define MINDSPORE_LITE_SRC_LITERT_DELEGATE_NNAPI_OP_RESIZE_NNAPI_H_
...
class NNAPIResize : public NNAPIOp {
 public:
  NNAPIResize(const std::string &name, const schema::Primitive *primitive,
...
#endif  // MINDSPORE_LITE_SRC_LITERT_DELEGATE_NNAPI_OP_RESIZE_NNAPI_H_
