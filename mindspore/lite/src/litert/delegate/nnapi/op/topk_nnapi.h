 ...
 */
#ifndef MINDSPORE_LITE_SRC_LITERT_DELEGATE_NNAPI_OP_TOPK_NNAPI_H_
#define MINDSPORE_LITE_SRC_LITERT_DELEGATE_NNAPI_OP_TOPK_NNAPI_H_
...
namespace mindspore {
namespace lite {
class NNAPITopk : public NNAPIOp {
 public:
  NNAPITopk(const std::string &name, const schema::Primitive *primitive,
