 ...
 */
#ifndef MINDSPORE_LITE_SRC_LITERT_DELEGATE_NNAPI_OP_RESHAPE_NNAPI_H_
#define MINDSPORE_LITE_SRC_LITERT_DELEGATE_NNAPI_OP_RESHAPE_NNAPI_H_
...
namespace mindspore {
namespace lite {
class NNAPIReshape : public NNAPIOp {
 public:
  NNAPIReshape(const std::string &name, const schema::Primitive *primitive,
...
#endif  // MINDSPORE_LITE_SRC_LITERT_DELEGATE_NNAPI_OP_RESHAPE_NNAPI_H_
