...
#ifndef MINDSPORE_LITE_SRC_LITERT_DELEGATE_TENSORRT_OP_SQUARE_TENSORRT_H_
#define MINDSPORE_LITE_SRC_LITERT_DELEGATE_TENSORRT_OP_SQUARE_TENSORRT_H_
#include <string>
#include <vector>
...
#endif  // MINDSPORE_LITE_SRC_LITERT_DELEGATE_TENSORRT_OP_SQUARE_TENSORRT_H_
