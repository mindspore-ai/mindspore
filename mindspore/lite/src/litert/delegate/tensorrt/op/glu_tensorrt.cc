...
#include "src/litert/delegate/tensorrt/op/glu_tensorrt.h"
#include "src/litert/delegate/tensorrt/tensorrt_utils.h"

namespace mindspore::lite {
int GLUTensorRT::IsSupport(const mindspore::schema::Primitive *primitive,
...
int GLUTensorRT::AddInnerOp(TensorRTContext *ctx) {
  dim_ = op_primitive_->value_as_GLU()->axis();
...
REGISTER_TENSORRT_CREATOR(schema::PrimitiveType_GLU, GLUTensorRT)
}  // namespace mindspore::lite
