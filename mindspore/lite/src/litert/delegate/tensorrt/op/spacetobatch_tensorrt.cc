...
#include "src/litert/delegate/tensorrt/op/spacetobatch_tensorrt.h"
#include "spacetobatch_impl.cuh"

namespace mindspore::lite {
int SpaceToBatchTensorRT::IsSupport(const schema::Primitive *primitive,
...
REGISTER_TENSORRT_CREATOR(schema::PrimitiveType_SpaceToBatchND, SpaceToBatchTensorRT)
}  // namespace mindspore::lite
