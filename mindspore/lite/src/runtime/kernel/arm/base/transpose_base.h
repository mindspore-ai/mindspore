 ...
 */
#ifndef MINDSPORE_CCSRC_KERNEL_CPU_ARM_BASE_TRANSPOSE_BASE_H_
#define MINDSPORE_CCSRC_KERNEL_CPU_ARM_BASE_TRANSPOSE_BASE_H_
...
#endif  // MINDSPORE_CCSRC_KERNEL_CPU_ARM_BASE_TRANSPOSE_BASE_H_
