...
class WhereFp16CPUKernel : public WhereCPUKernel {
 public:
  WhereFp16CPUKernel(OpParameter *parameter, const std::vector<lite::Tensor *> &inputs,
                     const std::vector<lite::Tensor *> &outputs, const lite::InnerContext *ctx)
      : WhereCPUKernel(parameter, inputs, outputs, ctx) {}
  ~WhereFp16CPUKernel() = default;
