...
#include "src/runtime/kernel/cpu/fp32/convolution_winograd_avx_fp32.h"
#endif

#if defined(ENABLE_SSE)
#include "src/runtime/kernel/cpu/fp32/convolution_winograd_sse_fp32.h"
#endif

#if defined(ENABLE_ARM32)
#include "src/runtime/kernel/cpu/fp32/convolution_winograd_arm32_fp32.h"
#endif

#if defined(ENABLE_ARM64)
#include "src/runtime/kernel/cpu/fp32/convolution_winograd_arm64_fp32.h"
#endif
