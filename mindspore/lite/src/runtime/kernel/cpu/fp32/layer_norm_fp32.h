 ...
 */
#ifndef MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_FP32_LAYER_NORM_FP32_H_
#define MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_FP32_LAYER_NORM_FP32_H_
#include <vector>
...
#endif  // MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_FP32_LAYER_NORM_FP32_H_
