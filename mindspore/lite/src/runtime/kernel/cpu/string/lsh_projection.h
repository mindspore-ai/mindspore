...
#ifndef MINDSPORE_LITE_SRC_RUNTIME_KERNEL_ARM_STRING_LSH_PROJECTION_H_
#define MINDSPORE_LITE_SRC_RUNTIME_KERNEL_ARM_STRING_LSH_PROJECTION_H_
...
#endif  // MINDSPORE_LITE_SRC_RUNTIME_KERNEL_ARM_STRING_LSH_PROJECTION_H_
