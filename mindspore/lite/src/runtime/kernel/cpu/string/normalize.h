 ...
 */
#ifndef MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_STRING_NORMALIZE_H_
#define MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_STRING_NORMALIZE_H_
...
#endif  // MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_STRING_NORMALIZE_H_
