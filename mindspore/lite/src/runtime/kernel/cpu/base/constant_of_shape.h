 ...
 */
#ifndef MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_BASE_CONSTANT_OF_SHAPE_H_
#define MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_BASE_CONSTANT_OF_SHAPE_H_
...
#endif  // MINDSPORE_LITE_SRC_RUNTIME_KERNEL_CPU_BASE_CONSTANT_OF_SHAPE_H_
