...
#include "src/runtime/kernel/cpu/fp16/convolution_delegate_fp16.h"
#include <vector>
#include "src/runtime/kernel/cpu/fp16/convolution_fp16.h"
#include "src/runtime/kernel/cpu/fp16/convolution_winograd_fp16.h"
#include "src/runtime/kernel/cpu/fp16/convolution_1x1_fp16.h"
#include "src/runtime/kernel/cpu/fp16/group_convolution_fp16.h"
#include "src/runtime/kernel/cpu/fp16/convolution_depthwise_fp16.h"
#include "src/runtime/kernel/cpu/fp16/convolution_depthwise_slidewindow_fp16.h"
#include "src/runtime/kernel/cpu/fp16/convolution_depthwise_3x3_fp16.h"
