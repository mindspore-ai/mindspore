...
#ifndef MINDSPORE_LITE_SRC_EXTENDRT_DELEGATE_ASCEND_NATIVE_OPS_ASCEND_NATIVE_STUB_H_
...
#endif  // MINDSPORE_LITE_SRC_EXTENDRT_DELEGATE_ASCEND_NATIVE_OPS_ASCEND_NATIVE_STUB_H_
