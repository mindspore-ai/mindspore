...
__global__ __aicore__ void mmfuse_custom_mix(bool ta, bool tb, GM_ADDR mat_a, GM_ADDR mat_b, GM_ADDR mat_c,
                                             GM_ADDR bias, GM_ADDR tiling_data, GM_ADDR ws, GM_ADDR extra) {
...
void MatmulMix(bool ta, bool tb, void *mat_a, void *mat_b, void *mat_c, void *bias, void *tiling_data_d,
  ...
  int core_num = (bmm) ? getCubeNum() : tiling->usedCoreNum;
