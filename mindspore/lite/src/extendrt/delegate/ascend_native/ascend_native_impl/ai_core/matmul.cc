...
__global__ __aicore__ void mmfuse_custom_ai(bool ta, bool tb, GM_ADDR mat_a, GM_ADDR mat_b, GM_ADDR mat_c, GM_ADDR bias,
...
void MatmulAi(bool ta, bool tb, void *mat_a, void *mat_b, void *mat_c, void *bias, void *tiling_data_d,
  ...
  mmfuse_custom_ai<<<core_num, nullptr, stream>>>(
