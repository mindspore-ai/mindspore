 ...
 */
#ifndef MINDSPORE_LITE_SRC_EXTENDRT_DELEGATE_TENSORRT_OP_NORMALIZE_TENSORRT_H_
#define MINDSPORE_LITE_SRC_EXTENDRT_DELEGATE_TENSORRT_OP_NORMALIZE_TENSORRT_H_
#include <string>
#include <vector>
...
class NormalizeTensorRT : public TensorRTOp {
 public:
  NormalizeTensorRT(const BaseOperatorPtr &base_operator, const std::vector<TensorInfo> &in_tensors,
...
#endif  // MINDSPORE_LITE_SRC_EXTENDRT_DELEGATE_TENSORRT_OP_NORMALIZE_TENSORRT_H_
