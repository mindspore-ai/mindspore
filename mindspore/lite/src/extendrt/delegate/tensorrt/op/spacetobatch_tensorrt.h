...
class SpaceToBatchTensorRT : public TensorRTOp {
 public:
  SpaceToBatchTensorRT(const schema::Primitive *primitive, const std::vector<mindspore::MSTensor> &in_tensors,
...
constexpr char *SPACETOTENSORRT_PLUGIN_NAME{"SpaceToBatchPlugin"};
