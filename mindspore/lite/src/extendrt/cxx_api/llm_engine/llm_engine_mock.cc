...
ge::Status LLMEngine::PullKv(const LLMReq &) { return ge::GRAPH_SUCCESS; }
ge::Status LLMEngine::MergeKv(const uint64_t req_id, const int32_t batch_index) { return ge::GRAPH_SUCCESS; }

ge::Status LLMEngine::RunDecoder(const std::vector<uint64_t> &, const std::vector<ge::Tensor> &,
