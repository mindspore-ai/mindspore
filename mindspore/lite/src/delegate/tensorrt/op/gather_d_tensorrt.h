 ...
 */
#ifndef MINDSPORE_LITE_SRC_DELEGATE_TENSORRT_OP_GATHER_D_TENSORRT_H_
#define MINDSPORE_LITE_SRC_DELEGATE_TENSORRT_OP_GATHER_D_TENSORRT_H_
#include <string>
#include <vector>
...
class GatherDPlugin : public TensorRTPlugin {
 public:
  GatherDPlugin(const std::string name, size_t dim)
      : TensorRTPlugin(name, std::string(GATHER_D_PLUGIN_NAME)), axis_(dim) {}
...
#endif  // MINDSPORE_LITE_SRC_DELEGATE_TENSORRT_OP_GATHER_D_TENSORRT_H_
