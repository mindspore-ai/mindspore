...
#ifndef MINDSPORE_LITE_SRC_CONTROLFLOW_ENTRANCE_ACTOR_H_
#define MINDSPORE_LITE_SRC_CONTROLFLOW_ENTRANCE_ACTOR_H_
#include <vector>
#include <memory>
#include <string>
...
#endif  // MINDSPORE_LITE_SRC_CONTROLFLOW_ENTRANCE_ACTOR_H_
