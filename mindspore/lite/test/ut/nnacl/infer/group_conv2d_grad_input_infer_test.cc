...
#include "mindspore/lite/nnacl/infer/group_conv2d_grad_input_infer.h"

namespace mindspore {

class GroupConv2dGradInputInferTest : public mindspore::CommonTest {
 public:
  GroupConv2dGradInputInferTest() {}
};

TEST_F(GroupConv2dGradInputInferTest, GroupConv2dGradInputInferTest0) {
  ...
  GroupConv2dGradInputParameter *parameter = new GroupConv2dGradInputParameter;
  ...
  int ret = GroupConv2dGradInputInferShape((const TensorC **)inputs.data(), inputs.size(), outputs.data(),
