...
#include "mindspore/lite/nnacl/infer/expand_dims_infer.h"
...
TEST_F(ExpandDimsInferTest, ExpandDimsInferTest0) {
  ...
  ExpandDimsParameter *parameter = new ExpandDimsParameter;
  parameter->dim_ = 0;
  parameter->op_parameter_.infer_flag_ = true;
  int ret = ExpandDimsInferShape((const TensorC **)inputs.data(), inputs.size(), outputs.data(), outputs.size(),
