...
#include "mindspore/lite/nnacl/infer/softmax_cross_entropy_infer.h"

namespace mindspore {

class SoftmaxCrossEntropyInferTest : public mindspore::CommonTest {
 public:
  SoftmaxCrossEntropyInferTest() {}
};

TEST_F(SoftmaxCrossEntropyInferTest, SoftmaxCrossEntropyInferTest0) {
  ...
  int ret = SoftmaxCrossEntropyInferShape((const TensorC **)inputs.data(), inputs.size(), outputs.data(),
