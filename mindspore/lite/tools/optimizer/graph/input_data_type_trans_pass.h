...
class InputDTypeTransPass : public Pass {
 public:
  explicit InputDTypeTransPass(DataType user_set_data_type, DataType dst_input_data_type, DataType src_input_data_type)
      : Pass("input_data_type_trans_pass"),
        user_set_data_type_(user_set_data_type),
 ...
 private:
  ...
  DataType user_set_data_type_ = DataType::kTypeUnknown;
