...
class FlashAttentionFusion : public MultiplePatternProcessPass {
 ...
 private:
  ...
  CNodePtr CreateFlashAttentionNodeForWanXin(const std::string &pattern_name, const FuncGraphPtr &func_graph,
  ...
  const VectorRef DefineFlashAttentionPatternForWanXin() const;
