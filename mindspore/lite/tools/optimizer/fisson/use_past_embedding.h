...
#ifndef MINDSPORE_LITE_TOOLS_OPTIMIZER_FISSON_USE_PAST_EMBEDDING_H_
#define MINDSPORE_LITE_TOOLS_OPTIMIZER_FISSON_USE_PAST_EMBEDDING_H_
...
#endif  // MINDSPORE_LITE_TOOLS_OPTIMIZER_FISSON_USE_PAST_EMBEDDING_H_
