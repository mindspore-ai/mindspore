...
const AnfNodePtr SplitNodeLite::Process(const FuncGraphPtr &, const AnfNodePtr &node, const EquivPtr &) const {
...
const BaseRef SplitReshapeAndCacheLite::DefinePattern() const {
...
const bool SplitReshapeAndCacheLite::CanSplit(const AnfNodePtr &node) const {
