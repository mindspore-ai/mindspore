...
#ifndef MINDSPORE_CCSRC_GRAPH_IR_CUSTOM_OP_PROTO_OP_PROTO_MACRO_H_
#define MINDSPORE_CCSRC_GRAPH_IR_CUSTOM_OP_PROTO_OP_PROTO_MACRO_H_
...
#endif  // MINDSPORE_CCSRC_GRAPH_IR_CUSTOM_OP_PROTO_OP_PROTO_MACRO_H_
