...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_CHECKER_FULL_CONNECTION_CHECKER_H_
...
namespace mindspore {
namespace dpico {
class FullConnectionChecker : public OpChecker {
 public:
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_CHECKER_FULL_CONNECTION_CHECKER_H_
