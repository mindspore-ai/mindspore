...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_CHECKER_TRANSPOSE_CHECKER_H_
...
namespace mindspore {
namespace dpico {
class TransposeChecker : public OpChecker {
 public:
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_CHECKER_TRANSPOSE_CHECKER_H_
