...
namespace mindspore {
namespace lite {
ops::BaseOperatorPtr OnnxAsinhParser::Parse(const onnx::GraphProto &onnx_proto, const onnx::NodeProto &onnx_node) {
...
REG_NODE_PARSER(kFmkTypeOnnx, Asinh, std::make_shared<lite::OnnxAsinhParser>())
}  // namespace mindspore::registry
