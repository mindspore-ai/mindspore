...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_PARSER_ONNX_ONNX_ATANH_PARSER_H_
...
class OnnxAtanhParser : public converter::NodeParser {
 public:
  OnnxAtanhParser() : NodeParser() {}
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_PARSER_ONNX_ONNX_ATANH_PARSER_H_
