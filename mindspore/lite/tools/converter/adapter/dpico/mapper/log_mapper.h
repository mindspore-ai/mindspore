...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_LOG_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class LogMapper : public OpMapper {
 public:
  LogMapper() : OpMapper("Log") {}
  ~LogMapper() override = default;
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_LOG_MAPPER_H_
