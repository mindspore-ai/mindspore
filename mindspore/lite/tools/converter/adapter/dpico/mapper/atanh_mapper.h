...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_ATANH_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class AtanhMapper : public OpMapper {
 public:
  AtanhMapper() : OpMapper("Atanh") {}
  ~AtanhMapper() override = default;
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_ATANH_MAPPER_H_
