...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_MOD_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class ModMapper : public OpMapper {
 public:
  ModMapper() : OpMapper("Mod") {}
  ~ModMapper() override = default;
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_MOD_MAPPER_H_
