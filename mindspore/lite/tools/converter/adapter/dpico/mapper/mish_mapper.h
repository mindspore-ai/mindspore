...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_MISH_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class MishMapper : public OpMapper {
 public:
  MishMapper() : OpMapper("Mish") {}
  ~MishMapper() override = default;
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_MISH_MAPPER_H_
