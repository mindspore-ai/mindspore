...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_ACOS_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class AcosMapper : public OpMapper {
 public:
  AcosMapper() : OpMapper("Acos") {}
  ~AcosMapper() override = default;
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_ACOS_MAPPER_H_
