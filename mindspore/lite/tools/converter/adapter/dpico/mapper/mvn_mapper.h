...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_MVN_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class MvnMapper : public OpMapper {
 public:
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_MVN_MAPPER_H_
