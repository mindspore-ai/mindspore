...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_POWER_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class PowerMapper : public OpMapper {
 public:
  PowerMapper() : OpMapper("Power") {}
  ~PowerMapper() override = default;
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_POWER_MAPPER_H_
