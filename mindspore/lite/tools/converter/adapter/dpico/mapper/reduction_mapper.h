...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_REDUCTION_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class ReductionMapper : public OpMapper {
 public:
  ReductionMapper() : OpMapper("Reduction") {}
  ~ReductionMapper() override = default;
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_REDUCTION_MAPPER_H_
