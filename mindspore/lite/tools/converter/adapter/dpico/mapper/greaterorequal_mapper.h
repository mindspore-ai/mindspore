...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_GREATEROREQUAL_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class GreaterOrEqualMapper : public OpMapper {
 public:
  GreaterOrEqualMapper() : OpMapper("GreaterOrEqual") {}
  ~GreaterOrEqualMapper() override = default;
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_GREATEROREQUAL_MAPPER_H_
