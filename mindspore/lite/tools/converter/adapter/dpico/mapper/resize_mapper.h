...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_RESIZE_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class ResizeMapper : public OpMapper {
 public:
  ResizeMapper() : OpMapper("Resize") {}
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_RESIZE_MAPPER_H_
