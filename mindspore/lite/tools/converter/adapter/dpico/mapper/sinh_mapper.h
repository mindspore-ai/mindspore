...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_SINH_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class SinhMapper : public OpMapper {
 public:
  SinhMapper() : OpMapper("Sinh") {}
  ~SinhMapper() override = default;
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_SINH_MAPPER_H_
