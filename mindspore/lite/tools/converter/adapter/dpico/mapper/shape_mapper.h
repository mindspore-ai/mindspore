...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_SHAPE_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class ShapeMapper : public OpMapper {
 public:
  ShapeMapper() : OpMapper("Shape") {}
  ~ShapeMapper() override = default;
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_SHAPE_MAPPER_H_
