...
#ifndef DPICO_MAPPER_SPP_MAPPER_H_
#define DPICO_MAPPER_SPP_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class SppMapper : public OpMapper {
 public:
  SppMapper() : OpMapper("Spp") {}
  ~SppMapper() override = default;
...
#endif  // DPICO_MAPPER_SPP_MAPPER_H_
