...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_SHRINK_MAPPER_H_
...
namespace mindspore {
namespace dpico {
class ShrinkMapper : public OpMapper {
 public:
  ShrinkMapper() : OpMapper("Shrink") {}
  ~ShrinkMapper() override = default;
...
#endif  // MINDSPORE_LITE_TOOLS_CONVERTER_ADAPTER_DPICO_MAPPER_SHRINK_MAPPER_H_
