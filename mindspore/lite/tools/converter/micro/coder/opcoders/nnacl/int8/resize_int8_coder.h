 ...
 */
#ifndef MINDSPORE_LITE_MICRO_CODER_SLICE_INT8_CODER_H_
#define MINDSPORE_LITE_MICRO_CODER_SLICE_INT8_CODER_H_
...
#endif  // MINDSPORE_LITE_MICRO_CODER_SLICE_INT8_CODER_H_
