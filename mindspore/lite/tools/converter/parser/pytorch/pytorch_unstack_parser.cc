...
namespace mindspore {
namespace lite {
PrimitiveCPtr PytorchUnbindParser::Parse(const torch::jit::Node *torch_node, std::vector<size_t> *input_indices) {
...
PytorchNodeRegistrar g_pytorchUnbindParser("unbind", new PytorchUnbindParser());
}  // namespace lite
}  // namespace mindspore
