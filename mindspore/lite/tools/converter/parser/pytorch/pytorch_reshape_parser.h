...
#ifndef MINDSPORE_LITE_TOOLS_CONVERTER_PARSER_PYTORCH_PYTORCH_RESHAPE_PARSER_H_
#define MINDSPORE_LITE_TOOLS_CONVERTER_PARSER_PYTORCH_PYTORCH_RESHAPE_PARSER_H_
...
namespace mindspore {
namespace lite {
class PytorchReshapeParser : public PytorchNodeParser {
 public:
  PytorchReshapeParser() : PytorchNodeParser("Reshape") {}
  ~PytorchReshapeParser() override = default;
