...
MS_CORE_API inline const PrimitivePtr kPrimAsin = std::make_shared<Primitive>(kAsin);
...
MS_CORE_API inline const PrimitivePtr kPrimRpcSend = std::make_shared<Primitive>("RpcSend");
MS_CORE_API inline const PrimitivePtr kPrimRpcRecv = std::make_shared<Primitive>("RpcRecv");
...
MS_CORE_API inline const PrimitivePtr kPrimMatrixDiagPart = std::make_shared<Primitive>("MatrixDiagPartV3");
...
MS_CORE_API inline const PrimitivePtr kPrimAsinGrad = std::make_shared<Primitive>(kAsinGrad);
