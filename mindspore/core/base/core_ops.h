...
inline const PrimitivePtr kPrimParallelResizeBilinear = std::make_shared<Primitive>("ParallelResizeBilinear");
inline const PrimitivePtr kPrimParallelResizeBilinearGrad = std::make_shared<Primitive>("ParallelResizeBilinearGrad");
...
inline const PrimitivePtr kPrimAcosh = std::make_shared<Primitive>(kAcosh);
...
inline const PrimitivePtr kPrimBNTrainingReduce = std::make_shared<Primitive>("BNTrainingReduce");
...
inline const PrimitivePtr kPrimSelu = std::make_shared<Primitive>("SeLU");
...
inline const PrimitivePtr kPrimTruncateDiv = std::make_shared<Primitive>("TruncateDiv");
inline const PrimitivePtr kPrimSqrt = std::make_shared<Primitive>("Sqrt");
inline const PrimitivePtr kPrimTruncateMod = std::make_shared<Primitive>("TruncateMod");
...
inline const PrimitivePtr kPrimACos = std::make_shared<Primitive>(kACos);
inline const PrimitivePtr kPrimAsinGrad = std::make_shared<Primitive>("AsinGrad");
inline const PrimitivePtr kPrimACosGrad = std::make_shared<Primitive>(kACosGrad);
...
inline const PrimitivePtr kPrimAcoshGrad = std::make_shared<Primitive>(kAcoshGrad);
...
inline const PrimitivePtr kPrimXlogy = std::make_shared<Primitive>("Xlogy");
...
inline const PrimitivePtr kPrimDynamicQuant = std::make_shared<Primitive>("DynamicQuant");
