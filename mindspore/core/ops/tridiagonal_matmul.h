...
#ifndef MINDSPORE_CORE_OPS_TRIDIAGONAL_MATMUL_H_
#define MINDSPORE_CORE_OPS_TRIDIAGONAL_MATMUL_H_
#include <map>
#include <set>
#include <string>
...
class MS_CORE_API TridiagonalMatMul : public BaseOperator {
 public:
  ...
  TridiagonalMatMul() : BaseOperator(kNameTridiagonalMatMul) {
    InitIOName({"superdiag", "maindiag", "subdiag", "rhs"}, {"output"});
  }
};
...
#endif  // MINDSPORE_CORE_OPS_TRIDIAGONAL_MATMUL_H_
