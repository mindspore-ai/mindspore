 ...
 */
#ifndef MINDSPORE_CORE_C_OPS_FAKE_QUANT_WITH_MIN_MAX_VARS_H_
#define MINDSPORE_CORE_C_OPS_FAKE_QUANT_WITH_MIN_MAX_VARS_H_
#include <vector>
#include <memory>
...
#endif  // MINDSPORE_CORE_C_OPS_FAKE_QUANT_WITH_MIN_MAX_VARS_H_
