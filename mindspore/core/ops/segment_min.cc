...
namespace ops {
namespace {
abstract::ShapePtr SegmentMinInferShape(const PrimitivePtr &primitive, const std::vector<AbstractBasePtr> &input_args) {
...
TypePtr SegmentMinInferType(const PrimitivePtr &primitive, const std::vector<AbstractBasePtr> &input_args) {
...
AbstractBasePtr SegmentMinInfer(const abstract::AnalysisEnginePtr &, const PrimitivePtr &primitive,
  ...
  auto type = SegmentMinInferType(primitive, input_args);
  auto shape = SegmentMinInferShape(primitive, input_args);
  return abstract::MakeAbstract(shape, type);
}
REGISTER_PRIMITIVE_EVAL_IMPL(SegmentMin, prim::kPrimSegmentMin, SegmentMinInfer, nullptr, true);
}  // namespace ops
}  // namespace mindspore
