...
#ifndef MINDSPORE_CORE_OPS_PRC_RECV_H_
#define MINDSPORE_CORE_OPS_PRC_RECV_H_
...
namespace mindspore {
namespace ops {
constexpr auto kNameRpcRecv = "RpcRecv";
class MIND_API RpcRecv : public BaseOperator {
 public:
...
#endif  // MINDSPORE_CORE_OPS_PRC_RECV_H_
