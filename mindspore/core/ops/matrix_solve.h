...
#ifndef MINDSPORE_CORE_OPS_MATRIX_SOLVE_H_
...
namespace mindspore {
namespace ops {
constexpr auto kNameMatrixSolve = "MatrixSolve";
/// \brief Assert defined MatrixSolve operator prototype.
class MIND_API MatrixSolve : public BaseOperator {
 public:
  MIND_API_BASE_MEMBER(MatrixSolve);
  /// \brief Constructor.
  MatrixSolve() : BaseOperator(kNameMatrixSolve) { InitIOName({"matrix", "rhs"}, {"output"}); }
  /// \brief Init.
  void Init(bool adjoint);
  /// \brief Method to set adjoint attributes.
...
#endif  // MINDSPORE_CORE_OPS_MATRIX_SOLVE_H_
