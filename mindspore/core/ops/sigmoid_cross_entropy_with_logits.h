...
#ifndef MINDSPORE_CORE_C_OPS_SIGMOID_CROSS_ENTROPY_WITH_LOGITS_H_
#define MINDSPORE_CORE_C_OPS_SIGMOID_CROSS_ENTROPY_WITH_LOGITS_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
#endif  // MINDSPORE_CORE_C_OPS_SIGMOID_CROSS_ENTROPY_WITH_LOGITS_H_
