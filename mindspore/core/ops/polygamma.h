...
#ifndef MINDSPORE_CORE_OPS_POLYGAMMA_H
#define MINDSPORE_CORE_OPS_POLYGAMMA_H
...
class MIND_API Polygamma : public BaseOperator {
 public:
...
#endif  // MINDSPORE_CORE_OPS_POLYGAMMA_H
