...
namespace mindspore {
namespace ops {
class MIND_API AllFinite : public BaseOperator {
 public:
...
MIND_API abstract::AbstractBasePtr AllFiniteInfer(const abstract::AnalysisEnginePtr &, const PrimitivePtr &primitive,
