...
#ifndef MINDSPORE_CORE_OPS_SCATTER_MUL_H_
#define MINDSPORE_CORE_OPS_SCATTER_MUL_H_
...
class MIND_API ScatterMul : public BaseOperator {
 public:
...
#endif  // MINDSPORE_CORE_OPS_SCATTER_MUL_H_
