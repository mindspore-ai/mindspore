...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_RMS_NORM_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_RMS_NORM_H_
#include <memory>
#include <vector>
...
namespace mindspore {
namespace ops {
class MIND_API RmsNormFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_RMS_NORM_H_
