 ...
 */
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_UNIQUE_DIM_H_
...
class MIND_API UniqueDimFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_UNIQUE_DIM_H_
