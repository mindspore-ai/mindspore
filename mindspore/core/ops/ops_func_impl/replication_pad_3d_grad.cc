...
namespace mindspore {
namespace ops {
BaseShapePtr ReplicationPad3DGradFuncImpl::InferShape(const PrimitivePtr &primitive,
...
TypePtr ReplicationPad3DGradFuncImpl::InferType(const PrimitivePtr &primitive,
                                                const std::vector<AbstractBasePtr> &input_args) const {
