...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ONES_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ONES_H_
...
namespace mindspore {
namespace ops {
class MIND_API OnesFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ONES_H_
