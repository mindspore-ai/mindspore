 ...
 */
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_HSIGMOID_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_HSIGMOID_H_
...
namespace mindspore {
namespace ops {
class MIND_API HSigmoidFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_HSIGMOID_H_
