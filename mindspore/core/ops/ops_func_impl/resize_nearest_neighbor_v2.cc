...
namespace mindspore {
namespace ops {
BaseShapePtr ResizeNearestNeighborV2FuncImpl::InferShape(const PrimitivePtr &primitive,
                                                         const std::vector<AbstractBasePtr> &input_args) const {
  return Resize2DInferShape(primitive, input_args);
}

TypePtr ResizeNearestNeighborV2FuncImpl::InferType(const PrimitivePtr &primitive,
                                                   const std::vector<AbstractBasePtr> &input_args) const {
