...
namespace mindspore {
namespace ops {
BaseShapePtr ReplicationPad1DGradFuncImpl::InferShape(const PrimitivePtr &primitive,
...
TypePtr ReplicationPad1DGradFuncImpl::InferType(const PrimitivePtr &primitive,
                                                const std::vector<AbstractBasePtr> &input_args) const {
