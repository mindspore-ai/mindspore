...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_GREATER_EQUAL_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_GREATER_EQUAL_H_
...
namespace mindspore {
namespace ops {
class MIND_API GreaterEqualFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_GREATER_EQUAL_H_
