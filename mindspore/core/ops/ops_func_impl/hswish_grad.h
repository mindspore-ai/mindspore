 ...
 */
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_HSWISH_GRAD_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_HSWISH_GRAD_H_
...
namespace mindspore {
namespace ops {
class MIND_API HSwishGradFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_HSWISH_GRAD_H_
