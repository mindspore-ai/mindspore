...
#ifndef MINDSPORE_CORE_OPS_BATCH_MATMUL_EXT_H_
#define MINDSPORE_CORE_OPS_BATCH_MATMUL_EXT_H_
...
namespace mindspore {
namespace ops {
class MIND_API BatchMatMulExtFuncImpl : public BatchMatMulFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_BATCH_MATMUL_EXT_H_
