...
BaseShapePtr SquareFuncImpl::InferShape(const PrimitivePtr &primitive,
...
TypePtr SquareFuncImpl::InferType(const PrimitivePtr &primitive, const std::vector<AbstractBasePtr> &input_args) const {
  MS_EXCEPTION_IF_NULL(input_args[0]);
