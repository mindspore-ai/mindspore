...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_CUMMIN_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_CUMMIN_H_
...
namespace mindspore {
namespace ops {
class MIND_API CumminFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_CUMMIN_H_
