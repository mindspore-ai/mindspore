...
#ifndef MINDSPORE_CORE_OPS_OP_FUNC_IMPL_ONES_LIKE_EXT_H
#define MINDSPORE_CORE_OPS_OP_FUNC_IMPL_ONES_LIKE_EXT_H
...
class MIND_API OnesLikeExtFuncImpl : public EltwiseOpFuncImpl {
 public:
