...
#ifndef MINDSPORE_CORE_OPS_BATCH_NORM_WITH_ADD_AND_ACTIVATION_H_
#define MINDSPORE_CORE_OPS_BATCH_NORM_WITH_ADD_AND_ACTIVATION_H_
...
#endif  // MINDSPORE_CORE_OPS_BATCH_NORM_WITH_ADD_AND_ACTIVATION
