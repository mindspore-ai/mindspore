...
#ifndef MINDSPORE_CORE_OPS_BATCH_NORM_GRAD_WITH_ACTIVAATION_H_
#define MINDSPORE_CORE_OPS_BATCH_NORM_GRAD_WITH_ACTIVAATION_H_
...
#endif  // MINDSPORE_CORE_OPS_BATCH_NORM_GRAD_WITH_ACTIVAATION_H_
