...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_NON_ZERO_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_NON_ZERO_H_
...
namespace mindspore {
namespace ops {
class MIND_API NonZeroFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_NON_ZERO_H_
