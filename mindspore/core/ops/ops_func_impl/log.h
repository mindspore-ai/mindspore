...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LOG_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LOG_H_
...
namespace mindspore {
namespace ops {
class MIND_API LogFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LOG_H_
