...
namespace mindspore {
namespace ops {
BaseShapePtr ReflectionPad2DGradFuncImpl::InferShape(const PrimitivePtr &primitive,
...
TypePtr ReflectionPad2DGradFuncImpl::InferType(const PrimitivePtr &primitive,
                                               const std::vector<AbstractBasePtr> &input_args) const {
