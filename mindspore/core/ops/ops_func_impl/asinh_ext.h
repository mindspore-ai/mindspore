...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ASINH_EXT_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ASINH_EXT_H_
...
class MIND_API AsinhExtFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ASINH_EXT_H_
