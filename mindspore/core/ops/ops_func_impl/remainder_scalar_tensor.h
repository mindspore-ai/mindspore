...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_REMAINDER_SCALAR_TENSOR_H_
...
class MIND_API RemainderScalarTensorFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_REMAINDER_SCALAR_TENSOR_H_
