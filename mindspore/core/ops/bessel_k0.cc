...
namespace ops {
namespace {
abstract::ShapePtr BesselK0InferShape(const PrimitivePtr &primitive, const std::vector<AbstractBasePtr> &input_args) {
...
REGISTER_PRIMITIVE_EVAL_IMPL(BesselK0, prim::kPrimBesselK0, BesselK0Infer, nullptr, true);
}  // namespace ops
}  // namespace mindspore
