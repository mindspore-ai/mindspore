...
#ifndef MINDSPORE_CORE_OPS_SCATTER_SUB_H_
#define MINDSPORE_CORE_OPS_SCATTER_SUB_H_
#include <memory>
#include <vector>
...
class MIND_API ScatterSub : public BaseOperator {
 public:
...
#endif  // MINDSPORE_CORE_OPS_SCATTER_SUB_H_
