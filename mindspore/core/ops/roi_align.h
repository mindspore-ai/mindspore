...
class MIND_API ROIAlign : public BaseOperator {
 public:
  ...
  /// \brief Constructor.
  ROIAlign() : BaseOperator(kNameROIAlign) {}
  ...
  /// \param[in] roi_end_mode Define Define whether to use legacy implementation or shifting.
  ...
  ///
  /// \param[in] roi_end_mode Define whether to use legacy implementation or shifting.
