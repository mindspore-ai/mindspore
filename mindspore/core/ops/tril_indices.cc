...
namespace ops {
namespace {
abstract::ShapePtr TrilIndicesInferShape(const PrimitivePtr &primitive,
...
TypePtr TrilIndicesInferType(const PrimitivePtr &primitive, const std::vector<AbstractBasePtr> &input_args) {
...
REGISTER_PRIMITIVE_EVAL_IMPL(TrilIndices, prim::kPrimTrilIndices, TrilIndicesInfer, nullptr, true);
}  // namespace ops
}  // namespace mindspore
