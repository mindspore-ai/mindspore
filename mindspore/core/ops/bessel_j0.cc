...
namespace ops {
namespace {
abstract::ShapePtr BesselJ0InferShape(const PrimitivePtr &primitive, const std::vector<AbstractBasePtr> &input_args) {
...
REGISTER_PRIMITIVE_EVAL_IMPL(BesselJ0, prim::kPrimBesselJ0, BesselJ0Infer, nullptr, true);
}  // namespace ops
}  // namespace mindspore
