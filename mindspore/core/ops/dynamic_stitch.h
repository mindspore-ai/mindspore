...
#ifndef MINDSPORE_CORE_OPS_DYNAMIC_STITCH_H_
#define MINDSPORE_CORE_OPS_DYNAMIC_STITCH_H_
#include <vector>
#include <memory>
...
class MIND_API DynamicStitch : public BaseOperator {
 public:
...
#endif  // MINDSPORE_CORE_OPS_DYNAMIC_STITCH_H_
