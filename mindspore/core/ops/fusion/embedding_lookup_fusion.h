...
#ifndef MINDSPORE_CORE_C_OPS_EMBEDDING_LOOKUP_FUSION_H_
#define MINDSPORE_CORE_C_OPS_EMBEDDING_LOOKUP_FUSION_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
#endif  // MINDSPORE_CORE_C_OPS_EMBEDDING_LOOKUP_FUSION_H_
