...
#ifndef MINDSPORE_CORE_C_OPS_CONV2D_BACKPROP_FILTER_FUSION_H_
#define MINDSPORE_CORE_C_OPS_CONV2D_BACKPROP_FILTER_FUSION_H_
#include <vector>
#include <memory>
...
#endif  // MINDSPORE_CORE_C_OPS_CONV2D_BACKPROP_FILTER_FUSION_H_
