...
#ifndef MINDSPORE_CORE_OPS_GRAD_BN_TRAINING_REDUCE_GRAD_H_
#define MINDSPORE_CORE_OPS_GRAD_BN_TRAINING_REDUCE_GRAD_H_
#include <string>
#include <vector>
#include <memory>
...
#endif  // MINDSPORE_CORE_OPS_GRAD_BN_TRAINING_REDUCE_GRAD_H_
