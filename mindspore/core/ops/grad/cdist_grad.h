...
#ifndef MINDSPORE_CORE_OPS_CDIST_GRAD_H_
#define MINDSPORE_CORE_OPS_CDIST_GRAD_H_
#include <algorithm>
#include <map>
#include <memory>
#include <set>
...
MIND_API abstract::AbstractBasePtr CdistGradInfer(const abstract::AnalysisEnginePtr &, const PrimitivePtr &primitive,
                                                  const std::vector<abstract::AbstractBasePtr> &input_args);
}  // namespace ops
}  // namespace mindspore

#endif  // MINDSPORE_CORE_OPS_CDIST_GRAD_H_
