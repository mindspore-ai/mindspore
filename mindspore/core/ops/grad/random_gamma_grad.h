...
#ifndef MINDSPORE_CORE_OPS_RANDOM_GAMMA_GRAD_H_
#define MINDSPORE_CORE_OPS_RANDOM_GAMMA_GRAD_H_
...
class MIND_API RandomGammaGrad : public BaseOperator {
 public:
...
#endif  // MINDSPORE_CORE_OPS_RANDOM_GAMMA_GRAD_H_
