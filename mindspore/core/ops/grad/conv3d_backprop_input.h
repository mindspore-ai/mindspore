...
class MIND_API Conv3DBackpropInput : public BaseOperator {
 public:
  ...
  explicit Conv3DBackpropInput(const std::string &k_name = kNameConv3DBackpropInput) : BaseOperator(k_name) {
...
abstract::AbstractBasePtr Conv3DBackpropInputInfer(const abstract::AnalysisEnginePtr &, const PrimitivePtr &primitive,
