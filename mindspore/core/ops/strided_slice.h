...
#ifndef MINDSPORE_CORE_C_OPS_STRIDED_SLICE_H_
#define MINDSPORE_CORE_C_OPS_STRIDED_SLICE_H_
#include <map>
#include <vector>
#include <string>
#include <memory>
...
class StridedSlice : public PrimitiveC {
 public:
  StridedSlice() : PrimitiveC(kNameStridedSlice) { InitIOName({"x", "begain", "end", "strides"}, {"output"}); }
...
#endif  // MINDSPORE_CORE_C_OPS_STRIDED_SLICE_H_
