...
#include "ops/ops_frontend_func_impl/scalar_arithmetic.h"
#include <limits>
#include <map>
#include <string>
...
REGISTER_PRIMITIVE_FUNCTION_FRONTEND_FUNC_IMPL("ScalarGe", ScalarGeFrontendFuncImpl);
...
REGISTER_PRIMITIVE_FUNCTION_FRONTEND_FUNC_IMPL("ScalarMod", ScalarModFrontendFuncImpl);
