...
#ifndef MINDSPORE_CORE_C_OPS_TENSOR_LIST_GET_ITEM_H_
#define MINDSPORE_CORE_C_OPS_TENSOR_LIST_GET_ITEM_H_
#include <memory>
...
#endif  // MINDSPORE_CORE_C_OPS_TENSOR_LIST_GET_ITEM_H_
