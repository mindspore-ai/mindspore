...
namespace ops {
namespace {
abstract::ShapePtr SegmentSumInferShape(const PrimitivePtr &primitive, const std::vector<AbstractBasePtr> &input_args) {
...
TypePtr SegmentSumInferType(const PrimitivePtr &primitive, const std::vector<AbstractBasePtr> &input_args) {
...
AbstractBasePtr SegmentSumInfer(const abstract::AnalysisEnginePtr &, const PrimitivePtr &primitive,
  ...
  auto type = SegmentSumInferType(primitive, input_args);
  auto shape = SegmentSumInferShape(primitive, input_args);
  return abstract::MakeAbstract(shape, type);
}
REGISTER_PRIMITIVE_EVAL_IMPL(SegmentSum, prim::kPrimSegmentSum, SegmentSumInfer, nullptr, true);
}  // namespace ops
}  // namespace mindspore
