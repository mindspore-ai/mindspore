...
def CusImg2Col(input_x, output, ksizes, strides, dilates, mode, kernel_name="img2col"):
    ...
    if N % 32 != 0:
        raise RuntimeError("batch size %s is not supported" % str(N))
    ...
    input_shape = (tuple(input_x_shape[1:]), input_x_dtype, (filter_h, filter_w), (stride_h, stride_w))
    supported_shape = [((32, 14, 14, 16), 'float16', (3, 3), (2, 2)),
                       ((1, 224, 224, 16), 'float16', (7, 7), (2, 2)),
                       ((4, 56, 56, 16), 'float16', (3, 3), (1, 1)),
                       ((8, 56, 56, 16), 'float16', (3, 3), (2, 2)),
                       ((8, 28, 28, 16), 'float16', (3, 3), (1, 1)),
                       ((16, 28, 28, 16), 'float16', (3, 3), (2, 2)),
                       ((16, 14, 14, 16), 'float16', (3, 3), (1, 1)),
                       ((32, 7, 7, 16), 'float16', (3, 3), (1, 1)),
                       ((64, 14, 14, 16), 'float16', (1, 1), (1, 1)),
                       ((32, 7, 7, 16), 'float16', (1, 1), (1, 1)),
                       ((4, 56, 56, 16), 'float16', (1, 1), (1, 1)),
                       ((64, 14, 14, 16), 'float16', (1, 1), (2, 2)),
                       ((128, 7, 7, 16), 'float16', (1, 1), (1, 1)),
                       ((32, 28, 28, 16), 'float16', (1, 1), (2, 2)),
                       ((16, 56, 56, 16), 'float16', (1, 1), (2, 2)),
                       ((8, 28, 28, 16), 'float16', (1, 1), (1, 1)),
                       ((32, 28, 28, 16), 'float16', (1, 1), (1, 1)),
                       ((16, 14, 14, 16), 'float16', (1, 1), (1, 1)),
                       ((16, 56, 56, 16), 'float16', (1, 1), (1, 1)),
                       ((16, 28, 28, 16), 'float16', (1, 1), (1, 1)),
                       ((32, 14, 14, 16), 'float16', (1, 1), (1, 1)),
                       ((64, 7, 7, 16), 'float16', (1, 1), (1, 1))]
    ...
    if input_shape == ((64, 7, 7, 16), 'float16', (1, 1), (1, 1)):
        loop_size = N / 32
        pad = [0, 0, 0, 0]
        l1_h = 7
        l1_w = 7
        ...
        with tik_instance.for_range(0, 32, block_num=32) as block_index:
            with tik_instance.for_range(0, loop_size) as batch_loop:
                ...
                with tik_instance.for_range(0, 2) as eeb0:
                    with tik_instance.for_range(0, 32) as i:
                        tik_instance.data_move(input_1_1_local_L1[i * 784], input_x[i + batch_loop * 32, eeb0 + block_index * 2, 0, 0, 0], 0,
                                               1, 49, 0, 0)
                    with tik_instance.for_range(0, 32) as i:
                        rep = 4
                        fetch_filter_w = 0
                    ...
                    with tik_instance.for_range(0, 98) as i:
                        tik_instance.data_move(res[eeb0 + block_index * 2, i + 98 * batch_loop, 0, 0], input_1_2_fractal_L1_local_UB[256 * i],
                                               0, 1, 16, 0, 0)

    elif input_shape == ((32, 14, 14, 16), 'float16', (1, 1), (1, 1)):
        loop_size = N / 32
        pad = [0, 0, 0, 0]
        l1_h = 14
        l1_w = 14
        ...
        with tik_instance.for_range(0, 32, block_num=32) as block_index:
            with tik_instance.for_range(0, loop_size) as batch_loop:
                ...
                input_1_2_fractal_L1_local_UB = tik_instance.Tensor("float16", (50176,), scope=tik.scope_ubuf,
                                                                    name="input_1_2_fractal_L1_local_UB")
                with tik_instance.for_range(0, 32) as i:
                    tik_instance.data_move(input_1_1_local_L1[i * 3136], input_x[i + batch_loop * 32, block_index, 0, 0, 0], 0, 1, 196, 0,
                                           0)
                with tik_instance.for_range(0, 2) as eeb1:
                    ...
                    with tik_instance.for_range(eeb1 * 196, (eeb1 + 1) * 196) as i:
                        tik_instance.data_move(res[block_index, i + 392 * batch_loop, 0, 0],
                                               input_1_2_fractal_L1_local_UB[256 * (i - eeb1 * 196)], 0, 1, 16, 0, 0)

    elif input_shape == ((16, 14, 14, 16), 'float16', (1, 1), (1, 1)):
        loop_size = N / 32
        if padding == 'SAME':
            padding_left = 0
            padding_right = 0
        ...
        with tik_instance.for_range(0, 32, block_num=32) as block_index:
            with tik_instance.for_range(0, loop_size) as batch_loop:
                ...
                input_1_2_fractal_L1_local_UB = tik_instance.Tensor("float16", (196 * 16 * 16,), scope=tik.scope_ubuf,
                                                                    name="input_1_2_fractal_L1_local_UB")
                with tik_instance.for_range(0, 32) as i:
                    tik_instance.data_move(input_1_1_local_L1[i * 3136], input_x[i + 32 * batch_loop, eeb1, 0, 0, 0], 0, 1, 196, 0, 0)
                with tik_instance.for_range(0, 16) as i:
                    fetch_filter_w = 0
                    fetch_filter_h = 0
                    left_top_h = 0
                ...
                with tik_instance.for_range(0, 196) as i:
                    tik_instance.data_move(res[eeb1, i + 196 * eeb0 + batch_loop * 392, 0, 0], input_1_2_fractal_L1_local_UB[256 * i], 0, 1,
                                           16, 0, 0)

    elif input_shape == ((32, 28, 28, 16), 'float16', (1, 1), (1, 1)):
        if padding == 'SAME':
            padding_left = 0
            padding_right = 0
            padding_top = 0
        ...
        jump_stride = 1
        repeat_mode = 1
        with tik_instance.for_range(0, N, block_num=N) as block_index:
    ...
    elif input_shape == ((128, 7, 7, 16), 'float16', (1, 1), (1, 1)):
        loop_size = N / 32
        pad = [0, 0, 0, 0]
        l1_h = 7
        l1_w = 7
        ...
        with tik_instance.for_range(0, 32, block_num=32) as block_index:
            with tik_instance.for_range(0, loop_size) as batch_loop:
                ...
                with tik_instance.for_range(0, 4) as eeb0:
                    with tik_instance.for_range(0, 32) as i:
                        tik_instance.data_move(input_1_1_local_L1[i * 784], input_x[i + batch_loop * block_index, eeb0 + block_index * 4, 0, 0, 0], 0,
                                               1, 49, 0, 0)
                    with tik_instance.for_range(0, 32) as i:
                        rep = 4
                        fetch_filter_w = 0
                    ...
                    with tik_instance.for_range(0, 98) as i:
                        tik_instance.data_move(res[eeb0 + block_index * 4, i + 98 * batch_loop, 0, 0], input_1_2_fractal_L1_local_UB[256 * i],
                                               0, 1, 16, 0, 0)

    elif input_shape == ((64, 14, 14, 16), 'float16', (1, 1), (2, 2)):
        loop_size = N / 32
        pad = [0, 0, 0, 0]
        l1_h = 14
        l1_w = 14
        ...
        with tik_instance.for_range(0, 32, block_num=32) as block_index:
            with tik_instance.for_range(0, loop_size) as batch_loop:
                ...
                with tik_instance.for_range(0, 2) as eeb0:
                    with tik_instance.for_range(0, 32) as i:
                        tik_instance.data_move(input_1_1_local_L1[i * 3136], input_x[i + 32 * batch_loop, block_index * 2 + eeb0, 0, 0, 0], 0,
                                               1, 196, 0, 0)
                    with tik_instance.for_range(0, 32) as i:
                        rep = 4
                        fetch_filter_w = 0
    ...
    elif input_shape == ((32, 7, 7, 16), 'float16', (1, 1), (1, 1)):
        loop_size = N / 32
        if padding == 'SAME':
            padding_left = 0
            padding_right = 0
        ...
        with tik_instance.for_range(0, 32, block_num=32) as block_index:
            with tik_instance.for_range(0, loop_size) as batch_loop:
                ...
                with tik_instance.for_range(0, 32) as i:
                    tik_instance.data_move(input_1_1_local_L1[i * 784], input_x[i  + 32 * batch_loop, block_index, 0, 0, 0], 0, 1, 49, 0, 0)
                ...
                with tik_instance.for_range(0, 32) as i:
                    tik_instance.data_move(input_1_2_fractal_L1_local_UB[i * 49 * 16],
                                           input_1_1_fractal_L1_local_UB[i * 1024], 0, 1, 49, 0, 0)
                with tik_instance.for_range(0, 98) as i:
                    tik_instance.data_move(res[block_index, i + 98 * batch_loop, 0, 0], input_1_2_fractal_L1_local_UB[i * 256], 0, 1, 16, 0,
                                           0)

    elif input_shape == ((64, 14, 14, 16), 'float16', (1, 1), (1, 1)):
        loop_size = N / 32
        pad = [0, 0, 0, 0]
        l1_h = 14
        l1_w = 14
        ...
        with tik_instance.for_range(0, 32, block_num=32) as block_index:
            with tik_instance.for_range(0, loop_size) as batch_loop:
                ...
                input_1_2_fractal_L1_local_UB = tik_instance.Tensor("float16", (50176,), scope=tik.scope_ubuf,
                                                                    name="input_1_2_fractal_L1_local_UB")
                with tik_instance.for_range(0, 32) as i:
                    tik_instance.data_move(input_1_1_local_L1[i * 3136], input_x[i + batch_loop * 32, block_index * 2, 0, 0, 0], 0, 1, 196, 0,
                                           0)
                    tik_instance.data_move(input_1_2_local_L1[i * 3136], input_x[i + batch_loop * 32, block_index * 2 + 1, 0, 0, 0], 0, 1,
                                           196, 0, 0)
                with tik_instance.for_range(0, 2) as eeb1:
                    with tik_instance.for_range(eeb1 * 16, (eeb1 + 1) * 16) as i:
                        rep = 13
                    ...
                    with tik_instance.for_range(0, 16) as i:
                        tik_instance.data_move(input_1_2_fractal_L1_local_UB[i * 196 * 16],
                                               input_1_1_fractal_L1_local_UB[i * 3328], 0, 1, 196, 0, 0)
                    with tik_instance.for_range(eeb1 * 196, (eeb1 + 1) * 196) as i:
                        tik_instance.data_move(res[block_index * 2, i + batch_loop * 392, 0, 0],
                                               input_1_2_fractal_L1_local_UB[256 * (i - eeb1 * 196)], 0, 1, 16, 0, 0)
                ...
                with tik_instance.for_range(0, 2) as eeb1:
                    ...
                    with tik_instance.for_range(0, 16) as i:
                        tik_instance.data_move(input_1_2_fractal_L1_local_UB[i * 196 * 16],
                                               input_1_1_fractal_L1_local_UB[i * 3328], 0, 1, 196, 0, 0)
                    with tik_instance.for_range(eeb1 * 196, (eeb1 + 1) * 196) as i:
                        tik_instance.data_move(res[block_index * 2 + 1, i + batch_loop * 392, 0, 0],
                                               input_1_2_fractal_L1_local_UB[256 * (i - eeb1 * 196)], 0, 1, 16, 0, 0)

    elif input_shape == ((32, 7, 7, 16), 'float16', (3, 3), (1, 1)):
        loop_size = N / 32
        pad = [1, 1, 1, 1]
        l1_h = 7
        l1_w = 7
        ...
        with tik_instance.for_range(0, 32, block_num=32) as block_index:
            with tik_instance.for_range(0, loop_size) as batch_loop:
                ...
                input_1_2_fractal_L1_local_UB = tik_instance.Tensor("float16", (25088,), scope=tik.scope_ubuf,
                                                                    name="input_1_2_fractal_L1_local_UB")
                with tik_instance.for_range(0, 32) as i:
                    tik_instance.data_move(input_1_1_local_L1[i * 784], input_x[i + batch_loop * 32, block_index, 0, 0, 0], 0, 1, 49, 0, 0)
                ...
                with tik_instance.for_range(0, 9) as eeb:
                    ...
                    with tik_instance.for_range(0, 98) as i:
                        tik_instance.data_move(res[eeb + block_index * 9, i + 98 * batch_loop, 0, 0], input_1_2_fractal_L1_local_UB[256 * i],
                                               0, 1, 16, 0, 0)

    elif input_shape == ((16, 14, 14, 16), 'float16', (3, 3), (1, 1)):
        loop_size = N / 32
        pad = [1, 1, 1, 1]
        l1_h = 14
        l1_w = 14
        ...
        with tik_instance.for_range(0, 32, block_num=32) as block_index:
            with tik_instance.for_range(0, loop_size) as batch_loop:
                ...
                input_1_2_fractal_L1_local_UB = tik_instance.Tensor("float16", (50176,), scope=tik.scope_ubuf,
                                                                    name="input_1_2_fractal_L1_local_UB")
                with tik_instance.for_range(0, 16) as i:
                    tik_instance.data_move(input_1_1_local_L1[i * 3136], input_x[i + 16 * eeb0 + 32 * batch_loop, eeb1, 0, 0, 0], 0, 1, 196,
                                           0, 0)
                ...
                with tik_instance.for_range(0, 9) as eeb3:
                    ...
                    with tik_instance.for_range(196 * eeb0, 196 * (eeb0 + 1)) as i:
                        tik_instance.data_move(res[eeb1 * 9 + eeb3, i + 392 * batch_loop, 0, 0],
                                               input_1_2_fractal_L1_local_UB[256 * (i - 196 * eeb0)], 0, 1, 16, 0, 0)

    elif input_shape == ((16, 28, 28, 16), 'float16', (3, 3), (2, 2)):
        loop_size = N / 32
        pad = [1, 1, 1, 1]
        l1_h = 28
        l1_w = 28
        ...
        with tik_instance.for_range(0, 32, block_num=32) as block_index:
            with tik_instance.for_range(0, loop_size) as batch_loop:
                ...
                input_1_2_fractal_L1_local_UB = tik_instance.Tensor("float16", (50176,), scope=tik.scope_ubuf,
                                                                    name="input_1_2_fractal_L1_local_UB")
                with tik_instance.for_range(0, 16) as i:
                    tik_instance.data_move(input_1_1_local_L1[i * 12544], input_x[i + 16 * eeb0 + 32 * batch_loop, eeb1, 0, 0, 0], 0, 1, 784,
                                           0, 0)
    ...
    elif input_shape == ((32, 14, 14, 16), 'float16', (3, 3), (2, 2)):
        loop_size = N / 32
        pad = [1, 1, 1, 1]
        l1_h = 14
        l1_w = 14
        ...
        with tik_instance.for_range(0, 32, block_num=32) as block_index:
            with tik_instance.for_range(0, loop_size) as batch_loop:
                ...
                input_1_2_fractal_L1_local_UB = tik_instance.Tensor("float16", (25088,), scope=tik.scope_ubuf,
                                                                    name="input_1_2_fractal_L1_local_UB")
                with tik_instance.for_range(0, 32) as i:
                    tik_instance.data_move(input_1_1_local_L1[i * 3136], input_x[i + 32 * batch_loop, block_index, 0, 0, 0], 0, 1, 196, 0, 0)
                with tik_instance.for_range(0, 9) as eeb:
                    rep = 4
                    fetch_filter_w = eeb % 3
                    fetch_filter_h = eeb // 3
    ...
    elif input_shape == ((16, 28, 28, 16), 'float16', (1, 1), (1, 1)):
        pad = [0, 0, 0, 0]
        l1_h = 28
        l1_w = 28
        c1_index = 0
    ...
    elif input_shape == ((16, 56, 56, 16), 'float16', (1, 1), (1, 1)):
        if padding == 'SAME':
            padding_left = 0
            padding_right = 0
            padding_top = 0
    ...
    elif input_shape == ((8, 28, 28, 16), 'float16', (1, 1), (1, 1)):
        if padding == 'SAME':
            padding_left = 0
            padding_right = 0
            padding_top = 0
    ...
    elif input_shape == ((16, 56, 56, 16), 'float16', (1, 1), (2, 2)):
        if padding == 'SAME':
            padding_left = 0
            padding_right = 0
            padding_top = 0
    ...
    elif input_shape == ((32, 28, 28, 16), 'float16', (1, 1), (2, 2)):
        loop_size = N / 32
        pad = [0, 0, 0, 0]
        l1_h = 28
        l1_w = 28
        ...
        with tik_instance.for_range(0, 32, block_num=32) as block_index:
            with tik_instance.for_range(0, loop_size) as batch_loop:
                ...
                input_1_2_fractal_L1_local_UB = tik_instance.Tensor("float16", (50176,), scope=tik.scope_ubuf,
                                                                    name="input_1_2_fractal_L1_local_UB")
                with tik_instance.for_range(0, 32) as i:
                    tik_instance.data_move(input_1_1_local_L1[i * 12544], input_x[i + 32 * batch_loop, block_index, 0, 0, 0], 0, 1, 784, 0, 0)
                with tik_instance.for_range(0, 16) as i:
                    rep = 13
                    fetch_filter_w = 0
                    fetch_filter_h = 0
                ...
                with tik_instance.for_range(0, 16) as i:
                    tik_instance.data_move(input_1_2_fractal_L1_local_UB[i * 196 * 16],
                                           input_1_1_fractal_L1_local_UB[i * 3328], 0, 1, 196, 0, 0)
                with tik_instance.for_range(0, 196) as i:
                    tik_instance.data_move(res[block_index, i + 392*batch_loop, 0, 0], input_1_2_fractal_L1_local_UB[256 * i], 0, 1, 16, 0,
                                           0)
                ...
                with tik_instance.for_range(196, 392) as i:
                    tik_instance.data_move(res[block_index, i+ 392*batch_loop, 0, 0], input_1_2_fractal_L1_local_UB[256 * (i - 196)], 0, 1,
                                           16, 0, 0)

    elif input_shape == ((4, 56, 56, 16), 'float16', (1, 1), (1, 1)):
        if padding == 'SAME':
            padding_left = 0
            padding_right = 0
            padding_top = 0
    ...
    elif input_shape == ((8, 28, 28, 16), 'float16', (3, 3), (1, 1)):
        pad = [1, 1, 1, 1]
        l1_h = 28
        l1_w = 28
        jump_stride = 1
    ...
    elif input_shape == ((8, 56, 56, 16), 'float16', (3, 3), (2, 2)):
        pad = [1, 1, 1, 1]
        l1_h = 56
        l1_w = 56
        jump_stride = 1
    ...
    elif input_shape == ((4, 56, 56, 16), 'float16', (3, 3), (1, 1)):
        pad = [1, 1, 1, 1]
        l1_h = 56
        l1_w = 56
        jump_stride = 1
    ...
    elif input_shape == ((1, 224, 224, 16), 'float16', (7, 7), (2, 2)):
        pad = [3, 3, 3, 3]
        l1_h = 56
        l1_w = 224
        c1_index = 0
