...
if (BUILD_MINDDATA STREQUAL "full")
    install(DIRECTORY ${TOP_DIR}/mindspore/ccsrc/minddata/dataset/liteapi/include/ DESTINATION ${MIND_DATA_INC_DIR} COMPONENT ${RUNTIME_COMPONENT_NAME} FILES_MATCHING PATTERN "*.h" PATTERN "vision.h" EXCLUDE)
    install(FILES ${TOP_DIR}/include/api/status.h  DESTINATION ${MIND_DATA_INC_DIR} RENAME ms_status.h COMPONENT ${RUNTIME_COMPONENT_NAME})
...
if(BUILD_MINDDATA STREQUAL "lite")
    ...
    elseif(PLATFORM_ARM32)
        ...
        install(FILES ${TOP_DIR}/mindspore/lite/build/minddata/libminddata-lite.so DESTINATION ${MIND_DATA_LIB_DIR}
                COMPONENT ${RUNTIME_COMPONENT_NAME})
        install(FILES ${TOP_DIR}/third_party/libjpeg-turbo/lib/libjpeg.so.62.3.0 DESTINATION ${TURBO_DIR}/lib
                RENAME libjpeg.so.62 COMPONENT ${RUNTIME_COMPONENT_NAME})
        install(FILES ${TOP_DIR}/third_party/libjpeg-turbo/lib/libturbojpeg.so.0.2.0 DESTINATION ${TURBO_DIR}/lib
...
elseif(WIN32)
    ...
    if(ENABLE_CONVERTER)
        ...
        install(FILES ${glog_LIBPATH}/libglog.so.0.4.0 DESTINATION ${CONVERTER_PKG_NAME}/third_party/glog/lib
                RENAME libglog.so.0 COMPONENT ${CONVERTER_COMPONENT_NAME})
    endif()
    if(ENABLE_TOOLS)
        install(TARGETS benchmark RUNTIME DESTINATION ${RUNTIME_PKG_NAME}/benchmark COMPONENT ${RUNTIME_COMPONENT_NAME})
