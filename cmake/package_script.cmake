...
if(DEFINED ENV{MS_INTERNAL_KERNEL_HOME})
    set(MS_KERNELS_INTERNAL_BIN_PATH ${MS_ROOT_DIR}/ms_kernels_internal)
    set(MS_KERNELS_INTERNAL_PACK_PATH ${MS_PACK_ROOT_DIR}/mindspore/lib/plugin/ascend)
    file(COPY ${MS_KERNELS_INTERNAL_BIN_PATH} DESTINATION ${MS_KERNELS_INTERNAL_PACK_PATH})
    file(REMOVE_RECURSE ${MS_KERNELS_INTERNAL_BIN_PATH})
endif()
