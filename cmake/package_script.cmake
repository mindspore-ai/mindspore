...
if(NOT (${PYTHON_VERSION} VERSION_GREATER_EQUAL "3.7.0" AND ${PYTHON_VERSION} VERSION_LESS "3.10.15"))
    message(FATAL_ERROR "Found Python version ${PYTHON_VERSION}, but only versions 3.7 - 3.10 are supported.")
endif()
