...
set(nccl_CFLAGS "-D_FORTIFY_SOURCE=2 -O2 -fstack-protector-strong")
...
set(nccl_CXXFLAGS "-D_FORTIFY_SOURCE=2 -O2 -fstack-protector-strong \
                    -I$ENV{CUDA_HOME}/targets/x86_64-linux/include -fPIC")
set(nccl_LDFLAGS "-Wl,-z,now")
...
if(NOT BUILD_LITE)
    ...
    set(NCCL_ARCH_FLAG "-gencode=arch=compute_60,code=sm_60")
endif()
