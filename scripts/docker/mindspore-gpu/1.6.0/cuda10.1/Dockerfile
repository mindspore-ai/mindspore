...
RUN pip install --no-cache-dir https://ms-release.obs.cn-north-4.myhuaweicloud.com/1.6.0/MindSpore/gpu/x86_64/cuda-10.1/mindspore_gpu-1.6.0-cp37-cp37m-linux_x86_64.whl \
